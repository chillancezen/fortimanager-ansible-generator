...
DOCUMENTATION = '''
---
module: fmgr_cli_fmupdate_web_spam_web_proxy
description:
        ...
        api_tag0:
            data:
                ...
                password:
                    -
                        type: str
                        default: ENC MTQ4ODM1MjcyOTk3ODExNreUBchLdkFIbIbcd8CigXCsJs8gguZ6mOjknXBH4Tm3shANGNo7nlVP8rFMUYX0OzAZMe+28CSkktL4ruOhitTk30S9SNOWireuoDy4UZdB2Dp2KCir8uYTdjFXK1Dw1YExtuDv8hnAdcTrE7EGsuayqVn5
                port:
                    type: int
                    default: 80
      ...
      result:
         data:
            ...
            password:
               ...
               suboptions:
                  type: str
                  example: ENC MTQ4ODM1MjcyOTk3ODExNreUBchLdkFIbIbcd8CigXCsJs8gguZ6mOjknXBH4Tm3shANGNo7nlVP8rFMUYX0OzAZMe+28CSkktL4ruOhitTk30S9SNOWireuoDy4UZdB2Dp2KCir8uYTdjFXK1Dw1YExtuDv8hnAdcTrE7EGsuayqVn5
            port:
               type: int
               description: 'The port number of the web proxy (1 - 65535, default = 80).'
               example: 80
