...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_waf_profile_profile_signature_custom_signature_custom_signature
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/signature/custom-signature/{custom-signature}
return_of_api_category_0:
