...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_firewall_policy64
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/POLICY64
      fmgr_pm_config_pkg_firewall_policy64:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/policy64'
return_of_api_category_0:
