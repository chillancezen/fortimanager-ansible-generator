...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_ssh_filter_profile_profile_shell_commands_shell_commands
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/ssh-filter/profile/{profile}/shell-commands/{shell-commands}
return_of_api_category_0:
