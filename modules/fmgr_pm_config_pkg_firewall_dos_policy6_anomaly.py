...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_firewall_dos_policy6_anomaly
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/DOS-POLICY6/{DOS-POLICY6}/ANOMALY
      fmgr_pm_config_pkg_firewall_dos_policy6_anomaly:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/DoS-policy6/{DoS-policy6}/anomaly'
return_of_api_category_0:
      ...
      result:
         data:
            ...
            suboptions:
               ...
               quarantine-expiry:
                  type: str
                  description: 'Duration of quarantine, from 1 minute to 364 days, 23 hours, and 59 minutes from now. (format: ###d##h##m, default = 5m). Re...'
               quarantine-log:
                  type: str
                  description: 'Enable/disable quarantine logging.'
               status:
               ...
               threshold:
                  type: int
                  description: 'Number of detected instances per minute which triggers action (1 - 2147483647, default = 1000). Note that each anomaly has a...'
               threshold(default):
                  type: int
         status:
            code:
