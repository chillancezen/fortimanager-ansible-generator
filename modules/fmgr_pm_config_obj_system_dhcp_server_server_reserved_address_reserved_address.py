...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_dhcp_server_server_reserved_address_reserved_address
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/system/dhcp/server/{server}/reserved-address/{reserved-address}
return_of_api_category_0:
