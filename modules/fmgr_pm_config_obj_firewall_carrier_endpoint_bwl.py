...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_carrier_endpoint_bwl
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/carrier-endpoint-bwl
      fmgr_pm_config_obj_firewall_carrier_endpoint_bwl:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/carrier-endpoint-bwl
return_of_api_category_0:
