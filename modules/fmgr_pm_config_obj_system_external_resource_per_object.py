...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_external_resource_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/EXTERNAL-RESOURCE/{EXTERNAL-RESOURCE}
      fmgr_pm_config_obj_system_external_resource_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/system/external-resource/{external-resource}'
return_of_api_category_0:
