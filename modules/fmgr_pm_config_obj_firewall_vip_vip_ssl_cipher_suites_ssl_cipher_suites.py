...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_vip_vip_ssl_cipher_suites_ssl_cipher_suites
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/vip/{vip}/ssl-cipher-suites/{ssl-cipher-suites}
return_of_api_category_0:
