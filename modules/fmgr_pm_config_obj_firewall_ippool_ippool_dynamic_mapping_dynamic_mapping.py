...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_ippool_ippool_dynamic_mapping_dynamic_mapping
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/ippool/{ippool}/dynamic_mapping/{dynamic_mapping}
return_of_api_category_0:
