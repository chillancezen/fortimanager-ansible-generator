...
DOCUMENTATION = '''
---
module: fmgr_pkg_firewall_interfacepolicy_obj
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/INTERFACE-POLICY/{INTERFACE-POLICY}
      fmgr_pkg_firewall_interfacepolicy_obj:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/interface-policy/{interface-policy}'
return_of_api_category_0:
