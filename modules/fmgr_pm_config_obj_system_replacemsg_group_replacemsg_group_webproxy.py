...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_replacemsg_group_replacemsg_group_webproxy
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/system/replacemsg-group/{replacemsg-group}/webproxy
return_of_api_category_0:
