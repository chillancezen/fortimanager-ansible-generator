...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_vip_vip_dynamic_mapping_dynamic_mapping_ssl_cipher_suites_ssl_cipher_suites
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/vip/{vip}/dynamic_mapping/{dynamic_mapping}/ssl-cipher-suites/{ssl-cipher-suites}
return_of_api_category_0:
