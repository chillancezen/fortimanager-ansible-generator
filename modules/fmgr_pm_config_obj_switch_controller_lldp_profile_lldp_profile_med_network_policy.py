...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_med_network_policy
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/switch-controller/lldp-profile/{lldp-profile}/med-network-policy
return_of_api_category_0:
