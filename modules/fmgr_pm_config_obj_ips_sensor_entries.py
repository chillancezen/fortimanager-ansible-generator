...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_ips_sensor_entries
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/ips/sensor/{sensor}/entries'
return_of_api_category_0:
      ...
      result:
         data:
            ...
            suboptions:
               ...
               log-packet:
                  type: str
                  description: 'Enable/disable packet logging. Enable to save the packet that triggers the filter. You can download the packets in pcap form...'
               os:
                  type: array
                  suboptions:
                     type: str
