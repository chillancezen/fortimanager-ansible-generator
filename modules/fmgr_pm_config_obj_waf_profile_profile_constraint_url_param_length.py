...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_waf_profile_profile_constraint_url_param_length
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/url-param-length
return_of_api_category_0:
