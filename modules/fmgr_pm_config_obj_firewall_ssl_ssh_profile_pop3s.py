...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_ssl_ssh_profile_pop3s
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SSL-SSH-PROFILE/{SSL-SSH-PROFILE}/POP3S
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_pop3s:
         method: <value in [get]>
         url_params:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/pop3s'
return_of_api_category_0:
