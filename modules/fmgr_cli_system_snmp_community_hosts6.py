...
DOCUMENTATION = '''
---
module: fmgr_cli_system_snmp_community_hosts6
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/SNMP/COMMUNITY/{COMMUNITY}/HOSTS6
      fmgr_cli_system_snmp_community_hosts6:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/cli/global/system/snmp/community/{community}/hosts6'
return_of_api_category_0:
