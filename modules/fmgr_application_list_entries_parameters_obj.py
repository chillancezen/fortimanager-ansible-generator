...
DOCUMENTATION = '''
---
module: fmgr_application_list_entries_parameters_obj
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/APPLICATION/LIST/{LIST}/ENTRIES/{ENTRIES}/PARAMETERS/{PARAMETERS}
      fmgr_application_list_entries_parameters_obj:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/application/list/{list}/entries/{entries}/paramet...'
return_of_api_category_0:
