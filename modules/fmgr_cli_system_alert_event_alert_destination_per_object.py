...
DOCUMENTATION = '''
---
module: fmgr_cli_system_alert_event_alert_destination_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/ALERT-EVENT/{ALERT-EVENT}/ALERT-DESTINATION/{ALERT-DESTINATION}
      fmgr_cli_system_alert_event_alert_destination_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/cli/global/system/alert-event/{alert-event}/alert-destination/{alert-destin...'
return_of_api_category_0:
