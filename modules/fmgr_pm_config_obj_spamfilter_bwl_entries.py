...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_spamfilter_bwl_entries
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/BWL/{BWL}/ENTRIES
      fmgr_pm_config_obj_spamfilter_bwl_entries:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/spamfilter/bwl/{bwl}/entries'
return_of_api_category_0:
