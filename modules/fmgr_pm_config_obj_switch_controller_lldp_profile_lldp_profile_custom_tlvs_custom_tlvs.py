...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_custom_tlvs_custom_tlvs
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/switch-controller/lldp-profile/{lldp-profile}/custom-tlvs/{custom-tlvs}
return_of_api_category_0:
