...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_web_proxy_forward_server_group_server_list_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/web-proxy/forward-server-group/{forward-server-gr...'
return_of_api_category_0:
