...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_qos_dot1p_map_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SWITCH-CONTROLLER/QOS/DOT1P-MAP/{DOT1P-MAP}
      fmgr_pm_config_obj_switch_controller_qos_dot1p_map_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/switch-controller/qos/dot1p-map/{dot1p-map}'
return_of_api_category_0:
