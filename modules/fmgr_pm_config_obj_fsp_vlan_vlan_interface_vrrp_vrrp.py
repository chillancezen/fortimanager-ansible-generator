...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_fsp_vlan_vlan_interface_vrrp_vrrp
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/fsp/vlan/{vlan}/interface/vrrp/{vrrp}
      fmgr_pm_config_obj_fsp_vlan_vlan_interface_vrrp_vrrp:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/fsp/vlan/{vlan}/interface/vrrp/{vrrp}
return_of_api_category_0:
