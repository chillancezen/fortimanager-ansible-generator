...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_vpn_ssl_web_realm_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/REALM/{REALM}
      fmgr_pm_config_obj_vpn_ssl_web_realm_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/vpn/ssl/web/realm/{realm}'
return_of_api_category_0:
