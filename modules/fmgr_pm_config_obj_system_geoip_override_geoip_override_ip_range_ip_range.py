...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_geoip_override_geoip_override_ip_range_ip_range
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/system/geoip-override/{geoip-override}/ip-range/{ip-range}
return_of_api_category_0:
