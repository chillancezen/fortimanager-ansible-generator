...
DOCUMENTATION = '''
---
module: fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_service_service_sla_sla
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/wanprof/{wanprof}/system/virtual-wan-link/service/{service}/sla/{sla}
return_of_api_category_0:
