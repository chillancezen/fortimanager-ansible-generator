...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_identity_based_route_identity_based_route_rule_rule
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/identity-based-route/{identity-based-route}/rule/{rule}
return_of_api_category_0:
