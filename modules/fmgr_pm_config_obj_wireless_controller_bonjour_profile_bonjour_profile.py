...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_bonjour_profile_bonjour_profile
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/bonjour-profile/{bonjour-profile}
return_of_api_category_0:
