...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_firewall_dos_policy6_per_object
description:
            ...
            data:
                anomaly:
                    -
                        ...
                        quarantine-expiry:
                            type: str
                            description: 'Duration of quarantine, from 1 minute to 364 days, 23 hours, and 59 minutes from now. (format: ###d##h##m, default...'
                        quarantine-log:
                            type: str
                        ...
                        threshold:
                            type: int
                            description: 'Number of detected instances per minute which triggers action (1 - 2147483647, default = 1000). Note that each ano...'
                        threshold(default):
                            type: int
                comments:
                    type: str
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/DOS-POLICY6/{DOS-POLICY6}
      fmgr_pm_config_pkg_firewall_dos_policy6_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/DoS-policy6/{DoS-policy6}'
return_of_api_category_0:
         ...
         data:
            anomaly:
               ...
               suboptions:
                  ...
                  threshold:
                     type: int
                     description: 'Number of detected instances per minute which triggers action (1 - 2147483647, default = 1000). Note that each anomaly ha...'
                  threshold(default):
                     type: int
            comments:
               type: str
