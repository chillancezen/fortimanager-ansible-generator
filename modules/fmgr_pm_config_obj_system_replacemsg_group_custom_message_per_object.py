...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_replacemsg_group_custom_message_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/CUSTOM-MESSAGE/{CUSTOM-MESSAGE}
      fmgr_pm_config_obj_system_replacemsg_group_custom_message_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/system/replacemsg-group/{replacemsg-group}/custom...'
return_of_api_category_0:
