...
DOCUMENTATION = '''
---
module: fmgr_dvmdb_workflow_wflog_obj
short_description: Read workflow session log. Read only.
description:
...
options:
    ...
    schema_object0:
        methods: [get]
        description: 'Read workflow session log. Read only.'
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/dvmdb/adom/{adom}/workflow/{workflow}/wflog/{wflog}'
