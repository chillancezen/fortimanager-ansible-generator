...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_dhcp_server_reserved_address_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/system/dhcp/server/{server}/reserved-address/{res...'
return_of_api_category_0:
