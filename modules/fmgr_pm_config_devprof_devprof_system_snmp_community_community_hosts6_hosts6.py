...
DOCUMENTATION = '''
---
module: fmgr_pm_config_devprof_devprof_system_snmp_community_community_hosts6_hosts6
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/devprof/{devprof}/system/snmp/community/{community}/hosts6/{hosts6}
return_of_api_category_0:
