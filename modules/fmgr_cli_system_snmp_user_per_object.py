...
DOCUMENTATION = '''
---
module: fmgr_cli_system_snmp_user_per_object
description:
        ...
        api_tag0:
            data:
                ...
                auth-pwd:
                    -
                        type: str
                        default: 'ENC NjAyNzczNjcyNzY3Nzg1Of2B29hwP1lYq82MXmrQ1PG7EGaRNDqkrqYFYL1NNEgm54idZER+oDi44SCyPKkvrPPrxgkkBtYnh1uQ3hobimfdeMd2rooTu...'
                events:
                    -
                        type: str
                        choices:
                ...
                priv-pwd:
                    -
                        type: str
                        default: 'ENC OTA3MDU5Nzg1ODQ2MDM2NInoPzPSYfTulrcxKZ65Re1ROZUOMQVvU4dqPX5WkABZ8PkpLAOtCEZJPjCcJbybir6Dw9yptXUDyKN4hUHbzauIOAQ2Az8Bl...'
                queries:
                    type: str
                    default: 'enable'
                    description:
