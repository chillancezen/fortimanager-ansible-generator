...
DOCUMENTATION = '''
---
module: fmgr_cli_system_log_settings_rolling_local
description:
        ...
        api_tag0:
            data:
                ...
                password:
                    -
                        type: str
                        default: 'ENC MTA3MjA4MzMzNDU1NjUyNKTuKbF8PktnhHOXsSkxjhxlHjwIE22BP2ak2RRotV+wsRkGD/HamAdeTJyxk8NUM5OZPMpAHhPZssCynPvryOwf6S7Bq6wiH...'
                password2:
                    -
                        type: str
                        default: 'ENC NjYyODA3OTExODQ2OTQ0N1452tPlCQK0/AvB5jye7GpFLLpArdcOazRo1BOGPYnKcgz2Iqn/Nt+7ZZereH6gM4nFNmsLipjwaznrIUtA2dAogsuYgiTXf...'
                password3:
                    -
                        type: str
                        default: 'ENC Mzk3ODgxMDA2MjU0NzUwNft3N0w+quBucyAJLuI78/qyOQAkHkRQnCPqX7Crikas/93czxOX2okFGGyPN7MhHEFPwsNyxKziYau12Szy5r5kYxSVnovhs...'
                server-type:
                    type: str
                    default: 'ftp'
                    description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/cli/global/system/log/settings/rolling-local'
return_of_api_category_0:
