...
DOCUMENTATION = '''
---
module: fmgr_dvmdb_workspace_lockinfo
short_description: Get the lock information of an ADOM.
description:
...
options:
    ...
    schema_object0:
        methods: [get]
        description: 'Get the lock information of an ADOM.'
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/dvmdb/adom/{adom}/workspace/lockinfo'
