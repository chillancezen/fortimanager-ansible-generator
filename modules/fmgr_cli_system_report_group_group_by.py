...
DOCUMENTATION = '''
---
module: fmgr_cli_system_report_group_group_by
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/REPORT/GROUP/{GROUP}/GROUP-BY
      fmgr_cli_system_report_group_group_by:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/cli/global/system/report/group/{group}/group-by'
return_of_api_category_0:
