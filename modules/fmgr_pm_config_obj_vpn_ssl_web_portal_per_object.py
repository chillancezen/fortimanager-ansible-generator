...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_vpn_ssl_web_portal_per_object
description:
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                custom-lang:
                    type: str
                    description: 'Change the web portal display language. Overrides config system global set language. You can use config system custom-lang...'
                ...
                ipv6-split-tunneling-routing-address:
                    type: str
                    description: 'IPv6 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tun...'
                ipv6-tunnel-mode:
                    type: str
                ...
                split-tunneling-routing-address:
                    type: str
                    description: 'IPv4 SSL-VPN tunnel mode firewall address objects that override firewall policy destination addresses to control split-tun...'
                theme:
                    type: str
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/vpn/ssl/web/portal/{portal}'
return_of_api_category_0:
