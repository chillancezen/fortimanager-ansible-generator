...
DOCUMENTATION = '''
---
module: fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/cli/global/fmupdate/fds-setting/push-override-to-client/announce-ip/{announ...'
return_of_api_category_0:
