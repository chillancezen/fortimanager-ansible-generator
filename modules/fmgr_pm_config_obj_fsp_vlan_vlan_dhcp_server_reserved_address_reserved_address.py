...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_fsp_vlan_vlan_dhcp_server_reserved_address_reserved_address
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/fsp/vlan/{vlan}/dhcp-server/reserved-address/{reserved-address}
return_of_api_category_0:
