...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_internet_service_custom_internet_service_custom_entry
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/internet-service-custom/{internet-service-custom}/entry
return_of_api_category_0:
