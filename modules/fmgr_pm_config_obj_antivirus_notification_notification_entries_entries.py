...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_antivirus_notification_notification_entries_entries
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/antivirus/notification/{notification}/entries/{entries}
return_of_api_category_0:
