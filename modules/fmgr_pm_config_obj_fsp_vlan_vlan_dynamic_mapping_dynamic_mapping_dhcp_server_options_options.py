...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_fsp_vlan_vlan_dynamic_mapping_dynamic_mapping_dhcp_server_options_options
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/fsp/vlan/{vlan}/dynamic_mapping/{dynamic_mapping}/dhcp-server/options/{options}
return_of_api_category_0:
