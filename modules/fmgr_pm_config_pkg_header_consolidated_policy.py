...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_header_consolidated_policy
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/HEADER/CONSOLIDATED/POLICY
      fmgr_pm_config_pkg_header_consolidated_policy:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/global/pkg/{pkg}/global/header/consolidated/policy'
return_of_api_category_0:
