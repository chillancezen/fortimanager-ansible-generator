...
DOCUMENTATION = '''
---
module: fmgr_cli_system_ntp_ntpserver_per_object
description:
        ...
        api_tag0:
            data:
                ...
                key:
                    -
                        type: str
                        default: 'ENC MTIwNDIxMDA1OTc0MDU5OOCz7ir5CgpbO/J3sN576PgSwbGc703sZpBwnR5CmNxRjhfSM2FPskJvCPZHAzZOjFTd7B1Ay0Ssf3MwFzNWVdOYL88mw7WTG...'
                key-id:
                    type: int
                    default: 0
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/NTP/NTPSERVER/{NTPSERVER}
      fmgr_cli_system_ntp_ntpserver_per_object:
