...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_dlp_sensor_filter_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/DLP/SENSOR/{SENSOR}/FILTER/{FILTER}
      fmgr_pm_config_obj_dlp_sensor_filter_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/dlp/sensor/{sensor}/filter/{filter}'
return_of_api_category_0:
