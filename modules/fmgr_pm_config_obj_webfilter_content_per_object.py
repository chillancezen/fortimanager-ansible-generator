...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_webfilter_content_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEBFILTER/CONTENT/{CONTENT}
      fmgr_pm_config_obj_webfilter_content_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/webfilter/content/{content}'
return_of_api_category_0:
