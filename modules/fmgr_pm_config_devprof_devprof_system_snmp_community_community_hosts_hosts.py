...
DOCUMENTATION = '''
---
module: fmgr_pm_config_devprof_devprof_system_snmp_community_community_hosts_hosts
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/devprof/{devprof}/system/snmp/community/{community}/hosts/{hosts}
return_of_api_category_0:
