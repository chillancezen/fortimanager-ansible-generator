...
DOCUMENTATION = '''
---
module: fmgr_pm_config_devprof_devprof_system_central_management_server_list_server_list
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/devprof/{devprof}/system/central-management/server-list/{server-list}
return_of_api_category_0:
