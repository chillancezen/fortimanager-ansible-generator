...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wanopt_auth_group_per_object
description:
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                peer:
                    type: str
                    description: 'If peer-accept is set to one, select the name of one peer to add to this authentication group. The peer must have added wi...'
                peer-accept:
                    type: str
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WANOPT/AUTH-GROUP/{AUTH-GROUP}
      fmgr_pm_config_obj_wanopt_auth_group_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/wanopt/auth-group/{auth-group}'
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         data:
            ...
            peer:
               type: str
               description: 'If peer-accept is set to one, select the name of one peer to add to this authentication group. The peer must have added with th...'
            peer-accept:
               type: str
               description: 'Determine if this auth group accepts, any peer, a list of defined peers, or just one peer.'
            psk:
