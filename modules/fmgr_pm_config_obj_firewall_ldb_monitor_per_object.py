...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_ldb_monitor_per_object
description:
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                port:
                    type: int
                    description: 'Service port used to perform the health check. If 0, health check monitor inherits port configured for the server (0 - 656...'
                retry:
                    type: int
                    description: 'Number health check attempts before the server is considered down (1 - 255, default = 3).'
                timeout:
                    type: int
                    description: 'Time to wait to receive response to a health check from a server. Reaching the timeout means the health check failed (1 - ...'
                type:
                    type: str
   ...
   suboptions:
      ...
      result:
         data:
            ...
            port:
               type: int
               description: 'Service port used to perform the health check. If 0, health check monitor inherits port configured for the server (0 - 65635, d...'
            retry:
               type: int
               description: 'Number health check attempts before the server is considered down (1 - 255, default = 3).'
            timeout:
               type: int
               description: 'Time to wait to receive response to a health check from a server. Reaching the timeout means the health check failed (1 - 255 s...'
            type:
               type: str
               description: 'Select the Monitor type used by the health check monitor to check the health of the server (PING | TCP | HTTP).'
         status:
