...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_fsp_vlan_vlan_dhcp_server
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/fsp/vlan/{vlan}/dhcp-server
      fmgr_pm_config_obj_fsp_vlan_vlan_dhcp_server:
         method: <value in [get]>
         url_params:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/fsp/vlan/{vlan}/dhcp-server
return_of_api_category_0:
