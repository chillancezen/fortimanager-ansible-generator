...
DOCUMENTATION = '''
---
module: fmgr_pm_config_devprof_system_central_management_server_list_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/CENTRAL-MANAGEMENT/SERVER-LIST/{SERVER-LIST}
      fmgr_pm_config_devprof_system_central_management_server_list_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/devprof/{devprof}/system/central-management/server-li...'
return_of_api_category_0:
