...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_dlp_filepattern_entries_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/DLP/FILEPATTERN/{FILEPATTERN}/ENTRIES/{ENTRIES}
      fmgr_pm_config_obj_dlp_filepattern_entries_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/dlp/filepattern/{filepattern}/entries/{entries}'
return_of_api_category_0:
