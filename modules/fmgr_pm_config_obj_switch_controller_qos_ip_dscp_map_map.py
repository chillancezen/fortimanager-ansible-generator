...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_qos_ip_dscp_map_map
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SWITCH-CONTROLLER/QOS/IP-DSCP-MAP/{IP-DSCP-MAP}/MAP
      fmgr_pm_config_obj_switch_controller_qos_ip_dscp_map_map:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/switch-controller/qos/ip-dscp-map/{ip-dscp-map}/map'
return_of_api_category_0:
