...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_ippool_dynamic_mapping
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/IPPOOL/{IPPOOL}/DYNAMIC_MAPPING
      fmgr_pm_config_obj_firewall_ippool_dynamic_mapping:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/ippool/{ippool}/dynamic_mapping'
return_of_api_category_0:
