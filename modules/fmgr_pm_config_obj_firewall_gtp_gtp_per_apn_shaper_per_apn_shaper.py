...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_gtp_gtp_per_apn_shaper_per_apn_shaper
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/gtp/{gtp}/per-apn-shaper/{per-apn-shaper}
return_of_api_category_0:
