...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_hotspot20_anqp_nai_realm_anqp_nai_realm_nai_list_nai_list_eap_method_eap_method
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/hotspot20/anqp-nai-realm/{anqp-nai-realm}/nai-list/{nai-list}/eap-method/{eap-method}
return_of_api_category_0:
