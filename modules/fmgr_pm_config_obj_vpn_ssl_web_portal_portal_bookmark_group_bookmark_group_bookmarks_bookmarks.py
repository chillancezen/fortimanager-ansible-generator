...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_vpn_ssl_web_portal_portal_bookmark_group_bookmark_group_bookmarks_bookmarks
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/vpn/ssl/web/portal/{portal}/bookmark-group/{bookmark-group}/bookmarks/{bookmarks}
return_of_api_category_0:
