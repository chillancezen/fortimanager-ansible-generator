...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_profile_protocol_options_profile_protocol_options
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/profile-protocol-options/{profile-protocol-options}
return_of_api_category_0:
