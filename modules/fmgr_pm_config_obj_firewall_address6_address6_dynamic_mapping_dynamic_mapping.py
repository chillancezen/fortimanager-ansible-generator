...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_address6_address6_dynamic_mapping_dynamic_mapping
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/address6/{address6}/dynamic_mapping/{dynamic_mapping}
      fmgr_pm_config_obj_firewall_address6_address6_dynamic_mapping_dynamic_mapping:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/address6/{address6}/dynamic_mapping/{dynamic_mapping}
return_of_api_category_0:
