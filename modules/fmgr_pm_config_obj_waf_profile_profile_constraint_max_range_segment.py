...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_waf_profile_profile_constraint_max_range_segment
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/max-range-segment
return_of_api_category_0:
