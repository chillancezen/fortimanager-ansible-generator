...
DOCUMENTATION = '''
---
module: fmgr_cli_system_log_fetch_client_profile_client_profile_device_filter
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /cli/global/system/log-fetch/client-profile/{client-profile}/device-filter
return_of_api_category_0:
