...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_hotspot20_qos_map_qos_map_dscp_range
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/hotspot20/qos-map/{qos-map}/dscp-range
return_of_api_category_0:
