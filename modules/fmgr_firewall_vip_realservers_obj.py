...
DOCUMENTATION = '''
---
module: fmgr_firewall_vip_realservers_obj
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                max-connections:
                    type: int
                    description: 'Max number of active connections that can be directed to the real server. When reached, sessions are sent to other real se...'
                monitor:
                    type: str
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP/{VIP}/REALSERVERS/{REALSERVERS}
      fmgr_firewall_vip_realservers_obj:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/vip/{vip}/realservers/{realservers}'
return_of_api_category_0:
