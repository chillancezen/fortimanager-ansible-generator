...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_user_device_device_dynamic_mapping_dynamic_mapping
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/user/device/{device}/dynamic_mapping/{dynamic_mapping}
return_of_api_category_0:
