...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_gtp_gtp_ie_remove_policy_ie_remove_policy
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/gtp/{gtp}/ie-remove-policy/{ie-remove-policy}
return_of_api_category_0:
