...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_ips_sensor_sensor_entries_entries_exempt_ip_exempt_ip
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/ips/sensor/{sensor}/entries/{entries}/exempt-ip/{exempt-ip}
return_of_api_category_0:
