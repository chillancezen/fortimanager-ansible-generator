...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_antivirus_mms_checksum_mms_checksum_entries_entries
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/antivirus/mms-checksum/{mms-checksum}/entries/{entries}
return_of_api_category_0:
