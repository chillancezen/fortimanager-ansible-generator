...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_vap_portal_message_overrides
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/VAP/{VAP}/PORTAL-MESSAGE-OVERRIDES
      fmgr_pm_config_obj_wireless_controller_vap_portal_message_overrides:
         method: <value in [get]>
         url_params:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/wireless-controller/vap/{vap}/portal-message-over...'
return_of_api_category_0:
