...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_sdn_connector_sdn_connector_nic_nic_ip_ip
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/system/sdn-connector/{sdn-connector}/nic/{nic}/ip/{ip}
return_of_api_category_0:
