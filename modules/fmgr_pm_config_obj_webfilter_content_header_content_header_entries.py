...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_webfilter_content_header_content_header_entries
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/webfilter/content-header/{content-header}/entries
return_of_api_category_0:
