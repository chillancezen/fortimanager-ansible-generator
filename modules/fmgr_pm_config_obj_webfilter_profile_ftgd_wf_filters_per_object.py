...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_webfilter_profile_ftgd_wf_filters_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEBFILTER/PROFILE/{PROFILE}/FTGD-WF/FILTERS/{FILTERS}
      fmgr_pm_config_obj_webfilter_profile_ftgd_wf_filters_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/webfilter/profile/{profile}/ftgd-wf/filters/{filters}'
return_of_api_category_0:
