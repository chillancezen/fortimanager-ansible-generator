...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_address6_template_subnet_segment_values_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/address6-template/{address6-template}/su...'
return_of_api_category_0:
