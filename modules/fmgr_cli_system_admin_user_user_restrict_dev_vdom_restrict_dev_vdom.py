...
DOCUMENTATION = '''
---
module: fmgr_cli_system_admin_user_user_restrict_dev_vdom_restrict_dev_vdom
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /cli/global/system/admin/user/{user}/restrict-dev-vdom/{restrict-dev-vdom}
return_of_api_category_0:
