...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_lldp_profile_med_network_policy
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SWITCH-CONTROLLER/LLDP-PROFILE/{LLDP-PROFILE}/MED-NETWORK-POLICY
      fmgr_pm_config_obj_switch_controller_lldp_profile_med_network_policy:
      ...
      result:
         data:
            ...
            suboptions:
               dscp:
                  type: int
                  description: 'Advertised Differentiated Services Code Point (DSCP) value, a packet header value indicating the level of service requested ...'
               name:
                  type: str
                  description: 'Policy type name.'
               priority:
