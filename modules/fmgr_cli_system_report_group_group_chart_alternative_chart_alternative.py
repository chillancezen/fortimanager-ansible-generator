...
DOCUMENTATION = '''
---
module: fmgr_cli_system_report_group_group_chart_alternative_chart_alternative
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /cli/global/system/report/group/{group}/chart-alternative/{chart-alternative}
return_of_api_category_0:
