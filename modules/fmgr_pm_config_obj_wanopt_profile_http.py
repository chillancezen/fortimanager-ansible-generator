...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wanopt_profile_http
description:
    ...
    schema_object1:
        ...
        api_tag0:
            data:
                ...
                tunnel-non-http:
                    type: str
                    description: 'Configure how to process non-HTTP traffic when a profile configured for HTTP traffic accepts a non-HTTP session. Can occur...'
                    choices:
                        - 'disable'
                        - 'enable'
                tunnel-sharing:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WANOPT/PROFILE/{PROFILE}/HTTP
      fmgr_pm_config_obj_wanopt_profile_http:
         method: <value in [get]>
         url_params:
   ...
   suboptions:
      ...
      result:
         data:
            ...
            tunnel-non-http:
               type: str
               description: 'Configure how to process non-HTTP traffic when a profile configured for HTTP traffic accepts a non-HTTP session. Can occur if a...'
            tunnel-sharing:
               type: str
               description: 'Tunnel sharing mode for aggressive/non-aggressive and/or interactive/non-interactive protocols.'
            unknown-http-version:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/wanopt/profile/{profile}/http'
return_of_api_category_0:
