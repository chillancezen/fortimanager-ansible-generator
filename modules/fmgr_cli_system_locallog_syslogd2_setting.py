...
DOCUMENTATION = '''
---
module: fmgr_cli_system_locallog_syslogd2_setting
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/LOCALLOG/SYSLOGD2/SETTING
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/cli/global/system/locallog/syslogd2/setting'
return_of_api_category_0:
