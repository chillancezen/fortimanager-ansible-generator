...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_user_device_device_dynamic_mapping
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/device/{device}/dynamic_mapping
      fmgr_pm_config_obj_user_device_device_dynamic_mapping:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/user/device/{device}/dynamic_mapping
return_of_api_category_0:
