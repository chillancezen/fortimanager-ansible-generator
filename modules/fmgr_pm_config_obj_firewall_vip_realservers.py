...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_vip_realservers
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP/{VIP}/REALSERVERS
      fmgr_pm_config_obj_firewall_vip_realservers:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/vip/{vip}/realservers'
return_of_api_category_0:
      ...
      result:
         data:
            ...
            suboptions:
               ...
               max-connections:
                  type: int
                  description: 'Max number of active connections that can be directed to the real server. When reached, sessions are sent to other real serv...'
               monitor:
                  type: str
                  description: 'Name of the health check monitor to use when polling to determine a virtual servers connectivity status.'
               port:
