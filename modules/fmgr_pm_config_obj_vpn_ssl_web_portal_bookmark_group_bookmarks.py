...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_vpn_ssl_web_portal_bookmark_group_bookmarks
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/PORTAL/{PORTAL}/BOOKMARK-GROUP/{BOOKMARK-GROUP}/BOOKMARKS
      fmgr_pm_config_obj_vpn_ssl_web_portal_bookmark_group_bookmarks:
