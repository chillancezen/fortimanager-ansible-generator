...
DOCUMENTATION = '''
---
module: fmgr_sshfilter_profile_shellcommands_obj
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SSH-FILTER/PROFILE/{PROFILE}/SHELL-COMMANDS/{SHELL-COMMANDS}
      fmgr_sshfilter_profile_shellcommands_obj:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/ssh-filter/profile/{profile}/shell-commands/{shel...'
return_of_api_category_0:
