...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_waf_profile_profile_url_access_url_access_access_pattern_access_pattern
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/url-access/{url-access}/access-pattern/{access-pattern}
return_of_api_category_0:
