...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_firewall_local_in_policy6_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/LOCAL-IN-POLICY6/{LOCAL-IN-POLICY6}
      fmgr_pm_config_pkg_firewall_local_in_policy6_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/local-in-policy6/{local-in-policy6}'
return_of_api_category_0:
