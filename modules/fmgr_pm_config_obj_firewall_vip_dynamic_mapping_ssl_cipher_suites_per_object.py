...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_vip_dynamic_mapping_ssl_cipher_suites_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/vip/{vip}/dynamic_mapping/{dynamic_mappi...'
return_of_api_category_0:
