...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_hotspot20_h2qp_osu_provider_h2qp_osu_provider
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/hotspot20/h2qp-osu-provider/{h2qp-osu-provider}
return_of_api_category_0:
