...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_user_security_exempt_list_security_exempt_list
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/user/security-exempt-list/{security-exempt-list}
return_of_api_category_0:
