...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_security_policy_captive_portal_captive_portal
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/switch-controller/security-policy/captive-portal/{captive-portal}
return_of_api_category_0:
