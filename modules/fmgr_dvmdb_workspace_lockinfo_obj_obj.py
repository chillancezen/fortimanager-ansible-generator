...
DOCUMENTATION = '''
---
module: fmgr_dvmdb_workspace_lockinfo_obj_obj
short_description: Get the lock information of a specific object, where the url contains the full path to the object (eg. <i>firewall/address/obj_name</i>).
description:
...
options:
    ...
    schema_object0:
        methods: [get]
        description: 'Get the lock information of a specific object, where the url contains the full path to the object (eg. <i>firewall/address/obj_name</i>).'
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/dvmdb/adom/{adom}/workspace/lockinfo/obj/{object_url_name}'
