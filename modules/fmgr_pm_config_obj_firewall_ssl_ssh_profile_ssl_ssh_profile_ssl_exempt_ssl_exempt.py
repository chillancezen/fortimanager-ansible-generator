...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_ssl_exempt_ssl_exempt
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/ssl-exempt/{ssl-exempt}
return_of_api_category_0:
