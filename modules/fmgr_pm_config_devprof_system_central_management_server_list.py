...
DOCUMENTATION = '''
---
module: fmgr_pm_config_devprof_system_central_management_server_list
description:
...
options:
    ...
    schema_object0:
        ...
        description: 'Additional severs that the FortiGate can use for updates (for AV, IPS, updates) and ratings (for web filter and antispam ratings) serv...'
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/devprof/{devprof}/system/central-management/server-list'
return_of_api_category_0:
