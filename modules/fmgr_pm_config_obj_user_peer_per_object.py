...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_user_peer_per_object
description:
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                mandatory-ca-verify:
                    type: str
                    description: 'Determine what happens to the peer if the CA certificate is not installed. Disable to automatically consider the peer cert...'
                    choices:
                        - 'disable'
                        - 'enable'
                name:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/user/peer/{peer}'
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         data:
            ...
            mandatory-ca-verify:
               type: str
               description: 'Determine what happens to the peer if the CA certificate is not installed. Disable to automatically consider the peer certifica...'
            name:
               type: str
               description: 'Peer name.'
            ocsp-override-server:
