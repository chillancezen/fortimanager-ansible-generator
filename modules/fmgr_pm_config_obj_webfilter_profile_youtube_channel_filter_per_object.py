...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_webfilter_profile_youtube_channel_filter_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEBFILTER/PROFILE/{PROFILE}/YOUTUBE-CHANNEL-FILTER/{YOUTUBE-CHANNEL-FILTER}
      fmgr_pm_config_obj_webfilter_profile_youtube_channel_filter_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/webfilter/profile/{profile}/youtube-channel-filte...'
return_of_api_category_0:
