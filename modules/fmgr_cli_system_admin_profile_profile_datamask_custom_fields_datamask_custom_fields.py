...
DOCUMENTATION = '''
---
module: fmgr_cli_system_admin_profile_profile_datamask_custom_fields_datamask_custom_fields
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /cli/global/system/admin/profile/{profile}/datamask-custom-fields/{datamask-custom-fields}
return_of_api_category_0:
