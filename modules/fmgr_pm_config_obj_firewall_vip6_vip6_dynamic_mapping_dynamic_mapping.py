...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_vip6_vip6_dynamic_mapping_dynamic_mapping
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/vip6/{vip6}/dynamic_mapping/{dynamic_mapping}
return_of_api_category_0:
