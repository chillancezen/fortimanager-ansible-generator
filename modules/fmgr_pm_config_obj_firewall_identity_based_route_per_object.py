...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_identity_based_route_per_object
description:
            ...
            data:
                ...
                rule:
                    -
                        ...
                        groups:
                            type: str
                            description: 'Select one or more group(s) from available groups that are allowed to use this route. Separate group names with a ...'
                        id:
                            type: int
                            description: 'Rule ID.'
    schema_object1:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/identity-based-route/{identity-based-route}'
return_of_api_category_0:
