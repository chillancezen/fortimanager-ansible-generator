...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_waf_profile_url_access_access_pattern_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/waf/profile/{profile}/url-access/{url-access}/acc...'
return_of_api_category_0:
