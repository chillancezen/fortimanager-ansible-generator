...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_sdn_connector_route_table_route_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/system/sdn-connector/{sdn-connector}/route-table/...'
return_of_api_category_0:
