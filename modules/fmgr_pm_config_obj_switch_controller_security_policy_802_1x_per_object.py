...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_security_policy_802_1x_per_object
description:
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                eap-passthru:
                    type: str
                    description: 'Enable/disable EAP pass-through mode, allowing protocols (such as LLDP) to pass through ports for more flexible authentica...'
                    choices:
                        - 'disable'
                        - 'enable'
                guest-auth-delay:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/switch-controller/security-policy/802-1X/{802-1X}'
return_of_api_category_0:
