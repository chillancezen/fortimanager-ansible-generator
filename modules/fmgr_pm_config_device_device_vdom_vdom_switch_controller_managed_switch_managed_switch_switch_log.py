...
DOCUMENTATION = '''
---
module: fmgr_pm_config_device_device_vdom_vdom_switch_controller_managed_switch_managed_switch_switch_log
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/device/{device}/vdom/{vdom}/switch-controller/managed-switch/{managed-switch}/switch-log
return_of_api_category_0:
