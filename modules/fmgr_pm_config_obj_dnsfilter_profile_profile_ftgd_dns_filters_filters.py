...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_dnsfilter_profile_profile_ftgd_dns_filters_filters
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/dnsfilter/profile/{profile}/ftgd-dns/filters/{filters}
return_of_api_category_0:
