...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_vap_vap_mac_filter_list_mac_filter_list
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/vap/{vap}/mac-filter-list/{mac-filter-list}
return_of_api_category_0:
