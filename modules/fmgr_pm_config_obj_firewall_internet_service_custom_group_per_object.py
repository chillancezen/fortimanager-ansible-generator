...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_internet_service_custom_group_per_object
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/internet-service-custom-group/{internet-...'
return_of_api_category_0:
