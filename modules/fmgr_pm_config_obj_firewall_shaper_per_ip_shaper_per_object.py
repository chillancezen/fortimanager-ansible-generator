...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_shaper_per_ip_shaper_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SHAPER/PER-IP-SHAPER/{PER-IP-SHAPER}
      fmgr_pm_config_obj_firewall_shaper_per_ip_shaper_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/shaper/per-ip-shaper/{per-ip-shaper}'
return_of_api_category_0:
