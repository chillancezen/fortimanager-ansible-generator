...
DOCUMENTATION = '''
---
module: fmgr_firewall_address6_dynamicmapping_obj
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/ADDRESS6/{ADDRESS6}/DYNAMIC_MAPPING/{DYNAMIC_MAPPING}
      fmgr_firewall_address6_dynamicmapping_obj:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/address6/{address6}/dynamic_mapping/{dyn...'
return_of_api_category_0:
