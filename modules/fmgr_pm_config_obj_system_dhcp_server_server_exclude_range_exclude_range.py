...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_dhcp_server_server_exclude_range_exclude_range
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/system/dhcp/server/{server}/exclude-range/{exclude-range}
return_of_api_category_0:
