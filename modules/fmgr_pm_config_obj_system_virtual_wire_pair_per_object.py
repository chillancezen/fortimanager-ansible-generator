...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_virtual_wire_pair_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/VIRTUAL-WIRE-PAIR/{VIRTUAL-WIRE-PAIR}
      fmgr_pm_config_obj_system_virtual_wire_pair_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/system/virtual-wire-pair/{virtual-wire-pair}'
return_of_api_category_0:
