...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_firewall_proxy_policy_per_object
description:
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                tags:
                    type: str
                    description: 'Names of object-tags applied to address. Tags need to be preconfigured in config system object-tag. Separate multiple tags...'
                transparent:
                    type: str
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/PROXY-POLICY/{PROXY-POLICY}
      fmgr_pm_config_pkg_firewall_proxy_policy_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/proxy-policy/{proxy-policy}'
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         data:
            ...
            tags:
               type: str
               description: 'Names of object-tags applied to address. Tags need to be preconfigured in config system object-tag. Separate multiple tags with...'
            transparent:
               type: str
               description: 'Enable to use the IP address of the client to connect to the server.'
            users:
