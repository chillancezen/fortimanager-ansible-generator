...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_firewall_multicast_policy
description:
        ...
        api_tag0:
            data:
                -
                    ...
                    snat:
                        type: str
                        description: 'Enable/disable substitution of the outgoing interface IP address for the original source IP address (called source NAT...'
                        choices:
                            - 'disable'
                            - 'enable'
                    snat-ip:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/MULTICAST-POLICY
      fmgr_pm_config_pkg_firewall_multicast_policy:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/pkg/{pkg}/firewall/multicast-policy'
return_of_api_category_0:
      ...
      result:
         data:
            ...
            suboptions:
               ...
               snat:
                  type: str
                  description: 'Enable/disable substitution of the outgoing interface IP address for the original source IP address (called source NAT or SN...'
               snat-ip:
                  type: str
                  description: 'IPv4 address to be used as the source address for NATed traffic.'
               srcaddr:
