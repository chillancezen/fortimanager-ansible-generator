...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_vap_vap_dynamic_mapping_dynamic_mapping
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/wireless-controller/vap/{vap}/dynamic_mapping/{dynamic_mapping}
      fmgr_pm_config_obj_wireless_controller_vap_vap_dynamic_mapping_dynamic_mapping:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/vap/{vap}/dynamic_mapping/{dynamic_mapping}
return_of_api_category_0:
