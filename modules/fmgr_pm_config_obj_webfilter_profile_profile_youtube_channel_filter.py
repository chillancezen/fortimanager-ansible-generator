...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_webfilter_profile_profile_youtube_channel_filter
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/webfilter/profile/{profile}/youtube-channel-filter
return_of_api_category_0:
