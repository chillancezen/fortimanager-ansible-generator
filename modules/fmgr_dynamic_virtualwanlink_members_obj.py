...
DOCUMENTATION = '''
---
module: fmgr_dynamic_virtualwanlink_members_obj
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/DYNAMIC/VIRTUAL-WAN-LINK/MEMBERS/{MEMBERS}
      fmgr_dynamic_virtualwanlink_members_obj:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/dynamic/virtual-wan-link/members/{members}'
return_of_api_category_0:
