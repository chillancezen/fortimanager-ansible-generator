...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_vpn_ssl_web_host_check_software_host_check_software
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/vpn/ssl/web/host-check-software/{host-check-software}
return_of_api_category_0:
