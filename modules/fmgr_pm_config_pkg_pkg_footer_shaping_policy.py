...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_pkg_footer_shaping_policy
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/pkg/{pkg}/footer/shaping-policy
      fmgr_pm_config_pkg_pkg_footer_shaping_policy:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/global/pkg/{pkg}/global/footer/shaping-policy
return_of_api_category_0:
