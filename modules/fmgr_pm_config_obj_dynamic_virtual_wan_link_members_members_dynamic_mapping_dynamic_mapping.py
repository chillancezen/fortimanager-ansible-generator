...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_dynamic_virtual_wan_link_members_members_dynamic_mapping_dynamic_mapping
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/dynamic/virtual-wan-link/members/{members}/dynamic_mapping/{dynamic_mapping}
return_of_api_category_0:
