...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_pkg_footer_policy6_policy6_identity_based_policy6
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/global/pkg/{pkg}/global/footer/policy6/{policy6}/identity-based-policy6
return_of_api_category_0:
