...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_shaping_profile_shaping_profile_shaping_entries
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/shaping-profile/{shaping-profile}/shaping-entries
return_of_api_category_0:
