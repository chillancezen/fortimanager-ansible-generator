        ...
        api_tag0:
            data:
                -
                    ...
                    maximum-bandwidth:
                        type: int
                        description: 'Upper bandwidth limit enforced by this shaper (0 - 16776000). 0 means no limit. Units depend on the bandwidth-unit set...'
                    name:
                        type: str
                        description: 'Traffic shaper name.'
                    per-policy:
                        type: str
                        description: 'Enable/disable applying a separate shaper for each policy. For example, if enabled the guaranteed bandwidth is applied...'
                        choices:
                            - 'disable'
                            - 'enable'
                    priority:
      ...
      result:
         data:
            ...
            suboptions:
               ...
               per-policy:
                  type: str
                  description: 'Enable/disable applying a separate shaper for each policy. For example, if enabled the guaranteed bandwidth is applied separ...'
               priority:
                  type: str
                  description: 'Higher priority traffic is more likely to be forwarded without delays and without compromising the guaranteed bandwidth.'
         status:
