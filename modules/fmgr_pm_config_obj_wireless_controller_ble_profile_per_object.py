...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_ble_profile_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/BLE-PROFILE/{BLE-PROFILE}
      fmgr_pm_config_obj_wireless_controller_ble_profile_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/wireless-controller/ble-profile/{ble-profile}'
return_of_api_category_0:
