...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_webfilter_urlfilter
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/webfilter/urlfilter
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/webfilter/urlfilter
return_of_api_category_0:
