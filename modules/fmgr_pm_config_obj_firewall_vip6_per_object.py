...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_vip6_per_object
description:
            ...
            data:
                ...
                realservers:
                    -
                        ...
                        max-connections:
                            type: int
                            description: 'Max number of active connections that can directed to the real server. When reached, sessions are sent to other re...'
                        monitor:
                            type: str
                            description: 'Name of the health check monitor to use when polling to determine a virtual servers connectivity status.'
                        port:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP6/{VIP6}
      fmgr_pm_config_obj_firewall_vip6_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/vip6/{vip6}'
return_of_api_category_0:
         ...
         data:
            ...
            realservers:
               ...
               suboptions:
                  ...
                  max-connections:
                     type: int
                     description: 'Max number of active connections that can directed to the real server. When reached, sessions are sent to other real serv...'
                  monitor:
                     type: str
                     description: 'Name of the health check monitor to use when polling to determine a virtual servers connectivity status.'
                  port:
