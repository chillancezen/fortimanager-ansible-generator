...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_pkg_footer_policy_policy_identity_based_policy
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/global/pkg/{pkg}/global/footer/policy/{policy}/identity-based-policy
return_of_api_category_0:
