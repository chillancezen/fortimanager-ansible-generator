...
DOCUMENTATION = '''
---
module: fmgr_pm_config_pkg_pkg_header_policy
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/pkg/{pkg}/header/policy
      fmgr_pm_config_pkg_pkg_header_policy:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/global/pkg/{pkg}/global/header/policy
return_of_api_category_0:
