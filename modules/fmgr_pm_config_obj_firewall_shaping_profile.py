...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_shaping_profile
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SHAPING-PROFILE
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/shaping-profile'
return_of_api_category_0:
