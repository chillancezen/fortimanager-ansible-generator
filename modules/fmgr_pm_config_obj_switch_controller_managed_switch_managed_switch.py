...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_managed_switch_managed_switch
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/switch-controller/managed-switch/{managed-switch}
return_of_api_category_0:
