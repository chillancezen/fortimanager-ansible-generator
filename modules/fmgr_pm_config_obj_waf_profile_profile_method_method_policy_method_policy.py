...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_waf_profile_profile_method_method_policy_method_policy
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/method/method-policy/{method-policy}
return_of_api_category_0:
