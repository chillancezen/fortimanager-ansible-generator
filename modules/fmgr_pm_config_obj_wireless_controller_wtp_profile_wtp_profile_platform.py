...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_wtp_profile_wtp_profile_platform
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/wtp-profile/{wtp-profile}/platform
return_of_api_category_0:
