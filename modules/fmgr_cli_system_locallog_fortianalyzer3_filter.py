...
DOCUMENTATION = '''
---
module: fmgr_cli_system_locallog_fortianalyzer3_filter
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/locallog/fortianalyzer3/filter
      fmgr_cli_system_locallog_fortianalyzer3_filter:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /cli/global/system/locallog/fortianalyzer3/filter
return_of_api_category_0:
