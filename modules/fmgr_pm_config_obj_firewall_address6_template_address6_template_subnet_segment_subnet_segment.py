...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_address6_template_address6_template_subnet_segment_subnet_segment
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/address6-template/{address6-template}/subnet-segment/{subnet-segment}
return_of_api_category_0:
