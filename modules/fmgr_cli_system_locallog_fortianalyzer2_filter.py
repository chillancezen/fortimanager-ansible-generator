...
DOCUMENTATION = '''
---
module: fmgr_cli_system_locallog_fortianalyzer2_filter
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/locallog/fortianalyzer2/filter
      fmgr_cli_system_locallog_fortianalyzer2_filter:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /cli/global/system/locallog/fortianalyzer2/filter
return_of_api_category_0:
