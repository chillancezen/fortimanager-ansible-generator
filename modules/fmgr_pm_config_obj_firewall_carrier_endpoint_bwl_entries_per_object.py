...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_entries_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/CARRIER-ENDPOINT-BWL/{CARRIER-ENDPOINT-BWL}/ENTRIES/{ENTRIES}
      fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_entries_per_object:
