...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_schedule_recurring_per_object
description:
...
EXAMPLES = '''
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SCHEDULE/RECURRING/{RECURRING}
      fmgr_pm_config_obj_firewall_schedule_recurring_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/schedule/recurring/{recurring}'
return_of_api_category_0:
