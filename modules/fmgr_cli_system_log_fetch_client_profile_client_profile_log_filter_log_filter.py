...
DOCUMENTATION = '''
---
module: fmgr_cli_system_log_fetch_client_profile_client_profile_log_filter_log_filter
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /cli/global/system/log-fetch/client-profile/{client-profile}/log-filter/{log-filter}
return_of_api_category_0:
