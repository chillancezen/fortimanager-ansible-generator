...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_mms_profile_mms_profile_notif_msisdn_notif_msisdn
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/mms-profile/{mms-profile}/notif-msisdn/{notif-msisdn}
return_of_api_category_0:
