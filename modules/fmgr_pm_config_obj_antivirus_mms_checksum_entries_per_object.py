...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_antivirus_mms_checksum_entries_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/ANTIVIRUS/MMS-CHECKSUM/{MMS-CHECKSUM}/ENTRIES/{ENTRIES}
      fmgr_pm_config_obj_antivirus_mms_checksum_entries_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/antivirus/mms-checksum/{mms-checksum}/entries/{en...'
return_of_api_category_0:
