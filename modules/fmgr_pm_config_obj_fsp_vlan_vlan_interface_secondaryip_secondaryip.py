...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_fsp_vlan_vlan_interface_secondaryip_secondaryip
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/fsp/vlan/{vlan}/interface/secondaryip/{secondaryip}
return_of_api_category_0:
