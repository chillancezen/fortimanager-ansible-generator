...
DOCUMENTATION = '''
---
module: fmgr_dvmdb_workspace_lockinfo_dev_obj
short_description: Get the lock information of a device.
description:
...
options:
    ...
    schema_object0:
        methods: [get]
        description: 'Get the lock information of a device.'
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/dvmdb/adom/{adom}/workspace/lockinfo/dev/{device_name}'
