...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_wireless_controller_vap_vap_vlan_pool_vlan_pool
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/wireless-controller/vap/{vap}/vlan-pool/{vlan-pool}
return_of_api_category_0:
