...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_vip46_vip46_dynamic_mapping_dynamic_mapping
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/vip46/{vip46}/dynamic_mapping/{dynamic_mapping}
return_of_api_category_0:
