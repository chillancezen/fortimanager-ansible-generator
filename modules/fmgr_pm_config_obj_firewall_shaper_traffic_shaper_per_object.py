...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_shaper_traffic_shaper_per_object
description:
    ...
    schema_object0:
        ...
        api_tag0:
            data:
                ...
                per-policy:
                    type: str
                    description: 'Enable/disable applying a separate shaper for each policy. For example, if enabled the guaranteed bandwidth is applied sep...'
                    choices:
                        - 'disable'
                        - 'enable'
                priority:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SHAPER/TRAFFIC-SHAPER/{TRAFFIC-SHAPER}
      fmgr_pm_config_obj_firewall_shaper_traffic_shaper_per_object:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: '/pm/config/adom/{adom}/obj/firewall/shaper/traffic-shaper/{traffic-shaper}'
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         data:
            ...
            per-policy:
               type: str
               description: 'Enable/disable applying a separate shaper for each policy. For example, if enabled the guaranteed bandwidth is applied separate...'
            priority:
               type: str
               description: 'Higher priority traffic is more likely to be forwarded without delays and without compromising the guaranteed bandwidth.'
         status:
