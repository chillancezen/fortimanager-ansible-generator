...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_carrier_endpoint_bwl_entries
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/carrier-endpoint-bwl/{carrier-endpoint-bwl}/entries
return_of_api_category_0:
