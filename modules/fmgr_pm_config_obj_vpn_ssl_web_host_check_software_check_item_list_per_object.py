...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_vpn_ssl_web_host_check_software_check_item_list_per_object
description:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/HOST-CHECK-SOFTWARE/{HOST-CHECK-SOFTWARE}/CHECK-ITEM-LIST/{CHECK-ITEM-LIST}
      fmgr_pm_config_obj_vpn_ssl_web_host_check_software_check_item_list_per_object:
