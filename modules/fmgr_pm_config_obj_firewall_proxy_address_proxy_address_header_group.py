...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_firewall_proxy_address_proxy_address_header_group
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/firewall/proxy-address/{proxy-address}/header-group
return_of_api_category_0:
