...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_system_replacemsg_group_replacemsg_group_ftp_ftp
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/system/replacemsg-group/{replacemsg-group}/ftp/{ftp}
return_of_api_category_0:
