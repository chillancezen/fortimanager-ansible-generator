...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_switch_controller_qos_queue_policy_queue_policy_cos_queue
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/switch-controller/qos/queue-policy/{queue-policy}/cos-queue
return_of_api_category_0:
