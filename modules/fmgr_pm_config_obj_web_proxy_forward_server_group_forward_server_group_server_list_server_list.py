...
DOCUMENTATION = '''
---
module: fmgr_pm_config_obj_web_proxy_forward_server_group_forward_server_group_server_list_server_list
description:
...
return_of_api_category_0:
   ...
   suboptions:
      ...
      result:
         ...
         url:
            type: str
            example: /pm/config/adom/{adom}/obj/web-proxy/forward-server-group/{forward-server-group}/server-list/{server-list}
return_of_api_category_0:
