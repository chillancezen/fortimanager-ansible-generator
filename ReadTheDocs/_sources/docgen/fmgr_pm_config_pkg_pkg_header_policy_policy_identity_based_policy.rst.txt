:source: fmgr_pm_config_pkg_pkg_header_policy_policy_identity_based_policy.py

:orphan:

.. _fmgr_pm_config_pkg_pkg_header_policy_policy_identity_based_policy:

fmgr_pm_config_pkg_pkg_header_policy_policy_identity_based_policy
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/pkg/{pkg}/header/policy/{policy}/identity-based-policy
      fmgr_pm_config_pkg_pkg_header_policy_policy_identity_based_policy:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/global/pkg/{pkg}/global/header/policy/{policy}/identity-based-policy</span>  </li>
 </ul>
