:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile:

fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile -- Configure SSL/SSH protocol options.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}
