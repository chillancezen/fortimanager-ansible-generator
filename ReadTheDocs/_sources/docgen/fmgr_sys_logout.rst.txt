...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [exec]</span> - Log out a session.</li>
 <ul class="ul-self">
 </ul>
 </ul>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /sys/logout</span>  </li>
 </ul>
 </ul>
