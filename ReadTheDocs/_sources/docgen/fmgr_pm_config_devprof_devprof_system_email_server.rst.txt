:source: fmgr_pm_config_devprof_devprof_system_email_server.py

:orphan:

.. _fmgr_pm_config_devprof_devprof_system_email_server:

fmgr_pm_config_devprof_devprof_system_email_server -- Configure the email server used by the FortiGate various things.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/devprof/{devprof}/system/email-server
