:source: fmgr_cli_system_admin_tacacs_tacacs.py

:orphan:

.. _fmgr_cli_system_admin_tacacs_tacacs:

fmgr_cli_system_admin_tacacs_tacacs -- TACACS+ server entry configuration.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [delete, get]</span> - TACACS+ server entry configuration.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - TACACS+ server entry configuration.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/admin/tacacs/{tacacs}
      fmgr_cli_system_admin_tacacs_tacacs:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/admin/tacacs/{tacacs}</span>  </li>
 </ul>
