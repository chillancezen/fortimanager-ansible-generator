:source: fmgr_pm_config_obj_system_dhcp_server_server_ip_range_ip_range.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_server_ip_range_ip_range:

fmgr_pm_config_obj_system_dhcp_server_server_ip_range_ip_range -- DHCP IP range configuration.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - DHCP IP range configuration.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - DHCP IP range configuration.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/dhcp/server/{server}/ip-range/{ip-range}
      fmgr_pm_config_obj_system_dhcp_server_server_ip_range_ip_range:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/dhcp/server/{server}/ip-range/{ip-range}</span>  </li>
 </ul>
