:source: fmgr_dvmdb_workflow_workflow.py

:orphan:

.. _fmgr_dvmdb_workflow_workflow:

fmgr_dvmdb_workflow_workflow -- Read workflow session information.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/workflow/{workflow}
      fmgr_dvmdb_workflow_workflow:
         method: <value in [get]>
         url_params:
