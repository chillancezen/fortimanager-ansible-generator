:source: fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries_entries.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries_entries:

fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries_entries -- Spam filter trusted IP addresses.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Spam filter trusted IP addresses.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Spam filter trusted IP addresses.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/spamfilter/iptrust/{iptrust}/entries/{entries}
      fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries_entries:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/spamfilter/iptrust/{iptrust}/entries/{entries}</span>  </li>
 </ul>
