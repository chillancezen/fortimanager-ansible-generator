:source: fmgr_pm_config_obj_vpnmgr_node_node_protected_subnet_protected_subnet.py

:orphan:

.. _fmgr_pm_config_obj_vpnmgr_node_node_protected_subnet_protected_subnet:

fmgr_pm_config_obj_vpnmgr_node_node_protected_subnet_protected_subnet
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">protected_subnet</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpnmgr/node/{node}/protected_subnet/{protected_subnet}
      fmgr_pm_config_obj_vpnmgr_node_node_protected_subnet_protected_subnet:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            node: <value of string>
            protected_subnet: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpnmgr/node/{node}/protected_subnet/{protected_subnet}</span>  </li>
 </ul>
