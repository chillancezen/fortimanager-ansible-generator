:source: fmgr_dvmdb_script_script.py

:orphan:

.. _fmgr_dvmdb_script_script:

fmgr_dvmdb_script_script -- Script table.
+++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/script/{script}
      fmgr_dvmdb_script_script:
