:source: fmgr_pm_config_obj_user_security_exempt_list_security_exempt_list_rule_rule.py

:orphan:

.. _fmgr_pm_config_obj_user_security_exempt_list_security_exempt_list_rule_rule:

fmgr_pm_config_obj_user_security_exempt_list_security_exempt_list_rule_rule -- Configure rules for exempting users from captive portal authentication.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure rules for exempting users from captive portal authentication.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure rules for exempting users from captive portal authentication.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/security-exempt-list/{security-exempt-list}/rule/{rule}
      fmgr_pm_config_obj_user_security_exempt_list_security_exempt_list_rule_rule:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/security-exempt-list/{security-exempt-list}/rule/{rule}</span>  </li>
 </ul>
