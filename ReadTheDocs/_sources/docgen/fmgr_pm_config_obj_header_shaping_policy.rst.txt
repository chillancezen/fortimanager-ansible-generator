:source: fmgr_pm_config_obj_header_shaping_policy.py

:orphan:

.. _fmgr_pm_config_obj_header_shaping_policy:

fmgr_pm_config_obj_header_shaping_policy
++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/header/shaping-policy
      fmgr_pm_config_obj_header_shaping_policy:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/global/header/shaping-policy</span>  </li>
 </ul>
 </ul>
