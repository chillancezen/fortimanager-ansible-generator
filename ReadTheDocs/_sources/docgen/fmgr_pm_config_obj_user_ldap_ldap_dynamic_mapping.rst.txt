:source: fmgr_pm_config_obj_user_ldap_ldap_dynamic_mapping.py

:orphan:

.. _fmgr_pm_config_obj_user_ldap_ldap_dynamic_mapping:

fmgr_pm_config_obj_user_ldap_ldap_dynamic_mapping
+++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [_scope, account-key-filter, account-key-name, account-key-processing, ca-cert, cnid, dn, filter, group, group-filter, group-member-check, group-object-filter, group-object-search-base, group-search-base, member-attr, obtain-user-info, password, password-expiry-warning, password-renewal, port, retrieve-protection-profile, search-type, secondary-server, secure, server, server-identity-check, source-ip, ssl-min-proto-version, tertiary-server, type, user-info-exchange-server, username]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/ldap/{ldap}/dynamic_mapping
      fmgr_pm_config_obj_user_ldap_ldap_dynamic_mapping:
      ...
      fmgr_pm_config_obj_user_ldap_ldap_dynamic_mapping:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [_scope, account-key-filter, account-key-name, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/ldap/{ldap}/dynamic_mapping</span>  </li>
 </ul>
