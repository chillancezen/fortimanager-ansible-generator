:source: fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_custom_tlvs.py

:orphan:

.. _fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_custom_tlvs:

fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_custom_tlvs -- Configuration method to edit custom TLV entries.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configuration method to edit custom TLV entries.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [information-string, name, oui, subtype]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/switch-controller/lldp-profile/{lldp-profile}/custom-tlvs
      fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_custom_tlvs:
      ...
      fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_custom_tlvs:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [information-string, name, oui, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/switch-controller/lldp-profile/{lldp-profile}/custom-tlvs</span>  </li>
 </ul>
