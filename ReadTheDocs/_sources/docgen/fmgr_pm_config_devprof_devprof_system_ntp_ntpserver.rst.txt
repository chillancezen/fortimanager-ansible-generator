:source: fmgr_pm_config_devprof_devprof_system_ntp_ntpserver.py

:orphan:

.. _fmgr_pm_config_devprof_devprof_system_ntp_ntpserver:

fmgr_pm_config_devprof_devprof_system_ntp_ntpserver -- Configure the FortiGate to connect to any available third-party NTP server.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configure the FortiGate to connect to any available third-party NTP server.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [authentication, id, key, key-id, ntpv3, server]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/devprof/{devprof}/system/ntp/ntpserver
      fmgr_pm_config_devprof_devprof_system_ntp_ntpserver:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/devprof/{devprof}/system/ntp/ntpserver</span>  </li>
 </ul>
