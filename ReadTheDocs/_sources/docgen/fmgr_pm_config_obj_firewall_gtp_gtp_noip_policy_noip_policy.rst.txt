:source: fmgr_pm_config_obj_firewall_gtp_gtp_noip_policy_noip_policy.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_gtp_noip_policy_noip_policy:

fmgr_pm_config_obj_firewall_gtp_gtp_noip_policy_noip_policy -- No IP policy.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">noip-policy</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - No IP policy.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - No IP policy.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - No IP policy.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/gtp/{gtp}/noip-policy/{noip-policy}
      fmgr_pm_config_obj_firewall_gtp_gtp_noip_policy_noip_policy:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            gtp: <value of string>
            noip-policy: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/gtp/{gtp}/noip-policy/{noip-policy}</span>  </li>
 </ul>
