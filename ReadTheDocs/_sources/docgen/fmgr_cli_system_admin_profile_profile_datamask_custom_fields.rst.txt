:source: fmgr_cli_system_admin_profile_profile_datamask_custom_fields.py

:orphan:

.. _fmgr_cli_system_admin_profile_profile_datamask_custom_fields:

fmgr_cli_system_admin_profile_profile_datamask_custom_fields -- Customized datamask fields.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Customized datamask fields.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Customized datamask fields.</li>
 <ul class="ul-self">
 <li><span class="li-head">fields</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [field-category, field-name, field-status, field-type]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/admin/profile/{profile}/datamask-custom-fields
      fmgr_cli_system_admin_profile_profile_datamask_custom_fields:
      ...
      fmgr_cli_system_admin_profile_profile_datamask_custom_fields:
         ...
         params:
            - 
               fields: 
                - 
                   - <value in [field-category, field-name, field-status, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/admin/profile/{profile}/datamask-custom-fields</span>  </li>
 </ul>
