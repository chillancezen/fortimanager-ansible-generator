:source: fmgr_pm_config_pkg_pkg_central_dnat.py

:orphan:

.. _fmgr_pm_config_pkg_pkg_central_dnat:

fmgr_pm_config_pkg_pkg_central_dnat
+++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/pkg/{pkg}/central/dnat
      fmgr_pm_config_pkg_pkg_central_dnat:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/pkg/{pkg}/central/dnat</span>  </li>
 </ul>
