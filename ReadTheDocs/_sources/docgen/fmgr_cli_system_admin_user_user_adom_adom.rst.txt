:source: fmgr_cli_system_admin_user_user_adom_adom.py

:orphan:

.. _fmgr_cli_system_admin_user_user_adom_adom:

fmgr_cli_system_admin_user_user_adom_adom -- Admin domain.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/admin/user/{user}/adom/{adom}
      fmgr_cli_system_admin_user_user_adom_adom:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/admin/user/{user}/adom/{adom}</span>  </li>
 </ul>
