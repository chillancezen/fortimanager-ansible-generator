:source: fmgr_dvm_cmd_update_dev_list.py

:orphan:

.. _fmgr_dvm_cmd_update_dev_list:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [exec]</span> - Refresh FGFM connection and system information for a list of devices.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvm/cmd/update/dev-list
      fmgr_dvm_cmd_update_dev_list:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvm/cmd/update/dev-list</span>  </li>
 </ul>
 </ul>
