:source: fmgr_pm_config_obj_firewall_vipgrp_vipgrp.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vipgrp_vipgrp:

fmgr_pm_config_obj_firewall_vipgrp_vipgrp -- Configure IPv4 virtual IP groups.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">vipgrp</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure IPv4 virtual IP groups.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure IPv4 virtual IP groups.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure IPv4 virtual IP groups.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/vipgrp/{vipgrp}
      fmgr_pm_config_obj_firewall_vipgrp_vipgrp:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            vipgrp: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/vipgrp/{vipgrp}</span>  </li>
 </ul>
 ...
 <li> <span class="li-return"> name </span> - VIP group name. <span class="li-normal">type: str</span>  </li>
