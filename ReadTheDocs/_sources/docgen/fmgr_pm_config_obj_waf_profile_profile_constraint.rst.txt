:source: fmgr_pm_config_obj_waf_profile_profile_constraint.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_profile_constraint:

fmgr_pm_config_obj_waf_profile_profile_constraint -- WAF HTTP protocol restrictions.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/waf/profile/{profile}/constraint
      fmgr_pm_config_obj_waf_profile_profile_constraint:
         method: <value in [get]>
         url_params:
