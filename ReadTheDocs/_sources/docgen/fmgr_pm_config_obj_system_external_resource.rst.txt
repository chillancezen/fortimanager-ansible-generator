:source: fmgr_pm_config_obj_system_external_resource.py

:orphan:

.. _fmgr_pm_config_obj_system_external_resource:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configure external resource.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [category, comments, name, refresh-rate, resource, status, type]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/external-resource
      fmgr_pm_config_obj_system_external_resource:
      ...
      fmgr_pm_config_obj_system_external_resource:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [category, comments, name, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/external-resource</span>  </li>
 </ul>
