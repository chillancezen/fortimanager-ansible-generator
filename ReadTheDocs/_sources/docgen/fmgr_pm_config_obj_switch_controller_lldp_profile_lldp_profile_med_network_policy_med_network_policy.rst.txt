:source: fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_med_network_policy_med_network_policy.py

:orphan:

.. _fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_med_network_policy_med_network_policy:

fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_med_network_policy_med_network_policy -- Configuration method to edit Media Endpoint Discovery (MED) network policy type-length-value (TLV) categories.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">med-network-policy</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configuration method to edit Media Endpoint Discovery (MED) network policy type-length-value (TLV) categories.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configuration method to edit Media Endpoint Discovery (MED) network policy type-length-value (TLV) categories.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/switch-controller/lldp-profile/{lldp-profile}/med-network-policy/{med-network-policy}
      fmgr_pm_config_obj_switch_controller_lldp_profile_lldp_profile_med_network_policy_med_network_policy:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/switch-controller/lldp-profile/{lldp-profile}/med-network-policy/{med-network-policy}</span>  </li>
 </ul>
