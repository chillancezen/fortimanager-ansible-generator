:source: fmgr_pm_config_obj_user_radius_radius_accounting_server.py

:orphan:

.. _fmgr_pm_config_obj_user_radius_radius_accounting_server:

fmgr_pm_config_obj_user_radius_radius_accounting_server -- Additional accounting servers.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Additional accounting servers.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Additional accounting servers.</li>
 <ul class="ul-self">
 <li><span class="li-head">attr</span> - The name of the attribute to retrieve its datasource. <span class="li-normal">type: str</span> </li>
 <li><span class="li-head">fields</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [id, port, secret, server, source-ip, status]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/radius/{radius}/accounting-server
      fmgr_pm_config_obj_user_radius_radius_accounting_server:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/radius/{radius}/accounting-server</span>  </li>
 </ul>
