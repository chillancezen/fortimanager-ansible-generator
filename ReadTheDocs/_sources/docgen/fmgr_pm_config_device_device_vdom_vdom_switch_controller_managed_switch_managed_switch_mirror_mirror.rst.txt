:source: fmgr_pm_config_device_device_vdom_vdom_switch_controller_managed_switch_managed_switch_mirror_mirror.py

:orphan:

.. _fmgr_pm_config_device_device_vdom_vdom_switch_controller_managed_switch_managed_switch_mirror_mirror:

fmgr_pm_config_device_device_vdom_vdom_switch_controller_managed_switch_managed_switch_mirror_mirror -- Configuration method to edit FortiSwitch packet mirror.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/device/{device}/vdom/{vdom}/switch-controller/managed-switch/{managed-switch}/mirror/{mirror}
      fmgr_pm_config_device_device_vdom_vdom_switch_controller_managed_switch_managed_switch_mirror_mirror:
         ...
         params:
            - 
               data:     - name: send request to /pm/config/device/{device}/vdom/{vdom}/switch-controller/managed-switch/{managed-switch}/mirror/{mirror}
      fmgr_pm_config_device_device_vdom_vdom_switch_controller_managed_switch_managed_switch_mirror_mirror:
         method: <value in [get]>
         url_params:
            device: <value of string>
