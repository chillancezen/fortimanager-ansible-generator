:source: fmgr_pm_config_obj_dnsfilter_profile_profile_ftgd_dns.py

:orphan:

.. _fmgr_pm_config_obj_dnsfilter_profile_profile_ftgd_dns:

fmgr_pm_config_obj_dnsfilter_profile_profile_ftgd_dns -- FortiGuard DNS Filter settings.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - FortiGuard DNS Filter settings.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - FortiGuard DNS Filter settings.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [error-allow, ftgd-disable]</span> </li>
 </ul>
 </ul>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/dnsfilter/profile/{profile}/ftgd-dns
      fmgr_pm_config_obj_dnsfilter_profile_profile_ftgd_dns:
         method: <value in [get]>
         url_params:
         ...
         params:
            - 
               data: 
                  ...
                  options: 
                   - <value in [error-allow, ftgd-disable]>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/dnsfilter/profile/{profile}/ftgd-dns</span>  </li>
 </ul>
