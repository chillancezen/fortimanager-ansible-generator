:source: fmgr_cli_system_auto_delete_report_auto_deletion.py

:orphan:

.. _fmgr_cli_system_auto_delete_report_auto_deletion:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/auto-delete/report-auto-deletion
      fmgr_cli_system_auto_delete_report_auto_deletion:
