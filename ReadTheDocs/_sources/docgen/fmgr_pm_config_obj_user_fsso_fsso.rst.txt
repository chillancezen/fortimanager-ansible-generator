:source: fmgr_pm_config_obj_user_fsso_fsso.py

:orphan:

.. _fmgr_pm_config_obj_user_fsso_fsso:

fmgr_pm_config_obj_user_fsso_fsso -- Configure Fortinet Single Sign On (FSSO) agents.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/fsso/{fsso}
      fmgr_pm_config_obj_user_fsso_fsso:
