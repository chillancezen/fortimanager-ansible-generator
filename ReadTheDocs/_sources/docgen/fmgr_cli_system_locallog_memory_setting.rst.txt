:source: fmgr_cli_system_locallog_memory_setting.py

:orphan:

.. _fmgr_cli_system_locallog_memory_setting:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [get]</span> - Settings for memory buffer.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Settings for memory buffer.</li>
 <ul class="ul-self">
...
.. raw:: html
 ...
 <li> <span class="li-return"> diskfull </span> - Action upon disk full. <span class="li-normal">type: str</span>  <span class="li-normal">example: overwrite</span>  </li>
 ...
 <li> <span class="li-return"> status </span> - Enable/disable memory buffer log. <span class="li-normal">type: str</span>  <span class="li-normal">example: disable</span>  </li>
 </ul>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/locallog/memory/setting</span>  </li>
 </ul>
