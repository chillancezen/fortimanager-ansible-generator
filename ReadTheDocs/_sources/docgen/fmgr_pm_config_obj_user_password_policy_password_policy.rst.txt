:source: fmgr_pm_config_obj_user_password_policy_password_policy.py

:orphan:

.. _fmgr_pm_config_obj_user_password_policy_password_policy:

fmgr_pm_config_obj_user_password_policy_password_policy -- Configure user password policy.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">password-policy</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure user password policy.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure user password policy.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/password-policy/{password-policy}
      fmgr_pm_config_obj_user_password_policy_password_policy:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            password-policy: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/password-policy/{password-policy}</span>  </li>
 </ul>
