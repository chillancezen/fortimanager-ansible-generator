:source: fmgr_pm_config_obj_system_sdn_connector_sdn_connector_route_table_route_table_route_route.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_sdn_connector_route_table_route_table_route_route:

fmgr_pm_config_obj_system_sdn_connector_sdn_connector_route_table_route_table_route_route -- Configure Azure route.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">route</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure Azure route.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure Azure route.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure Azure route.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [move]</span> - Configure Azure route.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/sdn-connector/{sdn-connector}/route-table/{route-table}/route/{route}
      fmgr_pm_config_obj_system_sdn_connector_sdn_connector_route_table_route_table_route_route:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            sdn-connector: <value of string>
            route-table: <value of string>
            route: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/sdn-connector/{sdn-connector}/route-table/{route-table}/route/{route}</span>  </li>
 </ul>
