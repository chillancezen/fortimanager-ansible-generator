:source: fmgr_pm_config_obj_dynamic_virtual_wan_link_members_members_dynamic_mapping.py

:orphan:

.. _fmgr_pm_config_obj_dynamic_virtual_wan_link_members_members_dynamic_mapping:

fmgr_pm_config_obj_dynamic_virtual_wan_link_members_members_dynamic_mapping
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [_scope, comment, cost, detect-failtime, detect-http-get, detect-http-match, detect-http-port, detect-interval, detect-protocol, detect-recoverytime, detect-server, detect-timeout, gateway, gateway6, ingress-spillover-threshold, interface, priority, source, source6, spillover-threshold, status, volume-ratio, weight]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/dynamic/virtual-wan-link/members/{members}/dynamic_mapping
      fmgr_pm_config_obj_dynamic_virtual_wan_link_members_members_dynamic_mapping:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/dynamic/virtual-wan-link/members/{members}/dynamic_mapping</span>  </li>
 </ul>
