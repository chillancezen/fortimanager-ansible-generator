:source: fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns.py

:orphan:

.. _fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns:

fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns -- Split DNS for SSL VPN.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Split DNS for SSL VPN.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [dns-server1, dns-server2, domains, id, ipv6-dns-server1, ipv6-dns-server2]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpn/ssl/web/portal/{portal}/split-dns
      fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns:
      ...
      fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [dns-server1, dns-server2, domains, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpn/ssl/web/portal/{portal}/split-dns</span>  </li>
 </ul>
