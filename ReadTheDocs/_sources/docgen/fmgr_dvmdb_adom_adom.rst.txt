:source: fmgr_dvmdb_adom_adom.py

:orphan:

.. _fmgr_dvmdb_adom_adom:

fmgr_dvmdb_adom_adom -- ADOM table, most attributes are read-only and can only be changed internally.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/adom/{adom}
      fmgr_dvmdb_adom_adom:
