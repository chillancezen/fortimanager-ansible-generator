:source: fmgr_dvmdb_workflow_workflow_wflog_wflog.py

:orphan:

.. _fmgr_dvmdb_workflow_workflow_wflog_wflog:

fmgr_dvmdb_workflow_workflow_wflog_wflog -- Read workflow session log.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">wflog</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/workflow/{workflow}/wflog/{wflog}
      fmgr_dvmdb_workflow_workflow_wflog_wflog:
         method: <value in [get]>
         url_params:
            adom: <value in [none, global, custom dom]>
            workflow: <value of string>
            wflog: <value of string>
         params:
            - 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/workflow/{workflow}/wflog/{wflog}</span>  </li>
 </ul>
 </ul>
