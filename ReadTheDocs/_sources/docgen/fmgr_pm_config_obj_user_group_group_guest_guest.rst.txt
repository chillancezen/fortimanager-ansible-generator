:source: fmgr_pm_config_obj_user_group_group_guest_guest.py

:orphan:

.. _fmgr_pm_config_obj_user_group_group_guest_guest:

fmgr_pm_config_obj_user_group_group_guest_guest -- Guest User.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">guest</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Guest User.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Guest User.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/group/{group}/guest/{guest}
      fmgr_pm_config_obj_user_group_group_guest_guest:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/group/{group}/guest/{guest}</span>  </li>
 </ul>
