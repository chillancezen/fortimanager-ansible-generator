:source: fmgr_pm_config_obj_switch_controller_managed_switch.py

:orphan:

.. _fmgr_pm_config_obj_switch_controller_managed_switch:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configure FortiSwitch devices that are managed by this FortiGate.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [_platform, description, name, switch-id]</span> </li>
 </ul>
 </ul>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/switch-controller/managed-switch</span>  </li>
 </ul>
