:source: fmgr_pm_config_obj_firewall_gtp_gtp_message_rate_limit_v1.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_gtp_message_rate_limit_v1:

fmgr_pm_config_obj_firewall_gtp_gtp_message_rate_limit_v1 -- Message rate limiting for GTP version 1.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Message rate limiting for GTP version 1.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Message rate limiting for GTP version 1.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/gtp/{gtp}/message-rate-limit-v1
      fmgr_pm_config_obj_firewall_gtp_gtp_message_rate_limit_v1:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/gtp/{gtp}/message-rate-limit-v1</span>  </li>
 </ul>
