:source: fmgr_pm_config_obj_waf_profile_profile_url_access_url_access_access_pattern_access_pattern.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_profile_url_access_url_access_access_pattern_access_pattern:

fmgr_pm_config_obj_waf_profile_profile_url_access_url_access_access_pattern_access_pattern -- URL access pattern.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">access-pattern</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - URL access pattern.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - URL access pattern.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/waf/profile/{profile}/url-access/{url-access}/access-pattern/{access-pattern}
      fmgr_pm_config_obj_waf_profile_profile_url_access_url_access_access_pattern_access_pattern:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            profile: <value of string>
            url-access: <value of string>
            access-pattern: <value of string>
         params:
            - 
               data: 
                  id: <value of integer>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/url-access/{url-access}/access-pattern/{access-pattern}</span>  </li>
 </ul>
