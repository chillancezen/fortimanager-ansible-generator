:source: fmgr_cli_system_admin_ldap_ldap_adom_adom.py

:orphan:

.. _fmgr_cli_system_admin_ldap_ldap_adom_adom:

fmgr_cli_system_admin_ldap_ldap_adom_adom -- Admin domain.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [delete, get]</span> - Admin domain.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Admin domain.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/admin/ldap/{ldap}/adom/{adom}
      fmgr_cli_system_admin_ldap_ldap_adom_adom:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/admin/ldap/{ldap}/adom/{adom}</span>  </li>
 </ul>
