:source: fmgr_cli_system_log_mail_domain_mail_domain.py

:orphan:

.. _fmgr_cli_system_log_mail_domain_mail_domain:

fmgr_cli_system_log_mail_domain_mail_domain -- FortiMail domain setting.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">mail-domain</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [delete, get]</span> - FortiMail domain setting.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - FortiMail domain setting.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/log/mail-domain/{mail-domain}
      fmgr_cli_system_log_mail_domain_mail_domain:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/log/mail-domain/{mail-domain}</span>  </li>
 </ul>
