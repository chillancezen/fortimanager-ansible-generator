:source: fmgr_pm_config_obj_user_device_device.py

:orphan:

.. _fmgr_pm_config_obj_user_device_device:

fmgr_pm_config_obj_user_device_device -- Configure devices.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure devices.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure devices.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/device/{device}
      fmgr_pm_config_obj_user_device_device:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/device/{device}</span>  </li>
 </ul>
