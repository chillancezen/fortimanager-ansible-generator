:source: fmgr_dvmdb_device_device_vdom_vdom.py

:orphan:

.. _fmgr_dvmdb_device_device_vdom_vdom:

fmgr_dvmdb_device_device_vdom_vdom -- Device VDOM table.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Device VDOM table.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Device VDOM table.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [set, update]</span> - Device VDOM table.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/device/{device}/vdom/{vdom}
      fmgr_dvmdb_device_device_vdom_vdom:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/device/{device}/vdom/{vdom}</span>  </li>
 </ul>
