:source: fmgr_pm_config_obj_user_fsso_polling_fsso_polling.py

:orphan:

.. _fmgr_pm_config_obj_user_fsso_polling_fsso_polling:

fmgr_pm_config_obj_user_fsso_polling_fsso_polling -- Configure FSSO active directory servers for polling mode.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/fsso-polling/{fsso-polling}
      fmgr_pm_config_obj_user_fsso_polling_fsso_polling:
