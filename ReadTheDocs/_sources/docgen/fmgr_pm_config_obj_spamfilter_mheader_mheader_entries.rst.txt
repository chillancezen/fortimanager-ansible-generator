:source: fmgr_pm_config_obj_spamfilter_mheader_mheader_entries.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_mheader_mheader_entries:

fmgr_pm_config_obj_spamfilter_mheader_mheader_entries -- Spam filter mime header content.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Spam filter mime header content.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [action, fieldbody, fieldname, id, pattern-type, status]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/spamfilter/mheader/{mheader}/entries
      fmgr_pm_config_obj_spamfilter_mheader_mheader_entries:
      ...
      fmgr_pm_config_obj_spamfilter_mheader_mheader_entries:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [action, fieldbody, fieldname, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/spamfilter/mheader/{mheader}/entries</span>  </li>
 </ul>
