:source: fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns_split_dns.py

:orphan:

.. _fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns_split_dns:

fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns_split_dns -- Split DNS for SSL VPN.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">split-dns</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Split DNS for SSL VPN.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Split DNS for SSL VPN.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Split DNS for SSL VPN.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [move]</span> - Split DNS for SSL VPN.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpn/ssl/web/portal/{portal}/split-dns/{split-dns}
      fmgr_pm_config_obj_vpn_ssl_web_portal_portal_split_dns_split_dns:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            portal: <value of string>
            split-dns: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpn/ssl/web/portal/{portal}/split-dns/{split-dns}</span>  </li>
 </ul>
