:source: fmgr_pm_config_obj_vpn_certificate_remote.py

:orphan:

.. _fmgr_pm_config_obj_vpn_certificate_remote:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Remote certificate as a PEM file.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [name, range, remote, source]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpn/certificate/remote
      fmgr_pm_config_obj_vpn_certificate_remote:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpn/certificate/remote</span>  </li>
 </ul>
