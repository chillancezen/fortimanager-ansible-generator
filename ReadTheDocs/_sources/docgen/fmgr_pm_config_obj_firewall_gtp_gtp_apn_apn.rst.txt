:source: fmgr_pm_config_obj_firewall_gtp_gtp_apn_apn.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_gtp_apn_apn:

fmgr_pm_config_obj_firewall_gtp_gtp_apn_apn -- APN.
+++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">apn</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - APN.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - APN.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/gtp/{gtp}/apn/{apn}
      fmgr_pm_config_obj_firewall_gtp_gtp_apn_apn:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/gtp/{gtp}/apn/{apn}</span>  </li>
 </ul>
