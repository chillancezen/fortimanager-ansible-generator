:source: fmgr_pm_config_obj_user_security_exempt_list.py

:orphan:

.. _fmgr_pm_config_obj_user_security_exempt_list:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configure security exemption list.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/security-exempt-list
      fmgr_pm_config_obj_user_security_exempt_list:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/security-exempt-list</span>  </li>
 </ul>
