:source: fmgr_pm_config_obj_waf_profile_profile_constraint_param_length.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_profile_constraint_param_length:

fmgr_pm_config_obj_waf_profile_profile_constraint_param_length -- Maximum length of parameter in URL, HTTP POST request or HTTP body.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Maximum length of parameter in URL, HTTP POST request or HTTP body.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Maximum length of parameter in URL, HTTP POST request or HTTP body.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/waf/profile/{profile}/constraint/param-length
      fmgr_pm_config_obj_waf_profile_profile_constraint_param_length:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/param-length</span>  </li>
 </ul>
