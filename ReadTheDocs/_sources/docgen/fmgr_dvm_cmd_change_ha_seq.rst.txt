:source: fmgr_dvm_cmd_change_ha_seq.py

:orphan:

.. _fmgr_dvm_cmd_change_ha_seq:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [exec]</span> - Modify HA sequence to promote a slave to become the master of the cluster.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvm/cmd/change-ha-seq
      fmgr_dvm_cmd_change_ha_seq:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvm/cmd/change-ha-seq</span>  </li>
 </ul>
 </ul>
