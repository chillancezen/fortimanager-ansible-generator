:source: fmgr_pm_config_obj_system_dhcp_server_server_options_options.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_server_options_options:

fmgr_pm_config_obj_system_dhcp_server_server_options_options -- DHCP options.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">options</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - DHCP options.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - DHCP options.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - DHCP options.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/dhcp/server/{server}/options/{options}
      fmgr_pm_config_obj_system_dhcp_server_server_options_options:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            server: <value of string>
            options: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/dhcp/server/{server}/options/{options}</span>  </li>
 </ul>
