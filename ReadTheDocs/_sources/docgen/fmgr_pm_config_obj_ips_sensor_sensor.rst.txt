:source: fmgr_pm_config_obj_ips_sensor_sensor.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_sensor:

fmgr_pm_config_obj_ips_sensor_sensor -- Configure IPS sensor.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/ips/sensor/{sensor}
