:source: fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check_sla.py

:orphan:

.. _fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check_sla:

fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check_sla -- Service level agreement (SLA).
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Service level agreement (SLA).</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [id, jitter-threshold, latency-threshold, link-cost-factor, packetloss-threshold]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/wanprof/{wanprof}/system/virtual-wan-link/health-check/{health-check}/sla
      fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check_sla:
      ...
      fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check_sla:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [id, jitter-threshold, latency-threshold, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/wanprof/{wanprof}/system/virtual-wan-link/health-check/{health-check}/sla</span>  </li>
 </ul>
