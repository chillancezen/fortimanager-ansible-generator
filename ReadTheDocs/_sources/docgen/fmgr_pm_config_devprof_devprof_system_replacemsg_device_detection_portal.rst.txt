:source: fmgr_pm_config_devprof_devprof_system_replacemsg_device_detection_portal.py

:orphan:

.. _fmgr_pm_config_devprof_devprof_system_replacemsg_device_detection_portal:

fmgr_pm_config_devprof_devprof_system_replacemsg_device_detection_portal -- Replacement messages.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Replacement messages.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Replacement messages.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/devprof/{devprof}/system/replacemsg/device-detection-portal
      fmgr_pm_config_devprof_devprof_system_replacemsg_device_detection_portal:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/devprof/{devprof}/system/replacemsg/device-detection-portal</span>  </li>
 </ul>
