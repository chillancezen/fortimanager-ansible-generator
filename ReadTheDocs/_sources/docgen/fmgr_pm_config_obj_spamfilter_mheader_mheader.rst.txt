:source: fmgr_pm_config_obj_spamfilter_mheader_mheader.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_mheader_mheader:

fmgr_pm_config_obj_spamfilter_mheader_mheader -- Configure AntiSpam MIME header.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure AntiSpam MIME header.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure AntiSpam MIME header.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure AntiSpam MIME header.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/spamfilter/mheader/{mheader}
      fmgr_pm_config_obj_spamfilter_mheader_mheader:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/spamfilter/mheader/{mheader}</span>  </li>
 </ul>
