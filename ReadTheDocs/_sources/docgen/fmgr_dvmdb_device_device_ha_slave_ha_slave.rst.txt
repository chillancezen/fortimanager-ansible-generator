:source: fmgr_dvmdb_device_device_ha_slave_ha_slave.py

:orphan:

.. _fmgr_dvmdb_device_device_ha_slave_ha_slave:

fmgr_dvmdb_device_device_ha_slave_ha_slave -- HA Slave table, read-only.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">ha_slave</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/device/{device}/ha_slave/{ha_slave}
      fmgr_dvmdb_device_device_ha_slave_ha_slave:
         method: <value in [get]>
         url_params:
            adom: <value in [none, global, custom dom]>
            device: <value of string>
            ha_slave: <value of string>
         params:
            - 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/device/{device}/ha_slave/{ha_slave}</span>  </li>
 </ul>
 </ul>
