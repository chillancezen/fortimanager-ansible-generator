:source: fmgr_pm_config_obj_firewall_internet_service_entry_entry.py

:orphan:

.. _fmgr_pm_config_obj_firewall_internet_service_entry_entry:

fmgr_pm_config_obj_firewall_internet_service_entry_entry -- Entries in the Internet Service database.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Entries in the Internet Service database.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Entries in the Internet Service database.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/internet-service/entry/{entry}
      fmgr_pm_config_obj_firewall_internet_service_entry_entry:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/internet-service/entry/{entry}</span>  </li>
 </ul>
