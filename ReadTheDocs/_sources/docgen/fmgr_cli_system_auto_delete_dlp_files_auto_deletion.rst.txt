:source: fmgr_cli_system_auto_delete_dlp_files_auto_deletion.py

:orphan:

.. _fmgr_cli_system_auto_delete_dlp_files_auto_deletion:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [get]</span> - Automatic deletion policy for DLP archives.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Automatic deletion policy for DLP archives.</li>
 <ul class="ul-self">
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/auto-delete/dlp-files-auto-deletion</span>  </li>
 </ul>
