:source: fmgr_pm_config_devprof_devprof_system_snmp_community_community_hosts.py

:orphan:

.. _fmgr_pm_config_devprof_devprof_system_snmp_community_community_hosts:

fmgr_pm_config_devprof_devprof_system_snmp_community_community_hosts -- Configure IPv4 SNMP managers (hosts).
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configure IPv4 SNMP managers (hosts).</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [ha-direct, host-type, id, ip, source-ip]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/devprof/{devprof}/system/snmp/community/{community}/hosts
      fmgr_pm_config_devprof_devprof_system_snmp_community_community_hosts:
      ...
      fmgr_pm_config_devprof_devprof_system_snmp_community_community_hosts:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [ha-direct, host-type, id, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/devprof/{devprof}/system/snmp/community/{community}/hosts</span>  </li>
 </ul>
