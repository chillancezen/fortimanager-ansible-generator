:source: fmgr_pm_config_obj_user_password_policy_per_object.py

:orphan:

.. _fmgr_pm_config_obj_user_password_policy_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/PASSWORD-POLICY/{PASSWORD-POLICY}
      fmgr_pm_config_obj_user_password_policy_per_object:
