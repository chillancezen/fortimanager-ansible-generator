:source: fmgr_pm_config_devprof_system_replacemsg_fortiguard_wf.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_fortiguard_wf:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/FORTIGUARD-WF
      fmgr_pm_config_devprof_system_replacemsg_fortiguard_wf:
         method: <value in [get]>
         url_params:
