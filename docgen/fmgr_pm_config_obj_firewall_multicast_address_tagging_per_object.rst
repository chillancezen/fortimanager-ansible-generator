:source: fmgr_pm_config_obj_firewall_multicast_address_tagging_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_multicast_address_tagging_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/MULTICAST-ADDRESS/{MULTICAST-ADDRESS}/TAGGING/{TAGGING}
      fmgr_pm_config_obj_firewall_multicast_address_tagging_per_object:
