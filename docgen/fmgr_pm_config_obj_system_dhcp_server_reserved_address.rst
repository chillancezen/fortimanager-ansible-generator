:source: fmgr_pm_config_obj_system_dhcp_server_reserved_address.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_reserved_address:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/DHCP/SERVER/{SERVER}/RESERVED-ADDRESS
      fmgr_pm_config_obj_system_dhcp_server_reserved_address:
