:source: fmgr_pm_config_obj_antivirus_mms_checksum_per_object.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_mms_checksum_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/ANTIVIRUS/MMS-CHECKSUM/{MMS-CHECKSUM}
      fmgr_pm_config_obj_antivirus_mms_checksum_per_object:
