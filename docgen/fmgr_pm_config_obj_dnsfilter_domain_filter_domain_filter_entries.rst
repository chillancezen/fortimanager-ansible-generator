:source: fmgr_pm_config_obj_dnsfilter_domain_filter_domain_filter_entries.py

:orphan:

.. _fmgr_pm_config_obj_dnsfilter_domain_filter_domain_filter_entries:

fmgr_pm_config_obj_dnsfilter_domain_filter_domain_filter_entries -- DNS domain filter entries.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - DNS domain filter entries.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [action, domain, id, status, type]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/dnsfilter/domain-filter/{domain-filter}/entries
      fmgr_pm_config_obj_dnsfilter_domain_filter_domain_filter_entries:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/dnsfilter/domain-filter/{domain-filter}/entries</span>  </li>
 </ul>
