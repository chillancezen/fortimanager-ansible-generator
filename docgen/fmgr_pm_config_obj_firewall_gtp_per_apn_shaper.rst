:source: fmgr_pm_config_obj_firewall_gtp_per_apn_shaper.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_per_apn_shaper:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/GTP/{GTP}/PER-APN-SHAPER
      fmgr_pm_config_obj_firewall_gtp_per_apn_shaper:
