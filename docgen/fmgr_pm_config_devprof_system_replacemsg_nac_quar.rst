:source: fmgr_pm_config_devprof_system_replacemsg_nac_quar.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_nac_quar:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/NAC-QUAR
      fmgr_pm_config_devprof_system_replacemsg_nac_quar:
         method: <value in [get]>
         url_params:
