:source: fmgr_pm_config_obj_system_replacemsg_group_alertmail.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_alertmail:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/ALERTMAIL
      fmgr_pm_config_obj_system_replacemsg_group_alertmail:
