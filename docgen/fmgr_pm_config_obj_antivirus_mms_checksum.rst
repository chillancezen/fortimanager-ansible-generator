:source: fmgr_pm_config_obj_antivirus_mms_checksum.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_mms_checksum:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configure MMS content checksum list.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/antivirus/mms-checksum
      fmgr_pm_config_obj_antivirus_mms_checksum:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/antivirus/mms-checksum</span>  </li>
 </ul>
