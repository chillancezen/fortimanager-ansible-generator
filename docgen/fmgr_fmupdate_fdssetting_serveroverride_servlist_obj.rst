:source: fmgr_fmupdate_fdssetting_serveroverride_servlist_obj.py

:orphan:

.. _fmgr_fmupdate_fdssetting_serveroverride_servlist_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/FMUPDATE/FDS-SETTING/SERVER-OVERRIDE/SERVLIST/{SERVLIST}
      fmgr_fmupdate_fdssetting_serveroverride_servlist_obj:
