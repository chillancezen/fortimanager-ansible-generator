:source: fmgr_pm_config_obj_system_replacemsg_group_custom_message.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_custom_message:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/CUSTOM-MESSAGE
      fmgr_pm_config_obj_system_replacemsg_group_custom_message:
