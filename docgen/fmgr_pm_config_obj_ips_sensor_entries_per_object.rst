:source: fmgr_pm_config_obj_ips_sensor_entries_per_object.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_entries_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/IPS/SENSOR/{SENSOR}/ENTRIES/{ENTRIES}
      fmgr_pm_config_obj_ips_sensor_entries_per_object:
