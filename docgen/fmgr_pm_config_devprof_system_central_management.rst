:source: fmgr_pm_config_devprof_system_central_management.py

:orphan:

.. _fmgr_pm_config_devprof_system_central_management:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/CENTRAL-MANAGEMENT
      fmgr_pm_config_devprof_system_central_management:
         method: <value in [get]>
         url_params:
