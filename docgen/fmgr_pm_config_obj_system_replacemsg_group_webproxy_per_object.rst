:source: fmgr_pm_config_obj_system_replacemsg_group_webproxy_per_object.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_webproxy_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/WEBPROXY/{WEBPROXY}
      fmgr_pm_config_obj_system_replacemsg_group_webproxy_per_object:
