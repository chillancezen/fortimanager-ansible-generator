:source: fmgr_pm_config_pkg_firewall_central_snat_map.py

:orphan:

.. _fmgr_pm_config_pkg_firewall_central_snat_map:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/CENTRAL-SNAT-MAP
      fmgr_pm_config_pkg_firewall_central_snat_map:
