:source: fmgr_cli_system_report_group_chart_alternative.py

:orphan:

.. _fmgr_cli_system_report_group_chart_alternative:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/REPORT/GROUP/{GROUP}/CHART-ALTERNATIVE
      fmgr_cli_system_report_group_chart_alternative:
