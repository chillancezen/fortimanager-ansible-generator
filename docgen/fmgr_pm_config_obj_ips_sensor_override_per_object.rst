:source: fmgr_pm_config_obj_ips_sensor_override_per_object.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_override_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/IPS/SENSOR/{SENSOR}/OVERRIDE/{OVERRIDE}
      fmgr_pm_config_obj_ips_sensor_override_per_object:
