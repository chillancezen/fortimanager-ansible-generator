:source: fmgr_pm_config_devprof_system_replacemsg_http.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_http:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/HTTP
      fmgr_pm_config_devprof_system_replacemsg_http:
         method: <value in [get]>
         url_params:
