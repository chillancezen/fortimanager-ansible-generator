:source: fmgr_pm_config_obj_wireless_controller_hotspot20_anqp_nai_realm_per_object.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_hotspot20_anqp_nai_realm_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/HOTSPOT20/ANQP-NAI-REALM/{ANQP-NAI-REALM}
      fmgr_pm_config_obj_wireless_controller_hotspot20_anqp_nai_realm_per_object:
