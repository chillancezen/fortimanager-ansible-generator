:source: fmgr_pm_config_devprof_system_snmp_community_hosts.py

:orphan:

.. _fmgr_pm_config_devprof_system_snmp_community_hosts:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/SNMP/COMMUNITY/{COMMUNITY}/HOSTS
      fmgr_pm_config_devprof_system_snmp_community_hosts:
