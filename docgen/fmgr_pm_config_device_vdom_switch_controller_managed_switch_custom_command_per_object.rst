:source: fmgr_pm_config_device_vdom_switch_controller_managed_switch_custom_command_per_object.py

:orphan:

.. _fmgr_pm_config_device_vdom_switch_controller_managed_switch_custom_command_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVICE/{DEVICE}/VDOM/{VDOM}/SWITCH-CONTROLLER/MANAGED-SWITCH/{MANAGED-SWITCH}/CUSTOM-COMMAND/{CUSTOM-COMMAND}
      fmgr_pm_config_device_vdom_switch_controller_managed_switch_custom_command_per_object:
