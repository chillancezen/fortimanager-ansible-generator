:source: fmgr_dvmdb_workflow_submit_session_id.py

:orphan:

.. _fmgr_dvmdb_workflow_submit_session_id:

fmgr_dvmdb_workflow_submit_session_id
+++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">mail_user</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/workflow/submit/{session_id}
      fmgr_dvmdb_workflow_submit_session_id:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/workflow/submit/{session_id}</span>  </li>
 </ul>
 </ul>
