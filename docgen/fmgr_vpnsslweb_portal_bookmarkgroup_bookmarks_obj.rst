:source: fmgr_vpnsslweb_portal_bookmarkgroup_bookmarks_obj.py

:orphan:

.. _fmgr_vpnsslweb_portal_bookmarkgroup_bookmarks_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/PORTAL/{PORTAL}/BOOKMARK-GROUP/{BOOKMARK-GROUP}/BOOKMARKS/{BOOKMARKS}
      fmgr_vpnsslweb_portal_bookmarkgroup_bookmarks_obj:
