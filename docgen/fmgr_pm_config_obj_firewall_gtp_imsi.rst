:source: fmgr_pm_config_obj_firewall_gtp_imsi.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_imsi:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/GTP/{GTP}/IMSI
      fmgr_pm_config_obj_firewall_gtp_imsi:
