:source: fmgr_pm_config_pkg_firewall_multicast_policy6_per_object.py

:orphan:

.. _fmgr_pm_config_pkg_firewall_multicast_policy6_per_object:
...
.. raw:: html
 ...
 <li><span class="li-head">multicast-policy6</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure IPv6 multicast NAT policies.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure IPv6 multicast NAT policies.</li>
 <ul class="ul-self">
 </ul>
 ...
 <li><span class="li-head">parameters for method: [move]</span> - Configure IPv6 multicast NAT policies.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/MULTICAST-POLICY6/{MULTICAST-POLICY6}
      fmgr_pm_config_pkg_firewall_multicast_policy6_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/pkg/{pkg}/firewall/multicast-policy6/{multicast-policy6}</span>  </li>
 </ul>
