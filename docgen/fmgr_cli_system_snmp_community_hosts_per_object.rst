:source: fmgr_cli_system_snmp_community_hosts_per_object.py

:orphan:

.. _fmgr_cli_system_snmp_community_hosts_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/SNMP/COMMUNITY/{COMMUNITY}/HOSTS/{HOSTS}
      fmgr_cli_system_snmp_community_hosts_per_object:
