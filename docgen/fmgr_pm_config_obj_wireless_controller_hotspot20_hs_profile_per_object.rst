:source: fmgr_pm_config_obj_wireless_controller_hotspot20_hs_profile_per_object.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_hotspot20_hs_profile_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/HOTSPOT20/HS-PROFILE/{HS-PROFILE}
      fmgr_pm_config_obj_wireless_controller_hotspot20_hs_profile_per_object:
