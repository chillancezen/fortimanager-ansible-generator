:source: fmgr_cli_system_metadata_admins_per_object.py

:orphan:

.. _fmgr_cli_system_metadata_admins_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/METADATA/ADMINS/{ADMINS}
      fmgr_cli_system_metadata_admins_per_object:
