:source: fmgr_pm_config_pkg_central_dnat_per_object.py

:orphan:

.. _fmgr_pm_config_pkg_central_dnat_per_object:

fmgr_pm_config_pkg_central_dnat_per_object
++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">dnat</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 ...
 <li><span class="li-head">parameters for method: [move]</span> - </li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/CENTRAL/DNAT/{DNAT}
      fmgr_pm_config_pkg_central_dnat_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/pkg/{pkg}/central/dnat/{dnat}</span>  </li>
 </ul>
