:source: fmgr_pm_config_obj_firewall_gtp_ip_policy_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_ip_policy_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/GTP/{GTP}/IP-POLICY/{IP-POLICY}
      fmgr_pm_config_obj_firewall_gtp_ip_policy_per_object:
