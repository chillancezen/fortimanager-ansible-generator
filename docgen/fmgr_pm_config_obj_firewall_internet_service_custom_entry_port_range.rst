:source: fmgr_pm_config_obj_firewall_internet_service_custom_entry_port_range.py

:orphan:

.. _fmgr_pm_config_obj_firewall_internet_service_custom_entry_port_range:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/INTERNET-SERVICE-CUSTOM/{INTERNET-SERVICE-CUSTOM}/ENTRY/{ENTRY}/PORT-RANGE
      fmgr_pm_config_obj_firewall_internet_service_custom_entry_port_range:
