:source: fmgr_cli_system_auto_delete_log_auto_deletion.py

:orphan:

.. _fmgr_cli_system_auto_delete_log_auto_deletion:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [get]</span> - Automatic deletion policy for device logs.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Automatic deletion policy for device logs.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">runat</span> - Automatic deletion run at (0 - 23) o'clock. <span class="li-normal">type: int</span>  <span class="li-normal">default: 0</span> </li>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/auto-delete/log-auto-deletion
      fmgr_cli_system_auto_delete_log_auto_deletion:
...
.. raw:: html
 ...
 <li> <span class="li-return"> runat </span> - Automatic deletion run at (0 - 23) o'clock. <span class="li-normal">type: int</span>  <span class="li-normal">example: 0</span>  </li>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/auto-delete/log-auto-deletion</span>  </li>
 </ul>
