:source: fmgr_cli_system_admin_user_user_meta_data_meta_data.py

:orphan:

.. _fmgr_cli_system_admin_user_user_meta_data_meta_data:

fmgr_cli_system_admin_user_user_meta_data_meta_data -- Configure meta data.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">meta-data</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [delete, get]</span> - Configure meta data.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Configure meta data.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/admin/user/{user}/meta-data/{meta-data}
      fmgr_cli_system_admin_user_user_meta_data_meta_data:
         method: <value in [set, update]>
         url_params:
            user: <value of string>
            meta-data: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/admin/user/{user}/meta-data/{meta-data}</span>  </li>
 </ul>
