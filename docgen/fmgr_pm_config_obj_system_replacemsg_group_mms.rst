:source: fmgr_pm_config_obj_system_replacemsg_group_mms.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_mms:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/MMS
      fmgr_pm_config_obj_system_replacemsg_group_mms:
