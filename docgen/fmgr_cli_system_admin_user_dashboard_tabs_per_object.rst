:source: fmgr_cli_system_admin_user_dashboard_tabs_per_object.py

:orphan:

.. _fmgr_cli_system_admin_user_dashboard_tabs_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/ADMIN/USER/{USER}/DASHBOARD-TABS/{DASHBOARD-TABS}
      fmgr_cli_system_admin_user_dashboard_tabs_per_object:
