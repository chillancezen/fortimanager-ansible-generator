:source: fmgr_pm_config_obj_switch_controller_managed_switch_per_object.py

:orphan:

.. _fmgr_pm_config_obj_switch_controller_managed_switch_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SWITCH-CONTROLLER/MANAGED-SWITCH/{MANAGED-SWITCH}
      fmgr_pm_config_obj_switch_controller_managed_switch_per_object:
