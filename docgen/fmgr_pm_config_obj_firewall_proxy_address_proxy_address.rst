:source: fmgr_pm_config_obj_firewall_proxy_address_proxy_address.py

:orphan:

.. _fmgr_pm_config_obj_firewall_proxy_address_proxy_address:

fmgr_pm_config_obj_firewall_proxy_address_proxy_address -- Web proxy address configuration.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Web proxy address configuration.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Web proxy address configuration.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/proxy-address/{proxy-address}
      fmgr_pm_config_obj_firewall_proxy_address_proxy_address:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/proxy-address/{proxy-address}</span>  </li>
 </ul>
