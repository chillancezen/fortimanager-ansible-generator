:source: fmgr_pm_config_obj_ssh_filter_profile_profile_shell_commands.py

:orphan:

.. _fmgr_pm_config_obj_ssh_filter_profile_profile_shell_commands:

fmgr_pm_config_obj_ssh_filter_profile_profile_shell_commands -- SSH command filter.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - SSH command filter.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [action, alert, id, log, pattern, severity, type]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/ssh-filter/profile/{profile}/shell-commands
      fmgr_pm_config_obj_ssh_filter_profile_profile_shell_commands:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/ssh-filter/profile/{profile}/shell-commands</span>  </li>
 </ul>
