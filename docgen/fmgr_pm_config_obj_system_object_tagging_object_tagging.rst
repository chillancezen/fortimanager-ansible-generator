:source: fmgr_pm_config_obj_system_object_tagging_object_tagging.py

:orphan:

.. _fmgr_pm_config_obj_system_object_tagging_object_tagging:

fmgr_pm_config_obj_system_object_tagging_object_tagging -- Configure object tagging.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">object-tagging</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure object tagging.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure object tagging.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure object tagging.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/object-tagging/{object-tagging}
      fmgr_pm_config_obj_system_object_tagging_object_tagging:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            object-tagging: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/object-tagging/{object-tagging}</span>  </li>
 </ul>
 <li><span class="li-return"> return values for method: [get]</span> </li>
 <ul class="ul-self">
 <li><span class="li-return">data</span>
 - No description for the parameter <span class="li-normal">type: dict</span> <ul class="ul-self">
 <li> <span class="li-return"> address </span> - Address. <span class="li-normal">type: str</span>  </li>
 ...
 <li> <span class="li-return"> device </span> - Device. <span class="li-normal">type: str</span>  </li>
 <li> <span class="li-return"> interface </span> - Interface. <span class="li-normal">type: str</span>  </li>
 <li> <span class="li-return"> multiple </span> - Allow multiple tag selection. <span class="li-normal">type: str</span>  </li>
