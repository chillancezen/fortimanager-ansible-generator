:source: fmgr_dvmdb_workflow_reject_session_id.py

:orphan:

.. _fmgr_dvmdb_workflow_reject_session_id:

fmgr_dvmdb_workflow_reject_session_id
+++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/workflow/reject/{session_id}
      fmgr_dvmdb_workflow_reject_session_id:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/workflow/reject/{session_id}</span>  </li>
 </ul>
 </ul>
