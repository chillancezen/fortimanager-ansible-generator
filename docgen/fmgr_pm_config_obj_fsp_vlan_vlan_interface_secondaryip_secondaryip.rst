:source: fmgr_pm_config_obj_fsp_vlan_vlan_interface_secondaryip_secondaryip.py

:orphan:

.. _fmgr_pm_config_obj_fsp_vlan_vlan_interface_secondaryip_secondaryip:

fmgr_pm_config_obj_fsp_vlan_vlan_interface_secondaryip_secondaryip
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">secondaryip</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/fsp/vlan/{vlan}/interface/secondaryip/{secondaryip}
      fmgr_pm_config_obj_fsp_vlan_vlan_interface_secondaryip_secondaryip:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            vlan: <value of string>
            secondaryip: <value of string>
         params:
            - 
               data: 
                  allowaccess: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/fsp/vlan/{vlan}/interface/secondaryip/{secondaryip}</span>  </li>
 </ul>
