:source: fmgr_pm_config_obj_system_sdn_connector_route_table.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_route_table:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/SDN-CONNECTOR/{SDN-CONNECTOR}/ROUTE-TABLE
      fmgr_pm_config_obj_system_sdn_connector_route_table:
