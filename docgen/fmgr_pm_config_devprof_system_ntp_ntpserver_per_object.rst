:source: fmgr_pm_config_devprof_system_ntp_ntpserver_per_object.py

:orphan:

.. _fmgr_pm_config_devprof_system_ntp_ntpserver_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/NTP/NTPSERVER/{NTPSERVER}
      fmgr_pm_config_devprof_system_ntp_ntpserver_per_object:
