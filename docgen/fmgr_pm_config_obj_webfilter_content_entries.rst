:source: fmgr_pm_config_obj_webfilter_content_entries.py

:orphan:

.. _fmgr_pm_config_obj_webfilter_content_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEBFILTER/CONTENT/{CONTENT}/ENTRIES
      fmgr_pm_config_obj_webfilter_content_entries:
