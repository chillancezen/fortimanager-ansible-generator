:source: fmgr_pm_config_obj_antivirus_profile_imap.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_profile_imap:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/ANTIVIRUS/PROFILE/{PROFILE}/IMAP
      fmgr_pm_config_obj_antivirus_profile_imap:
         method: <value in [get]>
         url_params:
