:source: fmgr_pm_config_obj_firewall_addrgrp_tagging_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_addrgrp_tagging_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/ADDRGRP/{ADDRGRP}/TAGGING/{TAGGING}
      fmgr_pm_config_obj_firewall_addrgrp_tagging_per_object:
