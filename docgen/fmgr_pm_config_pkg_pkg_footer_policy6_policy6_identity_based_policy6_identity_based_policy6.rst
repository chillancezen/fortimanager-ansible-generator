:source: fmgr_pm_config_pkg_pkg_footer_policy6_policy6_identity_based_policy6_identity_based_policy6.py

:orphan:

.. _fmgr_pm_config_pkg_pkg_footer_policy6_policy6_identity_based_policy6_identity_based_policy6:

fmgr_pm_config_pkg_pkg_footer_policy6_policy6_identity_based_policy6_identity_based_policy6
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/pkg/{pkg}/footer/policy6/{policy6}/identity-based-policy6/{identity-based-policy6}
      fmgr_pm_config_pkg_pkg_footer_policy6_policy6_identity_based_policy6_identity_based_policy6:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/global/pkg/{pkg}/global/footer/policy6/{policy6}/identity-based-policy6/{identity-based-policy6}</span>  </li>
 </ul>
