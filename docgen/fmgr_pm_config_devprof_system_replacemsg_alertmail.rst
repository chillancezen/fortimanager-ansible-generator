:source: fmgr_pm_config_devprof_system_replacemsg_alertmail.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_alertmail:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/ALERTMAIL
      fmgr_pm_config_devprof_system_replacemsg_alertmail:
         method: <value in [get]>
         url_params:
