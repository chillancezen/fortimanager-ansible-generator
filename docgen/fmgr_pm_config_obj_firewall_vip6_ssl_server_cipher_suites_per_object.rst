:source: fmgr_pm_config_obj_firewall_vip6_ssl_server_cipher_suites_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vip6_ssl_server_cipher_suites_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP6/{VIP6}/SSL-SERVER-CIPHER-SUITES/{SSL-SERVER-CIPHER-SUITES}
      fmgr_pm_config_obj_firewall_vip6_ssl_server_cipher_suites_per_object:
