:source: fmgr_pm_config_obj_system_sdn_connector_external_ip_per_object.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_external_ip_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/SDN-CONNECTOR/{SDN-CONNECTOR}/EXTERNAL-IP/{EXTERNAL-IP}
      fmgr_pm_config_obj_system_sdn_connector_external_ip_per_object:
