:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_exempt_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_exempt_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SSL-SSH-PROFILE/{SSL-SSH-PROFILE}/SSL-EXEMPT/{SSL-EXEMPT}
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_exempt_per_object:
