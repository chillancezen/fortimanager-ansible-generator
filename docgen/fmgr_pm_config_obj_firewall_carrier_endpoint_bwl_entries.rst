:source: fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_entries.py

:orphan:

.. _fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/CARRIER-ENDPOINT-BWL/{CARRIER-ENDPOINT-BWL}/ENTRIES
      fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_entries:
