:source: fmgr_pm_config_obj_ssh_filter_profile_shell_commands.py

:orphan:

.. _fmgr_pm_config_obj_ssh_filter_profile_shell_commands:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SSH-FILTER/PROFILE/{PROFILE}/SHELL-COMMANDS
      fmgr_pm_config_obj_ssh_filter_profile_shell_commands:
