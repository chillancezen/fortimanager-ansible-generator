:source: fmgr_pm_config_devprof_system_replacemsg_sslvpn.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_sslvpn:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/SSLVPN
      fmgr_pm_config_devprof_system_replacemsg_sslvpn:
         method: <value in [get]>
         url_params:
