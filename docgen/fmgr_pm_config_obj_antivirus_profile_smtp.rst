:source: fmgr_pm_config_obj_antivirus_profile_smtp.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_profile_smtp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/ANTIVIRUS/PROFILE/{PROFILE}/SMTP
      fmgr_pm_config_obj_antivirus_profile_smtp:
         method: <value in [get]>
         url_params:
