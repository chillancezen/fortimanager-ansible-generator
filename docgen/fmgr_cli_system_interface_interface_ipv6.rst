:source: fmgr_cli_system_interface_interface_ipv6.py

:orphan:

.. _fmgr_cli_system_interface_interface_ipv6:

fmgr_cli_system_interface_interface_ipv6 -- IPv6 of interface.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - IPv6 of interface.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - IPv6 of interface.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/interface/{interface}/ipv6
      fmgr_cli_system_interface_interface_ipv6:
...
.. raw:: html
 ...
 <li> <span class="li-return"> ip6-address </span> - IPv6 address/prefix of interface. <span class="li-normal">type: str</span>  <span class="li-normal">example: ::/0</span>  </li>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/interface/{interface}/ipv6</span>  </li>
 </ul>
