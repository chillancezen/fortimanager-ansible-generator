:source: fmgr_pm_config_devprof_system_replacemsg_webproxy.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_webproxy:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/WEBPROXY
      fmgr_pm_config_devprof_system_replacemsg_webproxy:
         method: <value in [get]>
         url_params:
