:source: fmgr_pm_config_devprof_system_replacemsg_traffic_quota.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_traffic_quota:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/TRAFFIC-QUOTA
      fmgr_pm_config_devprof_system_replacemsg_traffic_quota:
         method: <value in [get]>
         url_params:
