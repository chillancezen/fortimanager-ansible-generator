:source: fmgr_pm_config_obj_wanopt_profile_ftp.py

:orphan:

.. _fmgr_pm_config_obj_wanopt_profile_ftp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WANOPT/PROFILE/{PROFILE}/FTP
      fmgr_pm_config_obj_wanopt_profile_ftp:
         method: <value in [get]>
         url_params:
