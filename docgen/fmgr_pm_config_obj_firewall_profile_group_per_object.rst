:source: fmgr_pm_config_obj_firewall_profile_group_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_group_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROFILE-GROUP/{PROFILE-GROUP}
      fmgr_pm_config_obj_firewall_profile_group_per_object:
