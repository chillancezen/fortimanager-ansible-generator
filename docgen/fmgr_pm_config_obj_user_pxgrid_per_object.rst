:source: fmgr_pm_config_obj_user_pxgrid_per_object.py

:orphan:

.. _fmgr_pm_config_obj_user_pxgrid_per_object:

fmgr_pm_config_obj_user_pxgrid_per_object
+++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">pxgrid</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/PXGRID/{PXGRID}
      fmgr_pm_config_obj_user_pxgrid_per_object:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            pxgrid: <value of string>
         params:
            -
               data:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/pxgrid/{pxgrid}</span>  </li>
 </ul>
