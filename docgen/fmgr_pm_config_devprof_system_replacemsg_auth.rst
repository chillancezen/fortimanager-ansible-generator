:source: fmgr_pm_config_devprof_system_replacemsg_auth.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_auth:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/AUTH
      fmgr_pm_config_devprof_system_replacemsg_auth:
         method: <value in [get]>
         url_params:
