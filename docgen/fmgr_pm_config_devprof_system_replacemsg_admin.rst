:source: fmgr_pm_config_devprof_system_replacemsg_admin.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_admin:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/ADMIN
      fmgr_pm_config_devprof_system_replacemsg_admin:
         method: <value in [get]>
         url_params:
