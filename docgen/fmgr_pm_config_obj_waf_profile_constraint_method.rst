:source: fmgr_pm_config_obj_waf_profile_constraint_method.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_method:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/METHOD
      fmgr_pm_config_obj_waf_profile_constraint_method:
         method: <value in [get]>
         url_params:
