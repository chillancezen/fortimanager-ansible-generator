:source: fmgr_pm_config_obj_system_replacemsg_group_nntp.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_nntp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/NNTP
      fmgr_pm_config_obj_system_replacemsg_group_nntp:
