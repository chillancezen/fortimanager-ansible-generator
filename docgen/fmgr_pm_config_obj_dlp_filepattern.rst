:source: fmgr_pm_config_obj_dlp_filepattern.py

:orphan:

.. _fmgr_pm_config_obj_dlp_filepattern:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/dlp/filepattern
      fmgr_pm_config_obj_dlp_filepattern:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/dlp/filepattern</span>  </li>
 </ul>
