:source: fmgr_dvm_cmd_del_dev_list.py

:orphan:

.. _fmgr_dvm_cmd_del_dev_list:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [exec]</span> - Delete a list of devices.</li>
 <ul class="ul-self">
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvm/cmd/del/dev-list</span>  </li>
 </ul>
 </ul>
