:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SSL-SSH-PROFILE/{SSL-SSH-PROFILE}/SSL
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl:
         method: <value in [get]>
         url_params:
