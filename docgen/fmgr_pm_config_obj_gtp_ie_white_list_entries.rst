:source: fmgr_pm_config_obj_gtp_ie_white_list_entries.py

:orphan:

.. _fmgr_pm_config_obj_gtp_ie_white_list_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/GTP/IE-WHITE-LIST/{IE-WHITE-LIST}/ENTRIES
      fmgr_pm_config_obj_gtp_ie_white_list_entries:
