:source: fmgr_pm_config_obj_waf_profile_constraint_exception_per_object.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_exception_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/EXCEPTION/{EXCEPTION}
      fmgr_pm_config_obj_waf_profile_constraint_exception_per_object:
