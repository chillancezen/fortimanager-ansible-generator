:source: fmgr_pm_config_obj_dnsfilter_domain_filter.py

:orphan:

.. _fmgr_pm_config_obj_dnsfilter_domain_filter:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Configure DNS domain filters.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/dnsfilter/domain-filter
      fmgr_pm_config_obj_dnsfilter_domain_filter:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/dnsfilter/domain-filter</span>  </li>
 </ul>
