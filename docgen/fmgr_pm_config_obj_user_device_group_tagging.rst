:source: fmgr_pm_config_obj_user_device_group_tagging.py

:orphan:

.. _fmgr_pm_config_obj_user_device_group_tagging:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/DEVICE-GROUP/{DEVICE-GROUP}/TAGGING
      fmgr_pm_config_obj_user_device_group_tagging:
