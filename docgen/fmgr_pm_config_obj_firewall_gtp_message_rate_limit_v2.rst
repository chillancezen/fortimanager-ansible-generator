:source: fmgr_pm_config_obj_firewall_gtp_message_rate_limit_v2.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_message_rate_limit_v2:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/GTP/{GTP}/MESSAGE-RATE-LIMIT-V2
      fmgr_pm_config_obj_firewall_gtp_message_rate_limit_v2:
         method: <value in [get]>
         url_params:
