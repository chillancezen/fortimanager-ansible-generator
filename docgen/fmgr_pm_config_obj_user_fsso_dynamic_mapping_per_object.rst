:source: fmgr_pm_config_obj_user_fsso_dynamic_mapping_per_object.py

:orphan:

.. _fmgr_pm_config_obj_user_fsso_dynamic_mapping_per_object:

fmgr_pm_config_obj_user_fsso_dynamic_mapping_per_object
+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/FSSO/{FSSO}/DYNAMIC_MAPPING/{DYNAMIC_MAPPING}
      fmgr_pm_config_obj_user_fsso_dynamic_mapping_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/fsso/{fsso}/dynamic_mapping/{dynamic_mapping}</span>  </li>
 </ul>
