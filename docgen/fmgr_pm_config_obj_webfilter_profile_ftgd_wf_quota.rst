:source: fmgr_pm_config_obj_webfilter_profile_ftgd_wf_quota.py

:orphan:

.. _fmgr_pm_config_obj_webfilter_profile_ftgd_wf_quota:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEBFILTER/PROFILE/{PROFILE}/FTGD-WF/QUOTA
      fmgr_pm_config_obj_webfilter_profile_ftgd_wf_quota:
