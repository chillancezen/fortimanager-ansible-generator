:source: fmgr_pm_config_wanprof_system_virtual_wan_link_members_per_object.py

:orphan:

.. _fmgr_pm_config_wanprof_system_virtual_wan_link_members_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/WANPROF/{WANPROF}/SYSTEM/VIRTUAL-WAN-LINK/MEMBERS/{MEMBERS}
      fmgr_pm_config_wanprof_system_virtual_wan_link_members_per_object:
