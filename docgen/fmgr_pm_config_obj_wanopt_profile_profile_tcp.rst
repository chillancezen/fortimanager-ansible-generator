:source: fmgr_pm_config_obj_wanopt_profile_profile_tcp.py

:orphan:

.. _fmgr_pm_config_obj_wanopt_profile_profile_tcp:

fmgr_pm_config_obj_wanopt_profile_profile_tcp -- Enable/disable TCP WAN Optimization and configure TCP WAN Optimization features.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/wanopt/profile/{profile}/tcp
      fmgr_pm_config_obj_wanopt_profile_profile_tcp:
         method: <value in [get]>
         url_params:
