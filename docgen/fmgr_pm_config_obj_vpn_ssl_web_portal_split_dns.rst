:source: fmgr_pm_config_obj_vpn_ssl_web_portal_split_dns.py

:orphan:

.. _fmgr_pm_config_obj_vpn_ssl_web_portal_split_dns:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/PORTAL/{PORTAL}/SPLIT-DNS
      fmgr_pm_config_obj_vpn_ssl_web_portal_split_dns:
