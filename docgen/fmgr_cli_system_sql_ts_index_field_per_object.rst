:source: fmgr_cli_system_sql_ts_index_field_per_object.py

:orphan:

.. _fmgr_cli_system_sql_ts_index_field_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/SQL/TS-INDEX-FIELD/{TS-INDEX-FIELD}
      fmgr_cli_system_sql_ts_index_field_per_object:
