:source: fmgr_pm_config_obj_firewall_profile_protocol_options_ftp.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_protocol_options_ftp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROFILE-PROTOCOL-OPTIONS/{PROFILE-PROTOCOL-OPTIONS}/FTP
      fmgr_pm_config_obj_firewall_profile_protocol_options_ftp:
         method: <value in [get]>
         url_params:
