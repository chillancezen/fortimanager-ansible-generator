:source: fmgr_pm_config_obj_firewall_internet_service_custom_internet_service_custom_entry_entry_port_range.py

:orphan:

.. _fmgr_pm_config_obj_firewall_internet_service_custom_internet_service_custom_entry_entry_port_range:

fmgr_pm_config_obj_firewall_internet_service_custom_internet_service_custom_entry_entry_port_range -- Port ranges in the custom entry.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Port ranges in the custom entry.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [end-port, id, start-port]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/internet-service-custom/{internet-service-custom}/entry/{entry}/port-range
      fmgr_pm_config_obj_firewall_internet_service_custom_internet_service_custom_entry_entry_port_range:
      ...
      fmgr_pm_config_obj_firewall_internet_service_custom_internet_service_custom_entry_entry_port_range:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [end-port, id, start-port]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/internet-service-custom/{internet-service-custom}/entry/{entry}/port-range</span>  </li>
 </ul>
