:source: fmgr_pm_config_obj_firewall_vip46_realservers.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vip46_realservers:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP46/{VIP46}/REALSERVERS
      fmgr_pm_config_obj_firewall_vip46_realservers:
