:source: fmgr_pm_config_obj_waf_profile_constraint_max_range_segment.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_max_range_segment:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/MAX-RANGE-SEGMENT
      fmgr_pm_config_obj_waf_profile_constraint_max_range_segment:
         method: <value in [get]>
         url_params:
