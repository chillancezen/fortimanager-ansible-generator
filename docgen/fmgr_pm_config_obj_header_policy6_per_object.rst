:source: fmgr_pm_config_obj_header_policy6_per_object.py

:orphan:

.. _fmgr_pm_config_obj_header_policy6_per_object:

fmgr_pm_config_obj_header_policy6_per_object
++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/HEADER/POLICY6/{POLICY6}
      fmgr_pm_config_obj_header_policy6_per_object:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/global/header/policy6/{policy6}</span>  </li>
 </ul>
 </ul>
