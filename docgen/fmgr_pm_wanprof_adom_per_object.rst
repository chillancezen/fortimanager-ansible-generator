:source: fmgr_pm_wanprof_adom_per_object.py

:orphan:

.. _fmgr_pm_wanprof_adom_per_object:

fmgr_pm_wanprof_adom_per_object
+++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [description, name, oid, scope member, type]</span> </li>
 </ul>
 </ul>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/WANPROF/ADOM/{ADOM}
      fmgr_pm_wanprof_adom_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/wanprof/adom/{adom}</span>  </li>
 </ul>
