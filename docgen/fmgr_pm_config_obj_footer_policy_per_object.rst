:source: fmgr_pm_config_obj_footer_policy_per_object.py

:orphan:

.. _fmgr_pm_config_obj_footer_policy_per_object:

fmgr_pm_config_obj_footer_policy_per_object
+++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FOOTER/POLICY/{POLICY}
      fmgr_pm_config_obj_footer_policy_per_object:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/global/footer/policy/{policy}</span>  </li>
 </ul>
 </ul>
