:source: fmgr_pm_config_obj_system_sdn_connector_route.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_route:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/SDN-CONNECTOR/{SDN-CONNECTOR}/ROUTE
      fmgr_pm_config_obj_system_sdn_connector_route:
