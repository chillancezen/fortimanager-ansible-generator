...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [exec]</span> - Clone a policy package within the same ADOM.</li>
 <ul class="ul-self">
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /securityconsole/package/clone</span>  </li>
 </ul>
 </ul>
