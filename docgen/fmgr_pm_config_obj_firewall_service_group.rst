:source: fmgr_pm_config_obj_firewall_service_group.py

:orphan:

.. _fmgr_pm_config_obj_firewall_service_group:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/service/group
      fmgr_pm_config_obj_firewall_service_group:
