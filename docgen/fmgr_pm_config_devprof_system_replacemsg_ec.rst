:source: fmgr_pm_config_devprof_system_replacemsg_ec.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_ec:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/EC
      fmgr_pm_config_devprof_system_replacemsg_ec:
         method: <value in [get]>
         url_params:
