:source: fmgr_pm_config_pkg_firewall_dos_policy_anomaly.py

:orphan:

.. _fmgr_pm_config_pkg_firewall_dos_policy_anomaly:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/DOS-POLICY/{DOS-POLICY}/ANOMALY
      fmgr_pm_config_pkg_firewall_dos_policy_anomaly:
