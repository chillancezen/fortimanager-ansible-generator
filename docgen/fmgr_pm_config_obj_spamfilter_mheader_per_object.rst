:source: fmgr_pm_config_obj_spamfilter_mheader_per_object.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_mheader_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/MHEADER/{MHEADER}
      fmgr_pm_config_obj_spamfilter_mheader_per_object:
