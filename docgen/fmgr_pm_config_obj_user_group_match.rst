:source: fmgr_pm_config_obj_user_group_match.py

:orphan:

.. _fmgr_pm_config_obj_user_group_match:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/GROUP/{GROUP}/MATCH
      fmgr_pm_config_obj_user_group_match:
