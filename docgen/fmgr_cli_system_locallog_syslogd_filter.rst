:source: fmgr_cli_system_locallog_syslogd_filter.py

:orphan:

.. _fmgr_cli_system_locallog_syslogd_filter:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/locallog/syslogd/filter
      fmgr_cli_system_locallog_syslogd_filter:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/locallog/syslogd/filter</span>  </li>
 </ul>
