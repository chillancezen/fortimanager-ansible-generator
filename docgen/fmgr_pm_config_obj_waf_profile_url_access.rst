:source: fmgr_pm_config_obj_waf_profile_url_access.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_url_access:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/URL-ACCESS
      fmgr_pm_config_obj_waf_profile_url_access:
