:source: fmgr_pm_config_obj_system_dhcp_server_server_reserved_address_reserved_address.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_server_reserved_address_reserved_address:

fmgr_pm_config_obj_system_dhcp_server_server_reserved_address_reserved_address -- Options for the DHCP server to assign IP settings to specific MAC addresses.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">reserved-address</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Options for the DHCP server to assign IP settings to specific MAC addresses.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Options for the DHCP server to assign IP settings to specific MAC addresses.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Options for the DHCP server to assign IP settings to specific MAC addresses.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/dhcp/server/{server}/reserved-address/{reserved-address}
      fmgr_pm_config_obj_system_dhcp_server_server_reserved_address_reserved_address:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            server: <value of string>
            reserved-address: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/dhcp/server/{server}/reserved-address/{reserved-address}</span>  </li>
 </ul>
