:source: fmgr_pm_config_obj_system_sdn_connector_sdn_connector_nic_nic.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_sdn_connector_nic_nic:

fmgr_pm_config_obj_system_sdn_connector_sdn_connector_nic_nic -- Configure Azure network interface.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure Azure network interface.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure Azure network interface.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure Azure network interface.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [move]</span> - Configure Azure network interface.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/sdn-connector/{sdn-connector}/nic/{nic}
      fmgr_pm_config_obj_system_sdn_connector_sdn_connector_nic_nic:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/sdn-connector/{sdn-connector}/nic/{nic}</span>  </li>
 </ul>
