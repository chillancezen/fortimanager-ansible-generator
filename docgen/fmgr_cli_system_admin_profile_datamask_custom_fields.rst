:source: fmgr_cli_system_admin_profile_datamask_custom_fields.py

:orphan:

.. _fmgr_cli_system_admin_profile_datamask_custom_fields:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/ADMIN/PROFILE/{PROFILE}/DATAMASK-CUSTOM-FIELDS
      fmgr_cli_system_admin_profile_datamask_custom_fields:
