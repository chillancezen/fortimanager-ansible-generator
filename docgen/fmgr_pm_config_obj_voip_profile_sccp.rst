:source: fmgr_pm_config_obj_voip_profile_sccp.py

:orphan:

.. _fmgr_pm_config_obj_voip_profile_sccp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VOIP/PROFILE/{PROFILE}/SCCP
      fmgr_pm_config_obj_voip_profile_sccp:
         method: <value in [get]>
         url_params:
