:source: fmgr_wanprof_system_virtualwanlink_service_sla_obj.py

:orphan:

.. _fmgr_wanprof_system_virtualwanlink_service_sla_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/WANPROF/{WANPROF}/SYSTEM/VIRTUAL-WAN-LINK/SERVICE/{SERVICE}/SLA/{SLA}
      fmgr_wanprof_system_virtualwanlink_service_sla_obj:
