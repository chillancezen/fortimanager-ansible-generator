:source: fmgr_pm_config_obj_vpn_ssl_web_portal_portal_mac_addr_check_rule.py

:orphan:

.. _fmgr_pm_config_obj_vpn_ssl_web_portal_portal_mac_addr_check_rule:

fmgr_pm_config_obj_vpn_ssl_web_portal_portal_mac_addr_check_rule -- Client MAC address check rule.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Client MAC address check rule.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [mac-addr-list, mac-addr-mask, name]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpn/ssl/web/portal/{portal}/mac-addr-check-rule
      fmgr_pm_config_obj_vpn_ssl_web_portal_portal_mac_addr_check_rule:
      ...
      fmgr_pm_config_obj_vpn_ssl_web_portal_portal_mac_addr_check_rule:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [mac-addr-list, mac-addr-mask, name]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpn/ssl/web/portal/{portal}/mac-addr-check-rule</span>  </li>
 </ul>
