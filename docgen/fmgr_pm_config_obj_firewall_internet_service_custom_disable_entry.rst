:source: fmgr_pm_config_obj_firewall_internet_service_custom_disable_entry.py

:orphan:

.. _fmgr_pm_config_obj_firewall_internet_service_custom_disable_entry:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/INTERNET-SERVICE-CUSTOM/{INTERNET-SERVICE-CUSTOM}/DISABLE-ENTRY
      fmgr_pm_config_obj_firewall_internet_service_custom_disable_entry:
