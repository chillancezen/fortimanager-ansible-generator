:source: fmgr_dvmdb_device_device_ha_slave.py

:orphan:

.. _fmgr_dvmdb_device_device_ha_slave:

fmgr_dvmdb_device_device_ha_slave -- HA Slave table, read-only.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/device/{device}/ha_slave
      fmgr_dvmdb_device_device_ha_slave:
         method: <value in [get]>
         url_params:
