:source: fmgr_pm_config_pkg_firewall_local_in_policy_per_object.py

:orphan:

.. _fmgr_pm_config_pkg_firewall_local_in_policy_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/LOCAL-IN-POLICY/{LOCAL-IN-POLICY}
      fmgr_pm_config_pkg_firewall_local_in_policy_per_object:
