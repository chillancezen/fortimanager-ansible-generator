:source: fmgr_pm_config_obj_waf_profile_constraint_malformed.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_malformed:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/MALFORMED
      fmgr_pm_config_obj_waf_profile_constraint_malformed:
         method: <value in [get]>
         url_params:
