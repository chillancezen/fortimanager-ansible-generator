:source: fmgr_cli_system_admin_profile_profile.py

:orphan:

.. _fmgr_cli_system_admin_profile_profile:

fmgr_cli_system_admin_profile_profile -- Admin profile.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/admin/profile/{profile}
      fmgr_cli_system_admin_profile_profile:
