:source: fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_per_object.py

:orphan:

.. _fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/FMUPDATE/FDS-SETTING/PUSH-OVERRIDE-TO-CLIENT/ANNOUNCE-IP/{ANNOUNCE-IP}
      fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_per_object:
