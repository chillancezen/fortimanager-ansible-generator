:source: fmgr_pm_config_obj_user_security_exempt_list_rule_per_object.py

:orphan:

.. _fmgr_pm_config_obj_user_security_exempt_list_rule_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/SECURITY-EXEMPT-LIST/{SECURITY-EXEMPT-LIST}/RULE/{RULE}
      fmgr_pm_config_obj_user_security_exempt_list_rule_per_object:
