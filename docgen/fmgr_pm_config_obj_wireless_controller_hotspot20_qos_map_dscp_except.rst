:source: fmgr_pm_config_obj_wireless_controller_hotspot20_qos_map_dscp_except.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_hotspot20_qos_map_dscp_except:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/HOTSPOT20/QOS-MAP/{QOS-MAP}/DSCP-EXCEPT
      fmgr_pm_config_obj_wireless_controller_hotspot20_qos_map_dscp_except:
