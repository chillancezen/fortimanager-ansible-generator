:source: fmgr_pm_config_obj_spamfilter_bword_per_object.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_bword_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/BWORD/{BWORD}
      fmgr_pm_config_obj_spamfilter_bword_per_object:
