:source: fmgr_pm_config_obj_web_proxy_profile_headers.py

:orphan:

.. _fmgr_pm_config_obj_web_proxy_profile_headers:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEB-PROXY/PROFILE/{PROFILE}/HEADERS
      fmgr_pm_config_obj_web_proxy_profile_headers:
