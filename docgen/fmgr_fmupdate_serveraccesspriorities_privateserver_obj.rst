:source: fmgr_fmupdate_serveraccesspriorities_privateserver_obj.py

:orphan:

.. _fmgr_fmupdate_serveraccesspriorities_privateserver_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/FMUPDATE/SERVER-ACCESS-PRIORITIES/PRIVATE-SERVER/{PRIVATE-SERVER}
      fmgr_fmupdate_serveraccesspriorities_privateserver_obj:
