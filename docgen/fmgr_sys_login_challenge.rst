...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [exec]</span> - Answer a log in challenge question, used following a login/user or login/challenge command.</li>
 <ul class="ul-self">
...
.. raw:: html
 ...
 <li> <span class="li-return"> session </span> - Session ID returned from login/user or previous login/challenge command. <span class="li-normal">type: str</span>  </li>
 </ul>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /sys/login/challenge</span>  </li>
 </ul>
 </ul>
