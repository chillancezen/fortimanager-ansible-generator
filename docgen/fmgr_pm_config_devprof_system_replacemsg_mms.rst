:source: fmgr_pm_config_devprof_system_replacemsg_mms.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_mms:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/MMS
      fmgr_pm_config_devprof_system_replacemsg_mms:
         method: <value in [get]>
         url_params:
