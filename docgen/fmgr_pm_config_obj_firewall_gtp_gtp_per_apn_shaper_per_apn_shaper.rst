:source: fmgr_pm_config_obj_firewall_gtp_gtp_per_apn_shaper_per_apn_shaper.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_gtp_per_apn_shaper_per_apn_shaper:

fmgr_pm_config_obj_firewall_gtp_gtp_per_apn_shaper_per_apn_shaper -- Per APN shaper.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">per-apn-shaper</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Per APN shaper.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Per APN shaper.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Per APN shaper.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/gtp/{gtp}/per-apn-shaper/{per-apn-shaper}
      fmgr_pm_config_obj_firewall_gtp_gtp_per_apn_shaper_per_apn_shaper:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            gtp: <value of string>
            per-apn-shaper: <value of string>
         params:
            - 
               data: 
                  apn: <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/gtp/{gtp}/per-apn-shaper/{per-apn-shaper}</span>  </li>
 </ul>
