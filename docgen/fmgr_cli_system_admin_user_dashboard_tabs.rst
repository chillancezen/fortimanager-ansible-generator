:source: fmgr_cli_system_admin_user_dashboard_tabs.py

:orphan:

.. _fmgr_cli_system_admin_user_dashboard_tabs:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/ADMIN/USER/{USER}/DASHBOARD-TABS
      fmgr_cli_system_admin_user_dashboard_tabs:
