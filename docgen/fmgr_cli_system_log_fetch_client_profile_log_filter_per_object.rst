:source: fmgr_cli_system_log_fetch_client_profile_log_filter_per_object.py

:orphan:

.. _fmgr_cli_system_log_fetch_client_profile_log_filter_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/LOG-FETCH/CLIENT-PROFILE/{CLIENT-PROFILE}/LOG-FILTER/{LOG-FILTER}
      fmgr_cli_system_log_fetch_client_profile_log_filter_per_object:
