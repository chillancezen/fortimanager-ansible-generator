:source: fmgr_pm_config_obj_firewall_vipgrp_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vipgrp_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIPGRP/{VIPGRP}
      fmgr_pm_config_obj_firewall_vipgrp_per_object:
