:source: fmgr_pm_config_obj_firewall_gtp_noip_policy.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_noip_policy:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/GTP/{GTP}/NOIP-POLICY
      fmgr_pm_config_obj_firewall_gtp_noip_policy:
