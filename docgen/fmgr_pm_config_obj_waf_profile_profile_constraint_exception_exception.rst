:source: fmgr_pm_config_obj_waf_profile_profile_constraint_exception_exception.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_profile_constraint_exception_exception:

fmgr_pm_config_obj_waf_profile_profile_constraint_exception_exception -- HTTP constraint exception.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">exception</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - HTTP constraint exception.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - HTTP constraint exception.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/waf/profile/{profile}/constraint/exception/{exception}
      fmgr_pm_config_obj_waf_profile_profile_constraint_exception_exception:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/waf/profile/{profile}/constraint/exception/{exception}</span>  </li>
 </ul>
