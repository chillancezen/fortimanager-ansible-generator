:source: fmgr_cli_system_locallog_fortianalyzer_filter.py

:orphan:

.. _fmgr_cli_system_locallog_fortianalyzer_filter:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [get]</span> - Filter for FortiAnalyzer logging.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Filter for FortiAnalyzer logging.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/locallog/fortianalyzer/filter
      fmgr_cli_system_locallog_fortianalyzer_filter:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/locallog/fortianalyzer/filter</span>  </li>
 </ul>
