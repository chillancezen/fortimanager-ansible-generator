...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [exec]</span> - Lock an entire ADOM.</li>
 <ul class="ul-self">
 </ul>
 </ul>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/workspace/lock</span>  </li>
 </ul>
 </ul>
