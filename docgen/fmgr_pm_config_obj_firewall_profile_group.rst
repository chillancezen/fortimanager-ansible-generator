:source: fmgr_pm_config_obj_firewall_profile_group.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_group:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/profile-group
