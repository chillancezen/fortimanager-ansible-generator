:source: fmgr_pm_config_obj_firewall_addrgrp6_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_addrgrp6_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/ADDRGRP6/{ADDRGRP6}
      fmgr_pm_config_obj_firewall_addrgrp6_per_object:
