:source: fmgr_pm_config_obj_spamfilter_bwl_bwl_entries_entries.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_bwl_bwl_entries_entries:

fmgr_pm_config_obj_spamfilter_bwl_bwl_entries_entries -- Anti-spam black/white list entries.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Anti-spam black/white list entries.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Anti-spam black/white list entries.</li>
 <ul class="ul-self">
 </ul>
 ...
 <li><span class="li-head">parameters for method: [move]</span> - Anti-spam black/white list entries.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/spamfilter/bwl/{bwl}/entries/{entries}
      fmgr_pm_config_obj_spamfilter_bwl_bwl_entries_entries:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/spamfilter/bwl/{bwl}/entries/{entries}</span>  </li>
 </ul>
