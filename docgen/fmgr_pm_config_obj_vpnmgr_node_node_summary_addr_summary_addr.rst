:source: fmgr_pm_config_obj_vpnmgr_node_node_summary_addr_summary_addr.py

:orphan:

.. _fmgr_pm_config_obj_vpnmgr_node_node_summary_addr_summary_addr:

fmgr_pm_config_obj_vpnmgr_node_node_summary_addr_summary_addr
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">summary_addr</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpnmgr/node/{node}/summary_addr/{summary_addr}
      fmgr_pm_config_obj_vpnmgr_node_node_summary_addr_summary_addr:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            node: <value of string>
            summary_addr: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpnmgr/node/{node}/summary_addr/{summary_addr}</span>  </li>
 </ul>
