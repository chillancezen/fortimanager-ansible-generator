:source: fmgr_pm_config_obj_system_dhcp_server_per_object.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/DHCP/SERVER/{SERVER}
      fmgr_pm_config_obj_system_dhcp_server_per_object:
