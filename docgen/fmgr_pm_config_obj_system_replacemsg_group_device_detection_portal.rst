:source: fmgr_pm_config_obj_system_replacemsg_group_device_detection_portal.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_device_detection_portal:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/DEVICE-DETECTION-PORTAL
      fmgr_pm_config_obj_system_replacemsg_group_device_detection_portal:
