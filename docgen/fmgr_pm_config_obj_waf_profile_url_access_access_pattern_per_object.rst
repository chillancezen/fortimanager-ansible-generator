:source: fmgr_pm_config_obj_waf_profile_url_access_access_pattern_per_object.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_url_access_access_pattern_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/URL-ACCESS/{URL-ACCESS}/ACCESS-PATTERN/{ACCESS-PATTERN}
      fmgr_pm_config_obj_waf_profile_url_access_access_pattern_per_object:
