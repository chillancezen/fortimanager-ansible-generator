:source: fmgr_cli_system_admin_user_adom_per_object.py

:orphan:

.. _fmgr_cli_system_admin_user_adom_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/ADMIN/USER/{USER}/ADOM/{ADOM}
      fmgr_cli_system_admin_user_adom_per_object:
