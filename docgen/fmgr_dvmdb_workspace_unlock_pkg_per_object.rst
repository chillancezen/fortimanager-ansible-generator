:source: fmgr_dvmdb_workspace_unlock_pkg_per_object.py

:orphan:

.. _fmgr_dvmdb_workspace_unlock_pkg_per_object:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [exec]</span> - Unlock a specific package, where the url includes both the folder(s) and name of the policy package.</li>
 <ul class="ul-self">
 </ul>
 </ul>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/workspace/unlock/pkg/{package_path_name}</span>  </li>
 </ul>
 </ul>
