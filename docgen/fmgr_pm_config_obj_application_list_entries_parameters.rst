:source: fmgr_pm_config_obj_application_list_entries_parameters.py

:orphan:

.. _fmgr_pm_config_obj_application_list_entries_parameters:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/APPLICATION/LIST/{LIST}/ENTRIES/{ENTRIES}/PARAMETERS
      fmgr_pm_config_obj_application_list_entries_parameters:
