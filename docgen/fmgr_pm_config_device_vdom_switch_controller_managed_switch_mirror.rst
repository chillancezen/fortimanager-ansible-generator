:source: fmgr_pm_config_device_vdom_switch_controller_managed_switch_mirror.py

:orphan:

.. _fmgr_pm_config_device_vdom_switch_controller_managed_switch_mirror:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVICE/{DEVICE}/VDOM/{VDOM}/SWITCH-CONTROLLER/MANAGED-SWITCH/{MANAGED-SWITCH}/MIRROR
      fmgr_pm_config_device_vdom_switch_controller_managed_switch_mirror:
