:source: fmgr_pm_config_obj_wireless_controller_hotspot20_anqp_nai_realm_nai_list_eap_method.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_hotspot20_anqp_nai_realm_nai_list_eap_method:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/HOTSPOT20/ANQP-NAI-REALM/{ANQP-NAI-REALM}/NAI-LIST/{NAI-LIST}/EAP-METHOD
      fmgr_pm_config_obj_wireless_controller_hotspot20_anqp_nai_realm_nai_list_eap_method:
