:source: fmgr_pm_config_obj_vpn_ssl_web_portal_bookmark_group_bookmarks_per_object.py

:orphan:

.. _fmgr_pm_config_obj_vpn_ssl_web_portal_bookmark_group_bookmarks_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/PORTAL/{PORTAL}/BOOKMARK-GROUP/{BOOKMARK-GROUP}/BOOKMARKS/{BOOKMARKS}
      fmgr_pm_config_obj_vpn_ssl_web_portal_bookmark_group_bookmarks_per_object:
