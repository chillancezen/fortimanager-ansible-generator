:source: fmgr_pm_config_obj_antivirus_profile_smb.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_profile_smb:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/ANTIVIRUS/PROFILE/{PROFILE}/SMB
      fmgr_pm_config_obj_antivirus_profile_smb:
         method: <value in [get]>
         url_params:
