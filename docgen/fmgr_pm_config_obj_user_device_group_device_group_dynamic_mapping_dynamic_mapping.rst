:source: fmgr_pm_config_obj_user_device_group_device_group_dynamic_mapping_dynamic_mapping.py

:orphan:

.. _fmgr_pm_config_obj_user_device_group_device_group_dynamic_mapping_dynamic_mapping:

fmgr_pm_config_obj_user_device_group_device_group_dynamic_mapping_dynamic_mapping
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/device-group/{device-group}/dynamic_mapping/{dynamic_mapping}
      fmgr_pm_config_obj_user_device_group_device_group_dynamic_mapping_dynamic_mapping:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/device-group/{device-group}/dynamic_mapping/{dynamic_mapping}</span>  </li>
 </ul>
