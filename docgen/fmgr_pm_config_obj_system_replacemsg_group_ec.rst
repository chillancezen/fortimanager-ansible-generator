:source: fmgr_pm_config_obj_system_replacemsg_group_ec.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_ec:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/EC
      fmgr_pm_config_obj_system_replacemsg_group_ec:
