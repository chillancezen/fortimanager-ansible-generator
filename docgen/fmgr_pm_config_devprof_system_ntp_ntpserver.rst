:source: fmgr_pm_config_devprof_system_ntp_ntpserver.py

:orphan:

.. _fmgr_pm_config_devprof_system_ntp_ntpserver:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/NTP/NTPSERVER
      fmgr_pm_config_devprof_system_ntp_ntpserver:
