:source: fmgr_pm_config_obj_system_replacemsg_group_admin.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_admin:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/ADMIN
      fmgr_pm_config_obj_system_replacemsg_group_admin:
