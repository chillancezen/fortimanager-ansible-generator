:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_ssh.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_ssh:

fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_ssh -- Configure SSH options.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Configure SSH options.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Configure SSH options.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/ssh
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_ssh:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 <li> <span class="li-return"> inspect-all </span> - Level of SSL inspection. <span class="li-normal">type: str</span>  </li>
 ...
 <li> <span class="li-return"> ssh-algorithm </span> - Relative strength of encryption algorithms accepted during negotiation. <span class="li-normal">type: str</span>  </li>
 <li> <span class="li-return"> ssh-policy-check </span> - Enable/disable SSH policy check. <span class="li-normal">type: str</span>  </li>
 <li> <span class="li-return"> ssh-tun-policy-check </span> - Enable/disable SSH tunnel policy check. <span class="li-normal">type: str</span>  </li>
 <li> <span class="li-return"> status </span> - Configure protocol inspection status. <span class="li-normal">type: str</span>  </li>
 <li> <span class="li-return"> unsupported-version </span> - Action based on SSH version being unsupported. <span class="li-normal">type: str</span>  </li>
 </ul>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/ssh</span>  </li>
 </ul>
