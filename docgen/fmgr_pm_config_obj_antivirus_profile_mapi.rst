:source: fmgr_pm_config_obj_antivirus_profile_mapi.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_profile_mapi:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/ANTIVIRUS/PROFILE/{PROFILE}/MAPI
      fmgr_pm_config_obj_antivirus_profile_mapi:
         method: <value in [get]>
         url_params:
