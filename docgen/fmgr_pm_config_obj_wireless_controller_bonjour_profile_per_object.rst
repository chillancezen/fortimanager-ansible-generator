:source: fmgr_pm_config_obj_wireless_controller_bonjour_profile_per_object.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_bonjour_profile_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/BONJOUR-PROFILE/{BONJOUR-PROFILE}
      fmgr_pm_config_obj_wireless_controller_bonjour_profile_per_object:
