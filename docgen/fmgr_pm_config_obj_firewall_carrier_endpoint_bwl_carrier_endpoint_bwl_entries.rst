:source: fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_carrier_endpoint_bwl_entries.py

:orphan:

.. _fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_carrier_endpoint_bwl_entries:

fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_carrier_endpoint_bwl_entries -- Carrier end point black/white list.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Carrier end point black/white list.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [action, carrier-endpoint, log-action, pattern-type, status]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/carrier-endpoint-bwl/{carrier-endpoint-bwl}/entries
      fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_carrier_endpoint_bwl_entries:
      ...
      fmgr_pm_config_obj_firewall_carrier_endpoint_bwl_carrier_endpoint_bwl_entries:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [action, carrier-endpoint, log-action, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/carrier-endpoint-bwl/{carrier-endpoint-bwl}/entries</span>  </li>
 </ul>
