:source: fmgr_pm_config_obj_antivirus_profile_profile_mapi.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_profile_profile_mapi:

fmgr_pm_config_obj_antivirus_profile_profile_mapi -- Configure MAPI AntiVirus options.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Configure MAPI AntiVirus options.</li>
 <ul class="ul-self">
 <li><span class="li-head">option</span> - Set fetch option for the request. <span class="li-normal">type: str</span>  <span class="li-normal">choices: [object member, chksum, datasrc]</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Configure MAPI AntiVirus options.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [scan, quarantine, avquery, avmonitor]</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/antivirus/profile/{profile}/mapi
      fmgr_pm_config_obj_antivirus_profile_profile_mapi:
         method: <value in [get]>
         url_params:
         ...
         params:
            - 
               data: 
                  ...
                  options: 
                   - <value in [scan, quarantine, avquery, ...]>
...
.. raw:: html
 ...
 <li> <span class="li-return"> executables </span> - Treat Windows executable files as viruses for the purpose of blocking or monitoring. <span class="li-normal">type: str</span>  </li>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/antivirus/profile/{profile}/mapi</span>  </li>
 </ul>
