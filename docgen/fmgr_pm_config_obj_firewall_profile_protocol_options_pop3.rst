:source: fmgr_pm_config_obj_firewall_profile_protocol_options_pop3.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_protocol_options_pop3:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROFILE-PROTOCOL-OPTIONS/{PROFILE-PROTOCOL-OPTIONS}/POP3
      fmgr_pm_config_obj_firewall_profile_protocol_options_pop3:
         method: <value in [get]>
         url_params:
