:source: fmgr_pm_config_obj_ips_sensor_sensor_entries_entries.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_sensor_entries_entries:

fmgr_pm_config_obj_ips_sensor_sensor_entries_entries -- IPS sensor filter.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/ips/sensor/{sensor}/entries/{entries}
      fmgr_pm_config_obj_ips_sensor_sensor_entries_entries:
