:source: fmgr_pm_config_obj_wireless_controller_qos_profile_per_object.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_qos_profile_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/QOS-PROFILE/{QOS-PROFILE}
      fmgr_pm_config_obj_wireless_controller_qos_profile_per_object:
