:source: fmgr_dvmdb_workflow_discard_per_object.py

:orphan:

.. _fmgr_dvmdb_workflow_discard_per_object:

fmgr_dvmdb_workflow_discard_per_object
++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /dvmdb/adom/{adom}/workflow/discard/{session_id}</span>  </li>
 </ul>
 </ul>
