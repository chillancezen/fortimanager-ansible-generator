:source: fmgr_pm_config_obj_firewall_ippool6_ippool6_dynamic_mapping.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ippool6_ippool6_dynamic_mapping:

fmgr_pm_config_obj_firewall_ippool6_ippool6_dynamic_mapping
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [_scope, comments, endip, startip]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/ippool6/{ippool6}/dynamic_mapping
      fmgr_pm_config_obj_firewall_ippool6_ippool6_dynamic_mapping:
      ...
      fmgr_pm_config_obj_firewall_ippool6_ippool6_dynamic_mapping:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [_scope, comments, endip, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/ippool6/{ippool6}/dynamic_mapping</span>  </li>
 </ul>
