:source: fmgr_cli_fmupdate_fds_setting_server_override_servlist_per_object.py

:orphan:

.. _fmgr_cli_fmupdate_fds_setting_server_override_servlist_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/FMUPDATE/FDS-SETTING/SERVER-OVERRIDE/SERVLIST/{SERVLIST}
      fmgr_cli_fmupdate_fds_setting_server_override_servlist_per_object:
