:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_imaps.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_imaps:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SSL-SSH-PROFILE/{SSL-SSH-PROFILE}/IMAPS
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_imaps:
         method: <value in [get]>
         url_params:
