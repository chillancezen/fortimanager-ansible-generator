:source: fmgr_cli_system_workflow_approval_matrix_approval_matrix_approver_approver.py

:orphan:

.. _fmgr_cli_system_workflow_approval_matrix_approval_matrix_approver_approver:

fmgr_cli_system_workflow_approval_matrix_approval_matrix_approver_approver -- Approver.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">approver</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [delete, get]</span> - Approver.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Approver.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/workflow/approval-matrix/{approval-matrix}/approver/{approver}
      fmgr_cli_system_workflow_approval_matrix_approval_matrix_approver_approver:
         method: <value in [set, update]>
         url_params:
            approval-matrix: <value of string>
            approver: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/workflow/approval-matrix/{approval-matrix}/approver/{approver}</span>  </li>
 </ul>
