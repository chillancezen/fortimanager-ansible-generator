:source: fmgr_pm_config_obj_user_group_group_match_match.py

:orphan:

.. _fmgr_pm_config_obj_user_group_group_match_match:

fmgr_pm_config_obj_user_group_group_match_match -- Group matches.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">match</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Group matches.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Group matches.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/group/{group}/match/{match}
      fmgr_pm_config_obj_user_group_group_match_match:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/group/{group}/match/{match}</span>  </li>
 </ul>
