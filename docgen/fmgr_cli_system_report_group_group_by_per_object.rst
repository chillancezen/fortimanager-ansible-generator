:source: fmgr_cli_system_report_group_group_by_per_object.py

:orphan:

.. _fmgr_cli_system_report_group_group_by_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/REPORT/GROUP/{GROUP}/GROUP-BY/{GROUP-BY}
      fmgr_cli_system_report_group_group_by_per_object:
