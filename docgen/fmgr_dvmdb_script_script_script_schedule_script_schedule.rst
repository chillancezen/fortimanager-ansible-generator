:source: fmgr_dvmdb_script_script_script_schedule_script_schedule.py

:orphan:

.. _fmgr_dvmdb_script_script_script_schedule_script_schedule:

fmgr_dvmdb_script_script_script_schedule_script_schedule -- Script schedule table.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/script/{script}/script_schedule/{script_schedule}
      fmgr_dvmdb_script_script_script_schedule_script_schedule:
         method: <value in [get]>
         url_params:
