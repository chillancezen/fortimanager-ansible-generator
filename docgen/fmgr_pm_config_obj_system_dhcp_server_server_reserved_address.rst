:source: fmgr_pm_config_obj_system_dhcp_server_server_reserved_address.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_server_reserved_address:

fmgr_pm_config_obj_system_dhcp_server_server_reserved_address -- Options for the DHCP server to assign IP settings to specific MAC addresses.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Options for the DHCP server to assign IP settings to specific MAC addresses.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [action, description, id, ip, mac]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/system/dhcp/server/{server}/reserved-address
      fmgr_pm_config_obj_system_dhcp_server_server_reserved_address:
      ...
      fmgr_pm_config_obj_system_dhcp_server_server_reserved_address:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [action, description, id, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/system/dhcp/server/{server}/reserved-address</span>  </li>
 </ul>
