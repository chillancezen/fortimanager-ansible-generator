:source: fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_announce_ip.py

:orphan:

.. _fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_announce_ip:

fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_announce_ip -- Announce IP addresses for the device.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">announce-ip</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [delete, get]</span> - Announce IP addresses for the device.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Announce IP addresses for the device.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/fmupdate/fds-setting/push-override-to-client/announce-ip/{announce-ip}
      fmgr_cli_fmupdate_fds_setting_push_override_to_client_announce_ip_announce_ip:
         method: <value in [set, update]>
         url_params:
            announce-ip: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/fmupdate/fds-setting/push-override-to-client/announce-ip/{announce-ip}</span>  </li>
 </ul>
