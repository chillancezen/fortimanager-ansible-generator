:source: fmgr_pm_config_obj_user_group_guest.py

:orphan:

.. _fmgr_pm_config_obj_user_group_guest:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/GROUP/{GROUP}/GUEST
      fmgr_pm_config_obj_user_group_guest:
