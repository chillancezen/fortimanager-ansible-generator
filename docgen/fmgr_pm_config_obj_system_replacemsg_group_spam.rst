:source: fmgr_pm_config_obj_system_replacemsg_group_spam.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_spam:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/SPAM
      fmgr_pm_config_obj_system_replacemsg_group_spam:
