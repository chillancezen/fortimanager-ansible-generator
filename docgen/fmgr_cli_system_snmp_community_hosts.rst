:source: fmgr_cli_system_snmp_community_hosts.py

:orphan:

.. _fmgr_cli_system_snmp_community_hosts:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/SNMP/COMMUNITY/{COMMUNITY}/HOSTS
      fmgr_cli_system_snmp_community_hosts:
