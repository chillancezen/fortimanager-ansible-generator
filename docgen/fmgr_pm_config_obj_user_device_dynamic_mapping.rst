:source: fmgr_pm_config_obj_user_device_dynamic_mapping.py

:orphan:

.. _fmgr_pm_config_obj_user_device_dynamic_mapping:

fmgr_pm_config_obj_user_device_dynamic_mapping
++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [_scope, avatar, category, comment, mac, master-device, tags, type, user]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/DEVICE/{DEVICE}/DYNAMIC_MAPPING
      fmgr_pm_config_obj_user_device_dynamic_mapping:
      ...
      fmgr_pm_config_obj_user_device_dynamic_mapping:
         ...
         params:
            -
               ...
               fields:
                 -
                    - <value in [_scope, avatar, category, ...]>
               filter:
                 - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/device/{device}/dynamic_mapping</span>  </li>
 </ul>
