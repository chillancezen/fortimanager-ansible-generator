:source: fmgr_pm_config_obj_ips_sensor_sensor_override_override.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_sensor_override_override:

fmgr_pm_config_obj_ips_sensor_sensor_override_override -- IPS override rule.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - IPS override rule.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - IPS override rule.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/ips/sensor/{sensor}/override/{override}
      fmgr_pm_config_obj_ips_sensor_sensor_override_override:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/ips/sensor/{sensor}/override/{override}</span>  </li>
 </ul>
