:source: fmgr_pm_config_obj_ips_sensor_filter.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_filter:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/IPS/SENSOR/{SENSOR}/FILTER
      fmgr_pm_config_obj_ips_sensor_filter:
