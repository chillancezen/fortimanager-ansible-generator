:source: fmgr_cli_system_snmp_community_community_hosts_hosts.py

:orphan:

.. _fmgr_cli_system_snmp_community_community_hosts_hosts:

fmgr_cli_system_snmp_community_community_hosts_hosts -- Allow hosts configuration.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [delete, get]</span> - Allow hosts configuration.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Allow hosts configuration.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/system/snmp/community/{community}/hosts/{hosts}
      fmgr_cli_system_snmp_community_community_hosts_hosts:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/snmp/community/{community}/hosts/{hosts}</span>  </li>
 </ul>
