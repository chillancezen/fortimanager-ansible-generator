:source: fmgr_pm_config_obj_waf_profile_constraint_hostname.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_hostname:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/HOSTNAME
      fmgr_pm_config_obj_waf_profile_constraint_hostname:
         method: <value in [get]>
         url_params:
