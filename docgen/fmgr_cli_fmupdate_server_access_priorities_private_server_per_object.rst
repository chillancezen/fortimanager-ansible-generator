:source: fmgr_cli_fmupdate_server_access_priorities_private_server_per_object.py

:orphan:

.. _fmgr_cli_fmupdate_server_access_priorities_private_server_per_object:
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">private-server</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [delete, get]</span> - Configure multiple FortiManager units and private servers.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Configure multiple FortiManager units and private servers.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/FMUPDATE/SERVER-ACCESS-PRIORITIES/PRIVATE-SERVER/{PRIVATE-SERVER}
      fmgr_cli_fmupdate_server_access_priorities_private_server_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/fmupdate/server-access-priorities/private-server/{private-server}</span>  </li>
 </ul>
