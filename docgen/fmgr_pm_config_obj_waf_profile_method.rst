:source: fmgr_pm_config_obj_waf_profile_method.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_method:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/METHOD
      fmgr_pm_config_obj_waf_profile_method:
         method: <value in [get]>
         url_params:
