:source: fmgr_pm_config_pkg_firewall_central_snat_map_per_object.py

:orphan:

.. _fmgr_pm_config_pkg_firewall_central_snat_map_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/CENTRAL-SNAT-MAP/{CENTRAL-SNAT-MAP}
      fmgr_pm_config_pkg_firewall_central_snat_map_per_object:
