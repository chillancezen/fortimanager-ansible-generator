:source: fmgr_pm_config_obj_wireless_controller_hotspot20_h2qp_conn_capability_per_object.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_hotspot20_h2qp_conn_capability_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/HOTSPOT20/H2QP-CONN-CAPABILITY/{H2QP-CONN-CAPABILITY}
      fmgr_pm_config_obj_wireless_controller_hotspot20_h2qp_conn_capability_per_object:
