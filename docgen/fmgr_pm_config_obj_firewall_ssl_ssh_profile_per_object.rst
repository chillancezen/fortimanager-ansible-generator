:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SSL-SSH-PROFILE/{SSL-SSH-PROFILE}
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_per_object:
