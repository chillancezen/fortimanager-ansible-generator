:source: fmgr_pm_config_pkg_pkg_firewall_interface_policy6_interface_policy6.py

:orphan:

.. _fmgr_pm_config_pkg_pkg_firewall_interface_policy6_interface_policy6:

fmgr_pm_config_pkg_pkg_firewall_interface_policy6_interface_policy6 -- Configure IPv6 interface policies.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">interface-policy6</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, update]</span> - Configure IPv6 interface policies.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure IPv6 interface policies.</li>
 <ul class="ul-self">
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [move]</span> - Configure IPv6 interface policies.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [set]</span> - Configure IPv6 interface policies.</li>
 <ul class="ul-self">
 <ul class="ul-self">
 <li><span class="li-head">parameter collection 0</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/pkg/{pkg}/firewall/interface-policy6/{interface-policy6}
      fmgr_pm_config_pkg_pkg_firewall_interface_policy6_interface_policy6:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/pkg/{pkg}/firewall/interface-policy6/{interface-policy6}</span>  </li>
 </ul>
