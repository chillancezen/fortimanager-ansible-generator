:source: fmgr_pm_config_devprof_system_replacemsg_utm.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_utm:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/UTM
      fmgr_pm_config_devprof_system_replacemsg_utm:
         method: <value in [get]>
         url_params:
