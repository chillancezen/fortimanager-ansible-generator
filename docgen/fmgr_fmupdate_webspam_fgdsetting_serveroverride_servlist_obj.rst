:source: fmgr_fmupdate_webspam_fgdsetting_serveroverride_servlist_obj.py

:orphan:

.. _fmgr_fmupdate_webspam_fgdsetting_serveroverride_servlist_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/FMUPDATE/WEB-SPAM/FGD-SETTING/SERVER-OVERRIDE/SERVLIST/{SERVLIST}
      fmgr_fmupdate_webspam_fgdsetting_serveroverride_servlist_obj:
