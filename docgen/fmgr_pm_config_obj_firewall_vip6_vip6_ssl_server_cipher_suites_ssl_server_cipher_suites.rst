:source: fmgr_pm_config_obj_firewall_vip6_vip6_ssl_server_cipher_suites_ssl_server_cipher_suites.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vip6_vip6_ssl_server_cipher_suites_ssl_server_cipher_suites:

fmgr_pm_config_obj_firewall_vip6_vip6_ssl_server_cipher_suites_ssl_server_cipher_suites -- SSL/TLS cipher suites to offer to a server, ordered by priority.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">ssl-server-cipher-suites</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - SSL/TLS cipher suites to offer to a server, ordered by priority.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - SSL/TLS cipher suites to offer to a server, ordered by priority.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - SSL/TLS cipher suites to offer to a server, ordered by priority.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/vip6/{vip6}/ssl-server-cipher-suites/{ssl-server-cipher-suites}
      fmgr_pm_config_obj_firewall_vip6_vip6_ssl_server_cipher_suites_ssl_server_cipher_suites:
         method: <value in [clone, set, update]>
         url_params:
            adom: <value in [none, global, custom dom]>
            vip6: <value of string>
            ssl-server-cipher-suites: <value of string>
         params:
            - 
               data: 
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/vip6/{vip6}/ssl-server-cipher-suites/{ssl-server-cipher-suites}</span>  </li>
 </ul>
