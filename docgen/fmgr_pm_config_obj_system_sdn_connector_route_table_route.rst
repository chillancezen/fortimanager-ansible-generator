:source: fmgr_pm_config_obj_system_sdn_connector_route_table_route.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_route_table_route:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/SDN-CONNECTOR/{SDN-CONNECTOR}/ROUTE-TABLE/{ROUTE-TABLE}/ROUTE
      fmgr_pm_config_obj_system_sdn_connector_route_table_route:
