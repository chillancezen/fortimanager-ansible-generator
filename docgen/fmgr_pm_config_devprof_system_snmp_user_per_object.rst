:source: fmgr_pm_config_devprof_system_snmp_user_per_object.py

:orphan:

.. _fmgr_pm_config_devprof_system_snmp_user_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/SNMP/USER/{USER}
      fmgr_pm_config_devprof_system_snmp_user_per_object:
