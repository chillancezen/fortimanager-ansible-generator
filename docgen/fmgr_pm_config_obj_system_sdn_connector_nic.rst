:source: fmgr_pm_config_obj_system_sdn_connector_nic.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_nic:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/SDN-CONNECTOR/{SDN-CONNECTOR}/NIC
      fmgr_pm_config_obj_system_sdn_connector_nic:
