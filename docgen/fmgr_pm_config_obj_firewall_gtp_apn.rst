:source: fmgr_pm_config_obj_firewall_gtp_apn.py

:orphan:

.. _fmgr_pm_config_obj_firewall_gtp_apn:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/GTP/{GTP}/APN
      fmgr_pm_config_obj_firewall_gtp_apn:
