:source: fmgr_pm_config_obj_antivirus_profile_nntp.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_profile_nntp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/ANTIVIRUS/PROFILE/{PROFILE}/NNTP
      fmgr_pm_config_obj_antivirus_profile_nntp:
         method: <value in [get]>
         url_params:
