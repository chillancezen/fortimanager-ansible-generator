:source: fmgr_pm_config_obj_firewall_multicast_address6_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_multicast_address6_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/MULTICAST-ADDRESS6/{MULTICAST-ADDRESS6}
      fmgr_pm_config_obj_firewall_multicast_address6_per_object:
