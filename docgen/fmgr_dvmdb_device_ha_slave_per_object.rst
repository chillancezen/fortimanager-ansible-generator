:source: fmgr_dvmdb_device_ha_slave_per_object.py

:orphan:

.. _fmgr_dvmdb_device_ha_slave_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /DVMDB/DEVICE/{DEVICE}/HA_SLAVE/{HA_SLAVE}
      fmgr_dvmdb_device_ha_slave_per_object:
         method: <value in [get]>
         url_params:
