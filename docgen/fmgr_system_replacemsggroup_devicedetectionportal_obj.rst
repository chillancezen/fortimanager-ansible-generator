:source: fmgr_system_replacemsggroup_devicedetectionportal_obj.py

:orphan:

.. _fmgr_system_replacemsggroup_devicedetectionportal_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/DEVICE-DETECTION-PORTAL/{DEVICE-DETECTION-PORTAL}
      fmgr_system_replacemsggroup_devicedetectionportal_obj:
