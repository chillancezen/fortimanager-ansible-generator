:source: fmgr_pm_config_obj_gtp_ie_white_list_ie_white_list_entries.py

:orphan:

.. _fmgr_pm_config_obj_gtp_ie_white_list_ie_white_list_entries:

fmgr_pm_config_obj_gtp_ie_white_list_ie_white_list_entries -- Entries of white list (to allow) for unknown or out-of-state IEs.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Entries of white list (to allow) for unknown or out-of-state IEs.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [id, ie, message]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/gtp/ie-white-list/{ie-white-list}/entries
      fmgr_pm_config_obj_gtp_ie_white_list_ie_white_list_entries:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/gtp/ie-white-list/{ie-white-list}/entries</span>  </li>
 </ul>
