:source: fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check.py

:orphan:

.. _fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check:

fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check -- SD-WAN status checking or health checking.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/wanprof/{wanprof}/system/virtual-wan-link/health-check/{health-check}
      fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link_health_check_health_check:
