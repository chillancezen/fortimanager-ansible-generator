:source: fmgr_pm_config_obj_system_dhcp_server_ip_range_per_object.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_ip_range_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/DHCP/SERVER/{SERVER}/IP-RANGE/{IP-RANGE}
      fmgr_pm_config_obj_system_dhcp_server_ip_range_per_object:
