:source: fmgr_cli_fmupdate_fds_setting_update_schedule.py

:orphan:

.. _fmgr_cli_fmupdate_fds_setting_update_schedule:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure the schedule when built-in FortiGuard retrieves antivirus and IPS updates.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [set, update]</span> - Configure the schedule when built-in FortiGuard retrieves antivirus and IPS updates.</li>
 <ul class="ul-self">
...
.. raw:: html
 ...
 <li> <span class="li-return"> day </span> - Configure the day the update will occur, if the freqnecy is weekly (Sunday - Saturday, default = Monday). <span class="li-normal">type: str</span>  <span class="li-normal">example: Monday</span>  </li>
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/fmupdate/fds-setting/update-schedule</span>  </li>
 </ul>
