:source: fmgr_pm_config_obj_dynamic_virtual_wan_link_members.py

:orphan:

.. _fmgr_pm_config_obj_dynamic_virtual_wan_link_members:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/dynamic/virtual-wan-link/members
      fmgr_pm_config_obj_dynamic_virtual_wan_link_members:
