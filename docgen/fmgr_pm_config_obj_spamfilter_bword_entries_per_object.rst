:source: fmgr_pm_config_obj_spamfilter_bword_entries_per_object.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_bword_entries_per_object:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Spam filter banned word.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Spam filter banned word.</li>
 <ul class="ul-self">
 </ul>
 ...
 <li><span class="li-head">parameters for method: [move]</span> - Spam filter banned word.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/BWORD/{BWORD}/ENTRIES/{ENTRIES}
      fmgr_pm_config_obj_spamfilter_bword_entries_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/spamfilter/bword/{bword}/entries/{entries}</span>  </li>
 </ul>
