:source: fmgr_pm_config_obj_system_replacemsg_group_auth.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_auth:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/AUTH
      fmgr_pm_config_obj_system_replacemsg_group_auth:
