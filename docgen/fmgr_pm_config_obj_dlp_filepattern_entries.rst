:source: fmgr_pm_config_obj_dlp_filepattern_entries.py

:orphan:

.. _fmgr_pm_config_obj_dlp_filepattern_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/DLP/FILEPATTERN/{FILEPATTERN}/ENTRIES
      fmgr_pm_config_obj_dlp_filepattern_entries:
