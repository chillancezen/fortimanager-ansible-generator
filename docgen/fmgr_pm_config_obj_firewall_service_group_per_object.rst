:source: fmgr_pm_config_obj_firewall_service_group_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_service_group_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SERVICE/GROUP/{GROUP}
      fmgr_pm_config_obj_firewall_service_group_per_object:
