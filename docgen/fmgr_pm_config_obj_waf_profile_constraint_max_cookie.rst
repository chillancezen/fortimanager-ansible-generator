:source: fmgr_pm_config_obj_waf_profile_constraint_max_cookie.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_max_cookie:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/MAX-COOKIE
      fmgr_pm_config_obj_waf_profile_constraint_max_cookie:
         method: <value in [get]>
         url_params:
