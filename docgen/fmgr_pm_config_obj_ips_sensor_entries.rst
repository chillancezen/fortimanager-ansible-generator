:source: fmgr_pm_config_obj_ips_sensor_entries.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/IPS/SENSOR/{SENSOR}/ENTRIES
      fmgr_pm_config_obj_ips_sensor_entries:
