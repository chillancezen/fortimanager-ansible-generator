:source: fmgr_pm_config_obj_firewall_internet_service_custom_disable_entry_ip_range_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_internet_service_custom_disable_entry_ip_range_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/INTERNET-SERVICE-CUSTOM/{INTERNET-SERVICE-CUSTOM}/DISABLE-ENTRY/{DISABLE-ENTRY}/IP-RANGE/{IP-RANGE}
      fmgr_pm_config_obj_firewall_internet_service_custom_disable_entry_ip_range_per_object:
