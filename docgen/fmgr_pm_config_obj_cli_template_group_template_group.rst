:source: fmgr_pm_config_obj_cli_template_group_template_group.py

:orphan:

.. _fmgr_pm_config_obj_cli_template_group_template_group:

fmgr_pm_config_obj_cli_template_group_template_group
++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">template-group</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/cli/template-group/{template-group}
      fmgr_pm_config_obj_cli_template_group_template_group:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/cli/template-group/{template-group}</span>  </li>
 </ul>
