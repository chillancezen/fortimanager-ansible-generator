:source: fmgr_pm_config_obj_firewall_address6_tagging.py

:orphan:

.. _fmgr_pm_config_obj_firewall_address6_tagging:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/ADDRESS6/{ADDRESS6}/TAGGING
      fmgr_pm_config_obj_firewall_address6_tagging:
