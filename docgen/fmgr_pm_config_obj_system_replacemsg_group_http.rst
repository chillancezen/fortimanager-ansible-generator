:source: fmgr_pm_config_obj_system_replacemsg_group_http.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_http:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/HTTP
      fmgr_pm_config_obj_system_replacemsg_group_http:
