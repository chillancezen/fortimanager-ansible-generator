:source: fmgr_pm_config_obj_wireless_controller_vap_per_object.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_vap_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/VAP/{VAP}
      fmgr_pm_config_obj_wireless_controller_vap_per_object:
