:source: fmgr_pm_config_devprof_system_replacemsg_nntp.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_nntp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/NNTP
      fmgr_pm_config_devprof_system_replacemsg_nntp:
         method: <value in [get]>
         url_params:
