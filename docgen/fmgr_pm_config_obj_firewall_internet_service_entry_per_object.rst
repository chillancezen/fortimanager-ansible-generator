:source: fmgr_pm_config_obj_firewall_internet_service_entry_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_internet_service_entry_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/INTERNET-SERVICE/ENTRY/{ENTRY}
      fmgr_pm_config_obj_firewall_internet_service_entry_per_object:
