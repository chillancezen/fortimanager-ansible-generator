:source: fmgr_pm_config_obj_user_fsso_polling_per_object.py

:orphan:

.. _fmgr_pm_config_obj_user_fsso_polling_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/FSSO-POLLING/{FSSO-POLLING}
      fmgr_pm_config_obj_user_fsso_polling_per_object:
