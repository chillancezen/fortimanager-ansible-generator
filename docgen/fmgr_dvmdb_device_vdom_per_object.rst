:source: fmgr_dvmdb_device_vdom_per_object.py

:orphan:

.. _fmgr_dvmdb_device_vdom_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /DVMDB/DEVICE/{DEVICE}/VDOM/{VDOM}
      fmgr_dvmdb_device_vdom_per_object:
         method: <value in [get]>
         url_params:
