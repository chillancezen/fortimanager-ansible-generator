:source: fmgr_pm_config_obj_dnsfilter_domain_filter_entries.py

:orphan:

.. _fmgr_pm_config_obj_dnsfilter_domain_filter_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/DNSFILTER/DOMAIN-FILTER/{DOMAIN-FILTER}/ENTRIES
      fmgr_pm_config_obj_dnsfilter_domain_filter_entries:
