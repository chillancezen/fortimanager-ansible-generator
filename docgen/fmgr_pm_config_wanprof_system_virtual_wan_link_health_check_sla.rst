:source: fmgr_pm_config_wanprof_system_virtual_wan_link_health_check_sla.py

:orphan:

.. _fmgr_pm_config_wanprof_system_virtual_wan_link_health_check_sla:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/WANPROF/{WANPROF}/SYSTEM/VIRTUAL-WAN-LINK/HEALTH-CHECK/{HEALTH-CHECK}/SLA
      fmgr_pm_config_wanprof_system_virtual_wan_link_health_check_sla:
