:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ftps.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_ftps:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SSL-SSH-PROFILE/{SSL-SSH-PROFILE}/FTPS
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_ftps:
         method: <value in [get]>
         url_params:
