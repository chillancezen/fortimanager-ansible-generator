:source: fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries:

fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries -- Spam filter trusted IP addresses.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Spam filter trusted IP addresses.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Spam filter trusted IP addresses.</li>
 <ul class="ul-self">
 <li><span class="li-head">attr</span> - The name of the attribute to retrieve its datasource. <span class="li-normal">type: str</span> </li>
 <li><span class="li-head">fields</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [addr-type, id, ip4-subnet, ip6-subnet, status]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/spamfilter/iptrust/{iptrust}/entries
      fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries:
      ...
      fmgr_pm_config_obj_spamfilter_iptrust_iptrust_entries:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [addr-type, id, ip4-subnet, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/spamfilter/iptrust/{iptrust}/entries</span>  </li>
 </ul>
