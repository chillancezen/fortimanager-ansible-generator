:source: fmgr_pm_config_obj_vpn_certificate_ocsp_server.py

:orphan:

.. _fmgr_pm_config_obj_vpn_certificate_ocsp_server:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - OCSP server configuration.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [cert, name, secondary-cert, secondary-url, source-ip, unavail-action, url]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpn/certificate/ocsp-server
      fmgr_pm_config_obj_vpn_certificate_ocsp_server:
      ...
      fmgr_pm_config_obj_vpn_certificate_ocsp_server:
         ...
         params:
            - 
               ...
               fields: 
                - 
                   - <value in [cert, name, secondary-cert, ...]>
               filter: 
                - <value of string>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpn/certificate/ocsp-server</span>  </li>
 </ul>
