:source: fmgr_pm_config_obj_firewall_vip_ssl_cipher_suites.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vip_ssl_cipher_suites:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP/{VIP}/SSL-CIPHER-SUITES
      fmgr_pm_config_obj_firewall_vip_ssl_cipher_suites:
