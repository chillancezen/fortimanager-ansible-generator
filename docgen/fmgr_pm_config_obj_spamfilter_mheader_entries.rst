:source: fmgr_pm_config_obj_spamfilter_mheader_entries.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_mheader_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/MHEADER/{MHEADER}/ENTRIES
      fmgr_pm_config_obj_spamfilter_mheader_entries:
