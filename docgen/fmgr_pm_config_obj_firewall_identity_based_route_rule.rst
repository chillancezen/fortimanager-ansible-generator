:source: fmgr_pm_config_obj_firewall_identity_based_route_rule.py

:orphan:

.. _fmgr_pm_config_obj_firewall_identity_based_route_rule:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/IDENTITY-BASED-ROUTE/{IDENTITY-BASED-ROUTE}/RULE
      fmgr_pm_config_obj_firewall_identity_based_route_rule:
