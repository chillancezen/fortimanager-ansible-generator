:source: fmgr_firewall_internetservicecustom_disableentry_obj.py

:orphan:

.. _fmgr_firewall_internetservicecustom_disableentry_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/INTERNET-SERVICE-CUSTOM/{INTERNET-SERVICE-CUSTOM}/DISABLE-ENTRY/{DISABLE-ENTRY}
      fmgr_firewall_internetservicecustom_disableentry_obj:
