:source: fmgr_pm_config_obj_firewall_proxy_addrgrp_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_proxy_addrgrp_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROXY-ADDRGRP/{PROXY-ADDRGRP}
      fmgr_pm_config_obj_firewall_proxy_addrgrp_per_object:
