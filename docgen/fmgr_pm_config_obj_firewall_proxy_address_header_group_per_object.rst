:source: fmgr_pm_config_obj_firewall_proxy_address_header_group_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_proxy_address_header_group_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROXY-ADDRESS/{PROXY-ADDRESS}/HEADER-GROUP/{HEADER-GROUP}
      fmgr_pm_config_obj_firewall_proxy_address_header_group_per_object:
