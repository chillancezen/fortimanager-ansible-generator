:source: fmgr_pm_config_obj_firewall_address6_subnet_segment.py

:orphan:

.. _fmgr_pm_config_obj_firewall_address6_subnet_segment:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/ADDRESS6/{ADDRESS6}/SUBNET-SEGMENT
      fmgr_pm_config_obj_firewall_address6_subnet_segment:
