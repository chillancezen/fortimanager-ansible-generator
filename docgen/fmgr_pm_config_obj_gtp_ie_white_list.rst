:source: fmgr_pm_config_obj_gtp_ie_white_list.py

:orphan:

.. _fmgr_pm_config_obj_gtp_ie_white_list:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - IE white list.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/gtp/ie-white-list
      fmgr_pm_config_obj_gtp_ie_white_list:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/gtp/ie-white-list</span>  </li>
 </ul>
