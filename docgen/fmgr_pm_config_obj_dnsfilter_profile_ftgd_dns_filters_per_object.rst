:source: fmgr_pm_config_obj_dnsfilter_profile_ftgd_dns_filters_per_object.py

:orphan:

.. _fmgr_pm_config_obj_dnsfilter_profile_ftgd_dns_filters_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/DNSFILTER/PROFILE/{PROFILE}/FTGD-DNS/FILTERS/{FILTERS}
      fmgr_pm_config_obj_dnsfilter_profile_ftgd_dns_filters_per_object:
