:source: fmgr_pm_config_obj_web_proxy_forward_server_per_object.py

:orphan:

.. _fmgr_pm_config_obj_web_proxy_forward_server_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEB-PROXY/FORWARD-SERVER/{FORWARD-SERVER}
      fmgr_pm_config_obj_web_proxy_forward_server_per_object:
