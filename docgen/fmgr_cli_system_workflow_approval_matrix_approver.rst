:source: fmgr_cli_system_workflow_approval_matrix_approver.py

:orphan:

.. _fmgr_cli_system_workflow_approval_matrix_approver:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/WORKFLOW/APPROVAL-MATRIX/{APPROVAL-MATRIX}/APPROVER
      fmgr_cli_system_workflow_approval_matrix_approver:
