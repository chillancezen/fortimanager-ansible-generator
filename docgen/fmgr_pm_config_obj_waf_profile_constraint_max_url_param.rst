:source: fmgr_pm_config_obj_waf_profile_constraint_max_url_param.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_max_url_param:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/MAX-URL-PARAM
      fmgr_pm_config_obj_waf_profile_constraint_max_url_param:
         method: <value in [get]>
         url_params:
