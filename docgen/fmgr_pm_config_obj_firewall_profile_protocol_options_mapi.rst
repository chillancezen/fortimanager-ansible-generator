:source: fmgr_pm_config_obj_firewall_profile_protocol_options_mapi.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_protocol_options_mapi:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROFILE-PROTOCOL-OPTIONS/{PROFILE-PROTOCOL-OPTIONS}/MAPI
      fmgr_pm_config_obj_firewall_profile_protocol_options_mapi:
         method: <value in [get]>
         url_params:
