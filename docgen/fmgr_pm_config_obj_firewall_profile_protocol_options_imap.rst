:source: fmgr_pm_config_obj_firewall_profile_protocol_options_imap.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_protocol_options_imap:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROFILE-PROTOCOL-OPTIONS/{PROFILE-PROTOCOL-OPTIONS}/IMAP
      fmgr_pm_config_obj_firewall_profile_protocol_options_imap:
         method: <value in [get]>
         url_params:
