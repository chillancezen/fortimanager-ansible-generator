:source: fmgr_pm_config_obj_firewall_profile_protocol_options_smtp.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_protocol_options_smtp:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROFILE-PROTOCOL-OPTIONS/{PROFILE-PROTOCOL-OPTIONS}/SMTP
      fmgr_pm_config_obj_firewall_profile_protocol_options_smtp:
         method: <value in [get]>
         url_params:
