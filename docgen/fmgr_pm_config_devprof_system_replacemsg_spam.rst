:source: fmgr_pm_config_devprof_system_replacemsg_spam.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_spam:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/SPAM
      fmgr_pm_config_devprof_system_replacemsg_spam:
         method: <value in [get]>
         url_params:
