:source: fmgr_pm_config_device_vdom_switch_controller_managed_switch_switch_log.py

:orphan:

.. _fmgr_pm_config_device_vdom_switch_controller_managed_switch_switch_log:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVICE/{DEVICE}/VDOM/{VDOM}/SWITCH-CONTROLLER/MANAGED-SWITCH/{MANAGED-SWITCH}/SWITCH-LOG
      fmgr_pm_config_device_vdom_switch_controller_managed_switch_switch_log:
         method: <value in [get]>
         url_params:
