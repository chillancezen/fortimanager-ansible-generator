:source: fmgr_system_admin_ldap_adom_obj.py

:orphan:

.. _fmgr_system_admin_ldap_adom_obj:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/ADMIN/LDAP/{LDAP}/ADOM/{ADOM}
      fmgr_system_admin_ldap_adom_obj:
