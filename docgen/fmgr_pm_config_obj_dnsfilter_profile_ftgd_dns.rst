:source: fmgr_pm_config_obj_dnsfilter_profile_ftgd_dns.py

:orphan:

.. _fmgr_pm_config_obj_dnsfilter_profile_ftgd_dns:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/DNSFILTER/PROFILE/{PROFILE}/FTGD-DNS
      fmgr_pm_config_obj_dnsfilter_profile_ftgd_dns:
         method: <value in [get]>
         url_params:
