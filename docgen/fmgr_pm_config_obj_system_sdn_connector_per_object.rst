:source: fmgr_pm_config_obj_system_sdn_connector_per_object.py

:orphan:

.. _fmgr_pm_config_obj_system_sdn_connector_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/SDN-CONNECTOR/{SDN-CONNECTOR}
      fmgr_pm_config_obj_system_sdn_connector_per_object:
