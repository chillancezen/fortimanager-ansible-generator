:source: fmgr_pm_config_obj_firewall_multicast_address_tagging.py

:orphan:

.. _fmgr_pm_config_obj_firewall_multicast_address_tagging:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/MULTICAST-ADDRESS/{MULTICAST-ADDRESS}/TAGGING
      fmgr_pm_config_obj_firewall_multicast_address_tagging:
