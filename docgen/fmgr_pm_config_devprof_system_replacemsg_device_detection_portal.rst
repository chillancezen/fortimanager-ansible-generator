:source: fmgr_pm_config_devprof_system_replacemsg_device_detection_portal.py

:orphan:

.. _fmgr_pm_config_devprof_system_replacemsg_device_detection_portal:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/REPLACEMSG/DEVICE-DETECTION-PORTAL
      fmgr_pm_config_devprof_system_replacemsg_device_detection_portal:
         method: <value in [get]>
         url_params:
