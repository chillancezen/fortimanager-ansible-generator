:source: fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link.py

:orphan:

.. _fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link:

fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link -- Configure redundant internet connections using SD-WAN (formerly virtual WAN link).
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/wanprof/{wanprof}/system/virtual-wan-link
      fmgr_pm_config_wanprof_wanprof_system_virtual_wan_link:
         method: <value in [get]>
         url_params:
