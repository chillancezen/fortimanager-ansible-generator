:source: fmgr_pm_config_obj_wireless_controller_bonjour_profile_policy_list.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_bonjour_profile_policy_list:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Bonjour policy list.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [description, from-vlan, policy-id, services, to-vlan]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/BONJOUR-PROFILE/{BONJOUR-PROFILE}/POLICY-LIST
      fmgr_pm_config_obj_wireless_controller_bonjour_profile_policy_list:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/wireless-controller/bonjour-profile/{bonjour-profile}/policy-list</span>  </li>
 </ul>
