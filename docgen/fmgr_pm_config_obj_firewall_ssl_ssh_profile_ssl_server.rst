:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_server.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_server:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/SSL-SSH-PROFILE/{SSL-SSH-PROFILE}/SSL-SERVER
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_server:
