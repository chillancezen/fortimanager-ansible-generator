:source: fmgr_cli_system_saml_service_providers.py

:orphan:

.. _fmgr_cli_system_saml_service_providers:
...
.. raw:: html
 ...
 <ul>
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Authorized service providers.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [get]</span> - Authorized service providers.</li>
 <ul class="ul-self">
 <li><span class="li-head">fields</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: array</span> <ul class="ul-self">
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [idp-entity-id, idp-single-logout-url, idp-single-sign-on-url, name, prefix, sp-cert, sp-entity-id, sp-single-logout-url, sp-single-sign-on-url]</span> </li>
 </ul>
 </ul>
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/system/saml/service-providers</span>  </li>
 </ul>
