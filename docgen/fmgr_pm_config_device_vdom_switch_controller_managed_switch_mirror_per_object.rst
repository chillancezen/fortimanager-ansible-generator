:source: fmgr_pm_config_device_vdom_switch_controller_managed_switch_mirror_per_object.py

:orphan:

.. _fmgr_pm_config_device_vdom_switch_controller_managed_switch_mirror_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVICE/{DEVICE}/VDOM/{VDOM}/SWITCH-CONTROLLER/MANAGED-SWITCH/{MANAGED-SWITCH}/MIRROR/{MIRROR}
      fmgr_pm_config_device_vdom_switch_controller_managed_switch_mirror_per_object:
