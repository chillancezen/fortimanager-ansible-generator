:source: fmgr_pm_config_obj_ips_sensor_sensor_entries_entries_exempt_ip_exempt_ip.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_sensor_entries_entries_exempt_ip_exempt_ip:

fmgr_pm_config_obj_ips_sensor_sensor_entries_entries_exempt_ip_exempt_ip -- Traffic from selected source or destination IP addresses is exempt from this signature.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Traffic from selected source or destination IP addresses is exempt from this signature.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Traffic from selected source or destination IP addresses is exempt from this signature.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/ips/sensor/{sensor}/entries/{entries}/exempt-ip/{exempt-ip}
      fmgr_pm_config_obj_ips_sensor_sensor_entries_entries_exempt_ip_exempt_ip:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/ips/sensor/{sensor}/entries/{entries}/exempt-ip/{exempt-ip}</span>  </li>
 </ul>
