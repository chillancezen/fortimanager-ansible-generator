:source: fmgr_pm_config_obj_spamfilter_dnsbl_entries.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_dnsbl_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/DNSBL/{DNSBL}/ENTRIES
      fmgr_pm_config_obj_spamfilter_dnsbl_entries:
