:source: fmgr_pm_config_devprof_system_snmp_community_hosts6.py

:orphan:

.. _fmgr_pm_config_devprof_system_snmp_community_hosts6:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/DEVPROF/{DEVPROF}/SYSTEM/SNMP/COMMUNITY/{COMMUNITY}/HOSTS6
      fmgr_pm_config_devprof_system_snmp_community_hosts6:
