:source: fmgr_pm_config_obj_firewall_identity_based_route_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_identity_based_route_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/IDENTITY-BASED-ROUTE/{IDENTITY-BASED-ROUTE}
      fmgr_pm_config_obj_firewall_identity_based_route_per_object:
