:source: fmgr_dvmdb_workflow_wflog_per_object.py

:orphan:

.. _fmgr_dvmdb_workflow_wflog_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /DVMDB/WORKFLOW/{WORKFLOW}/WFLOG/{WFLOG}
      fmgr_dvmdb_workflow_wflog_per_object:
         method: <value in [get]>
         url_params:
