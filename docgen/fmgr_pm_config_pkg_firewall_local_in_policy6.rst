:source: fmgr_pm_config_pkg_firewall_local_in_policy6.py

:orphan:

.. _fmgr_pm_config_pkg_firewall_local_in_policy6:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/LOCAL-IN-POLICY6
      fmgr_pm_config_pkg_firewall_local_in_policy6:
