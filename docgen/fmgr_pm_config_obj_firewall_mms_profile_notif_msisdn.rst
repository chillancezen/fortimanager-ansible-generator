:source: fmgr_pm_config_obj_firewall_mms_profile_notif_msisdn.py

:orphan:

.. _fmgr_pm_config_obj_firewall_mms_profile_notif_msisdn:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/MMS-PROFILE/{MMS-PROFILE}/NOTIF-MSISDN
      fmgr_pm_config_obj_firewall_mms_profile_notif_msisdn:
