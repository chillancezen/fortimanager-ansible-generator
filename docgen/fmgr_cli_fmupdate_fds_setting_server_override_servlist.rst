:source: fmgr_cli_fmupdate_fds_setting_server_override_servlist.py

:orphan:

.. _fmgr_cli_fmupdate_fds_setting_server_override_servlist:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /cli/fmupdate/fds-setting/server-override/servlist
      fmgr_cli_fmupdate_fds_setting_server_override_servlist:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /cli/global/fmupdate/fds-setting/server-override/servlist</span>  </li>
 </ul>
