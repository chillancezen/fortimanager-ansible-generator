:source: fmgr_pm_config_obj_spamfilter_iptrust_entries.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_iptrust_entries:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/IPTRUST/{IPTRUST}/ENTRIES
      fmgr_pm_config_obj_spamfilter_iptrust_entries:
