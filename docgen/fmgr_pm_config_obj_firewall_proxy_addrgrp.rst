:source: fmgr_pm_config_obj_firewall_proxy_addrgrp.py

:orphan:

.. _fmgr_pm_config_obj_firewall_proxy_addrgrp:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - Web proxy address group configuration.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [color, comment, member, name, type, uuid, visibility]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/proxy-addrgrp
      fmgr_pm_config_obj_firewall_proxy_addrgrp:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/firewall/proxy-addrgrp</span>  </li>
 </ul>
