:source: fmgr_pm_config_obj_waf_profile_constraint_url_param_length.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_url_param_length:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/URL-PARAM-LENGTH
      fmgr_pm_config_obj_waf_profile_constraint_url_param_length:
         method: <value in [get]>
         url_params:
