:source: fmgr_pm_config_obj_system_replacemsg_group_ftp.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_ftp:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/FTP
      fmgr_pm_config_obj_system_replacemsg_group_ftp:
