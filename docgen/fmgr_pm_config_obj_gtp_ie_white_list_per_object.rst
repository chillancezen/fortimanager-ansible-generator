:source: fmgr_pm_config_obj_gtp_ie_white_list_per_object.py

:orphan:

.. _fmgr_pm_config_obj_gtp_ie_white_list_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/GTP/IE-WHITE-LIST/{IE-WHITE-LIST}
      fmgr_pm_config_obj_gtp_ie_white_list_per_object:
