:source: fmgr_pm_config_obj_user_ldap_ldap.py

:orphan:

.. _fmgr_pm_config_obj_user_ldap_ldap:

fmgr_pm_config_obj_user_ldap_ldap -- Configure LDAP server entries.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/ldap/{ldap}
      fmgr_pm_config_obj_user_ldap_ldap:
