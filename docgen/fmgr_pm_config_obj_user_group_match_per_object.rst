:source: fmgr_pm_config_obj_user_group_match_per_object.py

:orphan:

.. _fmgr_pm_config_obj_user_group_match_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/GROUP/{GROUP}/MATCH/{MATCH}
      fmgr_pm_config_obj_user_group_match_per_object:
