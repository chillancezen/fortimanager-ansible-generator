:source: fmgr_pm_config_pkg_firewall_multicast_policy_per_object.py

:orphan:

.. _fmgr_pm_config_pkg_firewall_multicast_policy_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/MULTICAST-POLICY/{MULTICAST-POLICY}
      fmgr_pm_config_pkg_firewall_multicast_policy_per_object:
