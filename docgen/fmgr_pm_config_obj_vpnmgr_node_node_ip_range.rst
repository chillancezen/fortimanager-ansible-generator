:source: fmgr_pm_config_obj_vpnmgr_node_node_ip_range.py

:orphan:

.. _fmgr_pm_config_obj_vpnmgr_node_node_ip_range:

fmgr_pm_config_obj_vpnmgr_node_node_ip_range
++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/vpnmgr/node/{node}/ip-range
      fmgr_pm_config_obj_vpnmgr_node_node_ip_range:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/vpnmgr/node/{node}/ip-range</span>  </li>
 </ul>
