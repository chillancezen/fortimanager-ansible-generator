:source: fmgr_pm_config_obj_system_replacemsg_group_icap.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_icap:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/ICAP
      fmgr_pm_config_obj_system_replacemsg_group_icap:
