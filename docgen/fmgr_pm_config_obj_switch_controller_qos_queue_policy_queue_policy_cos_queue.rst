:source: fmgr_pm_config_obj_switch_controller_qos_queue_policy_queue_policy_cos_queue.py

:orphan:

.. _fmgr_pm_config_obj_switch_controller_qos_queue_policy_queue_policy_cos_queue:

fmgr_pm_config_obj_switch_controller_qos_queue_policy_queue_policy_cos_queue -- COS queue configuration.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [add, set, update]</span> - COS queue configuration.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">{no-name}</span> - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">choices: [description, drop-policy, max-rate, min-rate, name, weight]</span> </li>
 </ul>
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/switch-controller/qos/queue-policy/{queue-policy}/cos-queue
      fmgr_pm_config_obj_switch_controller_qos_queue_policy_queue_policy_cos_queue:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/switch-controller/qos/queue-policy/{queue-policy}/cos-queue</span>  </li>
 </ul>
