:source: fmgr_pm_config_obj_waf_profile_constraint_version.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_constraint_version:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/CONSTRAINT/VERSION
      fmgr_pm_config_obj_waf_profile_constraint_version:
         method: <value in [get]>
         url_params:
