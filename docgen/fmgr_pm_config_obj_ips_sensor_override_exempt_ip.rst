:source: fmgr_pm_config_obj_ips_sensor_override_exempt_ip.py

:orphan:

.. _fmgr_pm_config_obj_ips_sensor_override_exempt_ip:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/IPS/SENSOR/{SENSOR}/OVERRIDE/{OVERRIDE}/EXEMPT-IP
      fmgr_pm_config_obj_ips_sensor_override_exempt_ip:
