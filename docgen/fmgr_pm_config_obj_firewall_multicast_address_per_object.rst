:source: fmgr_pm_config_obj_firewall_multicast_address_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_multicast_address_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/MULTICAST-ADDRESS/{MULTICAST-ADDRESS}
      fmgr_pm_config_obj_firewall_multicast_address_per_object:
