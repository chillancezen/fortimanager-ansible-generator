:source: fmgr_pm_config_obj_gtp_message_filter_v0v1_per_object.py

:orphan:

.. _fmgr_pm_config_obj_gtp_message_filter_v0v1_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/GTP/MESSAGE-FILTER-V0V1/{MESSAGE-FILTER-V0V1}
      fmgr_pm_config_obj_gtp_message_filter_v0v1_per_object:
