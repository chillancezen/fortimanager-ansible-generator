:source: fmgr_pm_config_obj_firewall_vip64_realservers_per_object.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vip64_realservers_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP64/{VIP64}/REALSERVERS/{REALSERVERS}
      fmgr_pm_config_obj_firewall_vip64_realservers_per_object:
