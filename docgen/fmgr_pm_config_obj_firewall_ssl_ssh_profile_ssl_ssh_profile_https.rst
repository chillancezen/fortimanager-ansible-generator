:source: fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_https.py

:orphan:

.. _fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_https:

fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_https -- Configure HTTPS options.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/firewall/ssl-ssh-profile/{ssl-ssh-profile}/https
      fmgr_pm_config_obj_firewall_ssl_ssh_profile_ssl_ssh_profile_https:
         method: <value in [get]>
         url_params:
