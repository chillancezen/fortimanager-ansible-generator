:source: fmgr_pm_config_obj_switch_controller_lldp_profile_custom_tlvs.py

:orphan:

.. _fmgr_pm_config_obj_switch_controller_lldp_profile_custom_tlvs:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SWITCH-CONTROLLER/LLDP-PROFILE/{LLDP-PROFILE}/CUSTOM-TLVS
      fmgr_pm_config_obj_switch_controller_lldp_profile_custom_tlvs:
