:source: fmgr_pm_config_obj_waf_profile_signature_main_class.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_signature_main_class:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/SIGNATURE/MAIN-CLASS
      fmgr_pm_config_obj_waf_profile_signature_main_class:
         method: <value in [get]>
         url_params:
