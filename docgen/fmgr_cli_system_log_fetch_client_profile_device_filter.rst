:source: fmgr_cli_system_log_fetch_client_profile_device_filter.py

:orphan:

.. _fmgr_cli_system_log_fetch_client_profile_device_filter:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/LOG-FETCH/CLIENT-PROFILE/{CLIENT-PROFILE}/DEVICE-FILTER
      fmgr_cli_system_log_fetch_client_profile_device_filter:
