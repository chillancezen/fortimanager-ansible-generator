:source: fmgr_dvmdb_device_device.py

:orphan:

.. _fmgr_dvmdb_device_device:

fmgr_dvmdb_device_device -- Device table, most attributes are read-only and can only be changed internally.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /dvmdb/device/{device}
      fmgr_dvmdb_device_device:
         method: <value in [get]>
         url_params:
