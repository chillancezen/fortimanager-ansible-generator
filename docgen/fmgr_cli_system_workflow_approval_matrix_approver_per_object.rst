:source: fmgr_cli_system_workflow_approval_matrix_approver_per_object.py

:orphan:

.. _fmgr_cli_system_workflow_approval_matrix_approver_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/WORKFLOW/APPROVAL-MATRIX/{APPROVAL-MATRIX}/APPROVER/{APPROVER}
      fmgr_cli_system_workflow_approval_matrix_approver_per_object:
