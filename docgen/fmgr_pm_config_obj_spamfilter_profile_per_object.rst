:source: fmgr_pm_config_obj_spamfilter_profile_per_object.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_profile_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SPAMFILTER/PROFILE/{PROFILE}
      fmgr_pm_config_obj_spamfilter_profile_per_object:
