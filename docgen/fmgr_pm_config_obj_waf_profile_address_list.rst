:source: fmgr_pm_config_obj_waf_profile_address_list.py

:orphan:

.. _fmgr_pm_config_obj_waf_profile_address_list:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WAF/PROFILE/{PROFILE}/ADDRESS-LIST
      fmgr_pm_config_obj_waf_profile_address_list:
         method: <value in [get]>
         url_params:
