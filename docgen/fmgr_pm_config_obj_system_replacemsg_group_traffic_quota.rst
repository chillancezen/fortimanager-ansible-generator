:source: fmgr_pm_config_obj_system_replacemsg_group_traffic_quota.py

:orphan:

.. _fmgr_pm_config_obj_system_replacemsg_group_traffic_quota:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/REPLACEMSG-GROUP/{REPLACEMSG-GROUP}/TRAFFIC-QUOTA
      fmgr_pm_config_obj_system_replacemsg_group_traffic_quota:
