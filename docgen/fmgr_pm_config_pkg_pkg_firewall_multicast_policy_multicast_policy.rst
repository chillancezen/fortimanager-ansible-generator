:source: fmgr_pm_config_pkg_pkg_firewall_multicast_policy_multicast_policy.py

:orphan:

.. _fmgr_pm_config_pkg_pkg_firewall_multicast_policy_multicast_policy:

fmgr_pm_config_pkg_pkg_firewall_multicast_policy_multicast_policy -- Configure multicast NAT policies.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">multicast-policy</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure multicast NAT policies.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure multicast NAT policies.</li>
 <ul class="ul-self">
 </ul>
 ...
 <li><span class="li-head">parameters for method: [move]</span> - Configure multicast NAT policies.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/pkg/{pkg}/firewall/multicast-policy/{multicast-policy}
      fmgr_pm_config_pkg_pkg_firewall_multicast_policy_multicast_policy:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/pkg/{pkg}/firewall/multicast-policy/{multicast-policy}</span>  </li>
 </ul>
