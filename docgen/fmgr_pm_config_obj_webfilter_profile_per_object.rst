:source: fmgr_pm_config_obj_webfilter_profile_per_object.py

:orphan:

.. _fmgr_pm_config_obj_webfilter_profile_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WEBFILTER/PROFILE/{PROFILE}
      fmgr_pm_config_obj_webfilter_profile_per_object:
