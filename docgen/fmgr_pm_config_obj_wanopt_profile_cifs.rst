:source: fmgr_pm_config_obj_wanopt_profile_cifs.py

:orphan:

.. _fmgr_pm_config_obj_wanopt_profile_cifs:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WANOPT/PROFILE/{PROFILE}/CIFS
      fmgr_pm_config_obj_wanopt_profile_cifs:
         method: <value in [get]>
         url_params:
