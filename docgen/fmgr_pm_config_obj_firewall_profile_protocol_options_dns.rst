:source: fmgr_pm_config_obj_firewall_profile_protocol_options_dns.py

:orphan:

.. _fmgr_pm_config_obj_firewall_profile_protocol_options_dns:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/PROFILE-PROTOCOL-OPTIONS/{PROFILE-PROTOCOL-OPTIONS}/DNS
      fmgr_pm_config_obj_firewall_profile_protocol_options_dns:
         method: <value in [get]>
         url_params:
