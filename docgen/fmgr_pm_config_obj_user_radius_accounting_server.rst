:source: fmgr_pm_config_obj_user_radius_accounting_server.py

:orphan:

.. _fmgr_pm_config_obj_user_radius_accounting_server:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/RADIUS/{RADIUS}/ACCOUNTING-SERVER
      fmgr_pm_config_obj_user_radius_accounting_server:
