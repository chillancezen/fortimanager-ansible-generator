:source: fmgr_pkg_firewall_dospolicy_anomaly_obj.py

:orphan:

.. _fmgr_pkg_firewall_dospolicy_anomaly_obj:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/PKG/{PKG}/FIREWALL/DOS-POLICY/{DOS-POLICY}/ANOMALY/{ANOMALY}
      fmgr_pkg_firewall_dospolicy_anomaly_obj:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/pkg/{pkg}/firewall/DoS-policy/{DoS-policy}/anomaly/{anomaly}</span>  </li>
 </ul>
