:source: fmgr_pm_config_obj_vpn_ssl_web_host_check_software_per_object.py

:orphan:

.. _fmgr_pm_config_obj_vpn_ssl_web_host_check_software_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/HOST-CHECK-SOFTWARE/{HOST-CHECK-SOFTWARE}
      fmgr_pm_config_obj_vpn_ssl_web_host_check_software_per_object:
