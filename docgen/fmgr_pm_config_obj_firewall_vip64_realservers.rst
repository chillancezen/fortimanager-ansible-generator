:source: fmgr_pm_config_obj_firewall_vip64_realservers.py

:orphan:

.. _fmgr_pm_config_obj_firewall_vip64_realservers:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/FIREWALL/VIP64/{VIP64}/REALSERVERS
      fmgr_pm_config_obj_firewall_vip64_realservers:
