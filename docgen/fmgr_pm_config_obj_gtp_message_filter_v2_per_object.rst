:source: fmgr_pm_config_obj_gtp_message_filter_v2_per_object.py

:orphan:

.. _fmgr_pm_config_obj_gtp_message_filter_v2_per_object:
...
.. raw:: html
 ...
 <li><span class="li-head">message-filter-v2</span> - the object name <span class="li-normal">type: str</span> </li>
 </ul>
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Message filter for GTPv2 messages.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Message filter for GTPv2 messages.</li>
 <ul class="ul-self">
 </ul>
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/GTP/MESSAGE-FILTER-V2/{MESSAGE-FILTER-V2}
      fmgr_pm_config_obj_gtp_message_filter_v2_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/gtp/message-filter-v2/{message-filter-v2}</span>  </li>
 </ul>
