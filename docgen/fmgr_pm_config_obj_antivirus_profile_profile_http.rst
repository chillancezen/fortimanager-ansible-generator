:source: fmgr_pm_config_obj_antivirus_profile_profile_http.py

:orphan:

.. _fmgr_pm_config_obj_antivirus_profile_profile_http:

fmgr_pm_config_obj_antivirus_profile_profile_http -- Configure HTTP AntiVirus options.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/antivirus/profile/{profile}/http
      fmgr_pm_config_obj_antivirus_profile_profile_http:
         method: <value in [get]>
         url_params:
