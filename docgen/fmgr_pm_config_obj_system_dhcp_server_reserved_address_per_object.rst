:source: fmgr_pm_config_obj_system_dhcp_server_reserved_address_per_object.py

:orphan:

.. _fmgr_pm_config_obj_system_dhcp_server_reserved_address_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/SYSTEM/DHCP/SERVER/{SERVER}/RESERVED-ADDRESS/{RESERVED-ADDRESS}
      fmgr_pm_config_obj_system_dhcp_server_reserved_address_per_object:
