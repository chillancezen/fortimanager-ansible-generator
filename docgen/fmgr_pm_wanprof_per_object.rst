:source: fmgr_pm_wanprof_per_object.py

:orphan:

.. _fmgr_pm_wanprof_per_object:

fmgr_pm_wanprof_per_object
++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/WANPROF/{PKG_PATH}
      fmgr_pm_wanprof_per_object:
         method: <value in [get]>
         url_params:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/wanprof/adom/{adom}/{pkg_path}</span>  </li>
 </ul>
