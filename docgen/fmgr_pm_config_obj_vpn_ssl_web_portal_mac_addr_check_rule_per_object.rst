:source: fmgr_pm_config_obj_vpn_ssl_web_portal_mac_addr_check_rule_per_object.py

:orphan:

.. _fmgr_pm_config_obj_vpn_ssl_web_portal_mac_addr_check_rule_per_object:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/VPN/SSL/WEB/PORTAL/{PORTAL}/MAC-ADDR-CHECK-RULE/{MAC-ADDR-CHECK-RULE}
      fmgr_pm_config_obj_vpn_ssl_web_portal_mac_addr_check_rule_per_object:
