:source: fmgr_cli_system_log_fetch_client_profile_log_filter.py

:orphan:

.. _fmgr_cli_system_log_fetch_client_profile_log_filter:
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /CLI/SYSTEM/LOG-FETCH/CLIENT-PROFILE/{CLIENT-PROFILE}/LOG-FILTER
      fmgr_cli_system_log_fetch_client_profile_log_filter:
