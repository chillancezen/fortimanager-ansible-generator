:source: fmgr_pm_config_obj_wireless_controller_hotspot20_h2qp_wan_metric_per_object.py

:orphan:

.. _fmgr_pm_config_obj_wireless_controller_hotspot20_h2qp_wan_metric_per_object:
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/WIRELESS-CONTROLLER/HOTSPOT20/H2QP-WAN-METRIC/{H2QP-WAN-METRIC}
      fmgr_pm_config_obj_wireless_controller_hotspot20_h2qp_wan_metric_per_object:
