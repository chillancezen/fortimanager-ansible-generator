:source: fmgr_pm_config_obj_user_peer_peer.py

:orphan:

.. _fmgr_pm_config_obj_user_peer_peer:

fmgr_pm_config_obj_user_peer_peer -- Configure peer users.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/user/peer/{peer}
      fmgr_pm_config_obj_user_peer_peer:
