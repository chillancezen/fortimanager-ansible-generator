:source: fmgr_pm_config_obj_user_device_group_per_object.py

:orphan:

.. _fmgr_pm_config_obj_user_device_group_per_object:
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure device groups.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure device groups.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure device groups.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    ...
    - name: REQUESTING /PM/CONFIG/OBJ/USER/DEVICE-GROUP/{DEVICE-GROUP}
      fmgr_pm_config_obj_user_device_group_per_object:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/user/device-group/{device-group}</span>  </li>
 </ul>
 ...
 <li> <span class="li-return"> member </span> - Device group member. <span class="li-normal">type: str</span>  </li>
 <li> <span class="li-return"> name </span> - Device group name. <span class="li-normal">type: str</span>  </li>
