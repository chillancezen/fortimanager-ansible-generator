:source: fmgr_pm_config_obj_spamfilter_bword_bword.py

:orphan:

.. _fmgr_pm_config_obj_spamfilter_bword_bword:

fmgr_pm_config_obj_spamfilter_bword_bword -- Configure AntiSpam banned word list.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">parameters for method: [clone, set, update]</span> - Configure AntiSpam banned word list.</li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">parameters for method: [delete]</span> - Configure AntiSpam banned word list.</li>
 <ul class="ul-self">
 </ul>
 <li><span class="li-head">parameters for method: [get]</span> - Configure AntiSpam banned word list.</li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
 ...
 - hosts: fortimanager-inventory
   ...
   tasks:
    - name: send request to /pm/config/obj/spamfilter/bword/{bword}
      fmgr_pm_config_obj_spamfilter_bword_bword:
...
.. raw:: html
 ...
 - No description for the parameter <span class="li-normal">type: str</span>  <span class="li-normal">example: /pm/config/adom/{adom}/obj/spamfilter/bword/{bword}</span>  </li>
 </ul>
